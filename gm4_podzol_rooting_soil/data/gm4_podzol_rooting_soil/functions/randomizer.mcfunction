...
# compare
execute if score compared_value gm4_podzol_data >= last_uuid gm4_podzol_data if entity @s[nbt={Item:{Count:1b}}] at @s if block ~ ~-1 ~ minecraft:podzol if block ~ ~ ~ #gm4_podzol_rooting_soil:air run function gm4_podzol_rooting_soil:plant/normal
