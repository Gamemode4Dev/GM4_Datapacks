...
execute as @e[type=area_effect_cloud,tag=gm4_orbis_populate] at @s run function #gm4_orbis:structure/populate_init
kill @e[type=area_effect_cloud,tag=gm4_orbis_populate]
execute as @e[type=area_effect_cloud,tag=gm4_orbis_populate_marker,sort=random] at @s run function gm4_orbis:structure/populate_all
