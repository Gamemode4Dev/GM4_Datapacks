...
execute if score chest_height gm4_count matches 110..139 run data merge block ~ ~ ~ {LootTable:"gm4_orbis:chests/tower_110"}
execute if score chest_height gm4_count matches 140..169 run data merge block ~ ~ ~ {LootTable:"gm4_orbis:chests/tower_130"}
execute if score chest_height gm4_count matches 170.. run data merge block ~ ~ ~ {LootTable:"gm4_orbis:chests/tower_150"}
