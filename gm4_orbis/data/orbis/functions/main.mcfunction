...
execute at @a[tag=!orbis_disabled] positioned ~-8 ~ ~-8 as @e[tag=gm4_chunk,tag=!gm4_generated,sort=nearest,limit=1] at @s run function orbis:chunk/generate
# kill chunk markers that have been generated and have all adjacent chunks generated
execute as @e[tag=gm4_chunk,tag=gm4_generated] at @s run function orbis:chunk/kill
