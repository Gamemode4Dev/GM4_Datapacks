...
execute if score structure_height gm4_count matches ..50 if entity @s[tag=gm4_dungeon,scores={gm4_orbis_biome=1}] run summon area_effect_cloud ~ ~ ~ {Tags:["gm4_orbis_spawn_marker","gm4_orbis_ocean_dungeon"]}
