...
execute if score chest_height gm4_count matches 40..49 run data merge block ~ ~ ~ {LootTable:"orbis:chests/dungeon_40"}
execute if score chest_height gm4_count matches 50.. run data merge block ~ ~ ~ {LootTable:"orbis:chests/dungeon_50"}
