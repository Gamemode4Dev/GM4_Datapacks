...
execute store result score temp gm4_count if entity @e[tag=gm4_chunk,tag=gm4_adjacent,scores={gm4_orbis_biome=0}]
execute if score temp gm4_count matches 3.. run scoreboard players set @s gm4_orbis_biome 0

execute store result score temp gm4_count if entity @e[tag=gm4_chunk,tag=gm4_adjacent,scores={gm4_orbis_biome=1}]
...
execute store result score temp gm4_count if entity @e[tag=gm4_chunk,tag=gm4_adjacent,scores={gm4_orbis_biome=2}]
...
execute store result score temp gm4_count if entity @e[tag=gm4_chunk,tag=gm4_adjacent,scores={gm4_orbis_biome=3}]
...
execute store result score temp gm4_count if entity @e[tag=gm4_chunk,tag=gm4_adjacent,scores={gm4_orbis_biome=4}]
