...
execute if score orbis_water gm4_count matches 256.. run scoreboard players set @s gm4_orbis_biome 1

# having at least 16x8 blocks of sandstone between layer 60 and 110 makes it a desert
...
# having at least 32 snow layer blocks or 32 ice blocks makes it a snow biome
