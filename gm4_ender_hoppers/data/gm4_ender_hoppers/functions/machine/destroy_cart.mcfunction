...
execute if score $dropped_item gm4_machine_data matches 1 run kill @e[type=item,distance=..1,nbt={Age:0s,Item:{id:"minecraft:hopper",Count:1b}},nbt=!{Item:{tag:{}}},limit=1,sort=nearest]
kill @s
