...
execute as @e[type=item,distance=..3,nbt={Age:0s,Item:{id:"minecraft:hopper_minecart",count:1,tag:{display:{}}}},limit=1,sort=nearest] at @s run function gm4_ender_hoppers:machine/destroy_cart/drop_item
