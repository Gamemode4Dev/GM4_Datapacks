...
execute unless score gm4_machines load.status matches 2 run data modify storage gm4:log queue append value {type:"missing",module:"Ender Hoppers",require:"Custom Crafters"}
