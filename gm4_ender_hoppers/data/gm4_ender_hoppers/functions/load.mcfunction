...
execute if score gm4_ender_hoppers load matches 1 run function ender_hoppers:init
execute unless score gm4_ender_hoppers load matches 1 run schedule clear ender_hoppers:main
