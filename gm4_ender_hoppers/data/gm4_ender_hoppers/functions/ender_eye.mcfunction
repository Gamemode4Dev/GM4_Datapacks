...
execute if block ~ ~ ~ hopper{Items:[{Slot:0b,id:"minecraft:ender_pearl",Count:2b},{Slot:1b,id:"minecraft:iron_block",Count:2b},{Slot:2b,id:"minecraft:diamond_block",Count:1b},{Slot:3b,id:"minecraft:iron_block",Count:2b},{Slot:4b,id:"minecraft:ender_pearl",Count:2b}]} align xyz positioned ~ ~-0.1 ~ unless entity @e[type=armor_stand,tag=gm4_machine,limit=1,dx=0] positioned ~0.5 ~0.1 ~0.5 run function gm4_ender_hoppers:create_block
execute unless block ~ ~ ~ hopper as @e[type=hopper_minecart,tag=!gm4_machine,dx=0,nbt={Items:[{Slot:0b,id:"minecraft:ender_pearl",Count:2b},{Slot:1b,id:"minecraft:iron_block",Count:2b},{Slot:2b,id:"minecraft:diamond_block",Count:1b},{Slot:3b,id:"minecraft:iron_block",Count:2b},{Slot:4b,id:"minecraft:ender_pearl",Count:2b}]}] at @s run function gm4_ender_hoppers:create_cart
