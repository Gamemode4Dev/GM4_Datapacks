# @s = forceloaded command block placed by "gm4_relocators:place_down/place_block/base"
# located at machine block location

data merge block ~ ~ ~ {CustomName:'{"translate":"%1$s%3427655$s","with":["Ender Hopper",{"translate":"block.gm4.ender_hopper"}]}'}
