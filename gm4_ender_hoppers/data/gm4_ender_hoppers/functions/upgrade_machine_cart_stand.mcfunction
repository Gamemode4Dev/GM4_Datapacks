...
data merge entity @s {Tags:["gm4_no_edit","gm4_ender_hopper_stand","gm4_machine_cart","smithed.entity","smithed.strict"],HasVisualFire:1,CustomName:'"gm4_ender_hopper_stand"',Pose:{Head:[180f,0f,0f],RightArm:[0f,0f,0f]},HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{CustomModelData:3420003}},{}]}
