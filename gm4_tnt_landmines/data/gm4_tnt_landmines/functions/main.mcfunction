#creation
execute as @e[type=item,tag=!gm4_mine_checked,nbt={OnGround:1b,Item:{id:"minecraft:player_head",count:1,tag:{gm4_tnt_landmines:{item:"landmine"}}}}] at @s run function gm4_tnt_landmines:checks/creation
