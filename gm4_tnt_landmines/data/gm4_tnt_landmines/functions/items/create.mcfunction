...
execute unless score invisible gm4_tnt_data matches 1 run summon armor_stand ~ ~ ~ {NoGravity:1b,Small:1b,Invisible:1b,Marker:1b,Invulnerable:1b,Fire:200000,Tags:["gm4_tnt_mine_unset","gm4_no_edit"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:tnt",Count:1b}]}
execute if score invisible gm4_tnt_data matches 1 run summon armor_stand ~ ~ ~ {NoGravity:1b,Small:1b,Invisible:1b,Marker:1b,Invulnerable:1b,Fire:200000,Tags:["gm4_tnt_mine_unset","gm4_no_edit"],DisabledSlots:4144959}
