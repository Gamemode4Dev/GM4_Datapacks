...
#upgrading
execute as @e[type=item,nbt={OnGround:1b,Item:{id:"minecraft:gunpowder",Count:1b,tag:{gm4_tnt_landmines:{item:2}}}}] at @s unless entity @e[type=item,nbt={OnGround:1b,Item:{id:"minecraft:gunpowder",Count:1b,tag:{gm4_tnt_landmines:{item:2}}}},distance=0.1..1.1] at @e[type=armor_stand,tag=gm4_tnt_mine,distance=..1.2,limit=1] if entity @e[type=area_effect_cloud,tag=gm4_mine_disarmed,distance=..0.2] run function tnt_landmines:upgrade
