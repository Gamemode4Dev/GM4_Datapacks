...
execute if score treasureType gm4_st_random matches 1 unless score scuba_gear gm4_modules matches 1.. run loot spawn ~ ~ ~ loot sunken_treasure:item_treasure
execute if score treasureType gm4_st_random matches 1 if score scuba_gear gm4_modules matches 1.. run loot spawn ~ ~ ~ loot sunken_treasure:item_treasure_scuba
