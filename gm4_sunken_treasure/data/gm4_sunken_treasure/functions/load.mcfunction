...
execute if score gm4_sunken_treasure load matches 1 run function gm4_sunken_treasure:init
execute unless score gm4_sunken_treasure load matches 1 run schedule clear gm4_sunken_treasure:tick
