...
# guidebook
summon marker ~ 1398.90858752394 ~ {CustomName:'"gm4_fulcio_shamir_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"metallurgy",id:"fulcio_shamir",page_count:1,line_count:1,module_name:"Fulcio Shamir"}}
