...
data merge entity @s {Item:{Count:1b,tag:{CustomModelData:64,gm4_compressed:{value:64},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:0}]}}}
data modify entity @s Item.tag.display.Lore append value '{"translate":"%1$s%3427655$s","with":["Compressed *64",{"translate":"text.gm4.block_compressors.compressed","with":["64"]}]}'
