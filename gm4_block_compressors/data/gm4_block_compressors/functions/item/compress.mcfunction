...
data modify storage gm4_block_compressors:temp/item_stack Item.components."minecraft:custom_data".gm4_block_compressors.old_tag set from storage gm4_block_compressors:temp/item_stack Item.components
data remove storage gm4_block_compressors:temp/item_stack Item.components."minecraft:custom_data".gm4_block_compressors.old_tag."minecraft:custom_data".gm4_block_compressors
