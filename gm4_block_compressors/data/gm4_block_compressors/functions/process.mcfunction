...
execute positioned ~ ~-0.995 ~ as @e[type=armor_stand,tag=gm4_block_compressor_stand,tag=gm4_compressor_depressed,distance=..0.01,limit=1] at @s run function gm4_block_compressors:pressure_plate_up
