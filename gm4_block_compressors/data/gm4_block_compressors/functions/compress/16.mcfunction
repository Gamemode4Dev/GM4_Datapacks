...
data merge entity @s {Item:{Count:1b,tag:{CustomModelData:3420016,gm4_compressed:{value:16},HideFlags:1,Enchantments:[{id:"minecraft:protection",lvl:0s}]}}}
data modify entity @s Item.tag.display.Lore append value '{"translate":"%1$s%3427655$s","with":["Compressed ×16",{"translate":"text.gm4.block_compressors.compressed","with":[" ×16"]}],"color":"gray","italic":false}'
