...
execute if score gm4_block_compressors load.status matches 1 if entity @s[tag=gm4_block_compressor] run function gm4_block_compressors:relocate/set_pick_up_data
