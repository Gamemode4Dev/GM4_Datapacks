execute if score gm4 load.status matches 1 if score gm4_liquid_tanks load.status matches 1 if score gm4_brewing load.status matches 1 run scoreboard players set gm4_potion_liquids load.status 1
