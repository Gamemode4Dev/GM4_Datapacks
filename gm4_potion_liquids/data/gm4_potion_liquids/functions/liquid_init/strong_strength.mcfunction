data merge block ~ ~ ~ {CustomName:'{"translate":"%1$s%3427655$s","with":["Strong Strength Potion Tank", {"translate":"container.gm4.liquid_tank.strong_strength"}]}'}
...
data modify entity @s ArmorItems[3].tag.gm4_liquid_tanks.liquid_tag set value "gm4_lt_strong_strength"
