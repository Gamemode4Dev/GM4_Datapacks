...
# guidebook
summon marker ~ 3414.390828457077 ~ {CustomName:'"gm4_potion_liquids_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"liquid_tanks",id:"potion_liquids",page_count:1,line_count:1,module_name:"Potion Liquids"}}
