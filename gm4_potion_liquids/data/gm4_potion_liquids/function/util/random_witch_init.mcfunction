...
summon area_effect_cloud ~ ~ ~ {Radius:0.0f,CustomName:"gm4_pl_random_witch_init",Tags:["gm4_pl_random_witch_init","gm4_lt_random_regeneration"]}
summon area_effect_cloud ~ ~ ~ {Radius:0.0f,CustomName:"gm4_pl_random_witch_init",Tags:["gm4_pl_random_witch_init","gm4_lt_random_swiftness"]}
summon area_effect_cloud ~ ~ ~ {Radius:0.0f,CustomName:"gm4_pl_random_witch_init",Tags:["gm4_pl_random_witch_init","gm4_lt_random_fire_resistance"]}
summon area_effect_cloud ~ ~ ~ {Radius:0.0f,CustomName:"gm4_pl_random_witch_init",Tags:["gm4_pl_random_witch_init","gm4_lt_random_harming"]}
