# Action for reeled glow item frame
# @s = glow item frame
# at @s
# run from gm4_reeling_rods:fishing/glow_item_frame/adv

data modify storage gm4_reeling_rods:temp item_data.Item set value {id:"minecraft:glow_item_frame",count:1}
