...
execute if data entity @s drop_chances.offhand store result score $drop_chance gm4_reeling_rods.math run data get entity @s drop_chances.offhand 1000
execute unless entity @s[type=#gm4_reeling_rods:ignore_drop_chances] \
  ...
  run return run function gm4_reeling_rods:reeling/stealable/break_slot/offhand
