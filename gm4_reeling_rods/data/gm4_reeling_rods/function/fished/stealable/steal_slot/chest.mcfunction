...
data modify storage gm4_reeling_rods:temp item_data.Item set from entity @s Inventory[{Slot:102b}]
data modify storage gm4_reeling_rods:temp item_data.Item set from entity @s ArmorItems[2]
