...
summon vex ~ ~ ~ {CustomName:'{"translate":"entity.gm4.possessed_item","fallback":"Possessed Item§"}',CustomNameVisible:0,Team:"gm4_hide_name",LifeTicks:320,Attributes:[{Name:"generic.attack_damage",Base:2}],Health:4.0f,Motion:[0.0,0.25,0.0],active_effects:[{id:'minecraft:resistance',amplifier:10,duration:20,show_particles:0b}]}
