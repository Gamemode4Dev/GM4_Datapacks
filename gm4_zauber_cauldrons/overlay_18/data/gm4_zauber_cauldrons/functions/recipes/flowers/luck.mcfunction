...
summon area_effect_cloud ~ ~.75 ~ {Tags:["gm4_zc_luck_cloud"],Radius:1.6f,Duration:10,RadiusOnUse:0.0f,RadiusPerTick:0.0f,ReapplicationDelay:100,Particle:"happy_villager",effects:[{duration:12,id:'minecraft:luck',amplifier:0b,show_particles:0b}]}
