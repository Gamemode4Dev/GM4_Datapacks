...
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Installing Zauber Cauldrons...",{"translate":"text.gm4.modules.update.installing","with":["Zauber Cauldrons"]}]}]
...
#announce success
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Zauber Cauldrons Installed!",{"translate":"text.gm4.modules.update.installed","with":["Zauber Cauldrons"]}]}]
