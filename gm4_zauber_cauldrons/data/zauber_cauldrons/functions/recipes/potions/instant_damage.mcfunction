...
summon item ~ ~.2 ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Lore:["{\"text\":\"Instant Damage IV\",\"color\":\"red\",\"italic\":\"false\"}"]},HideFlags:32,Potion:harming,CustomPotionEffects:[{Id:7,Amplifier:3,Duration:1}]}}}
