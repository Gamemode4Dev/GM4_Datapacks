...
summon item ~ ~.2 ~ {Item:{id:potion,Count:1b,tag:{display:{Lore:["{\"text\":\"Jump Boost IV (1:30)\",\"color\":\"blue\",\"italic\":\"false\"}"]},HideFlags:32,Potion:leaping,CustomPotionEffects:[{Id:8,Amplifier:3,Duration:1800}]}}}
