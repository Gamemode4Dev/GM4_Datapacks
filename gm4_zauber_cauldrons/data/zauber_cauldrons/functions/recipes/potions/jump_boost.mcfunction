...
summon item ~ ~.2 ~ {Item:{id:potion,Count:1b,tag:{display:{Lore:['[{"translate":"effect.minecraft.jump_boost","color":"blue","italic":false},{"text":" IV (1:30)","color":"blue","italic":false}]']},HideFlags:32,Potion:leaping,CustomPotionEffects:[{Id:8,Amplifier:3,Duration:1800}]}}}
