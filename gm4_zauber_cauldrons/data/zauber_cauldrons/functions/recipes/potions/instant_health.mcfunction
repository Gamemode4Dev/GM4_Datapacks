...
summon item ~ ~.2 ~ {Item:{id:potion,Count:1b,tag:{display:{Lore:["§9Instant Health IV§r","§cNausea (0:08)§r"]},HideFlags:32,Potion:healing,CustomPotionEffects:[{Id:6,Amplifier:3,Duration:1},{Id:9,Amplifier:0,Duration:160}]}}}
