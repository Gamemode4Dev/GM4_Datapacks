...
summon item ~ ~.2 ~ {Item:{id:"minecraft:prismarine_shard",Count:1b,tag:{Enchantments:[{lvl:1s,id:"minecraft:unbreaking"}],gm4_zauber_cauldrons:{item:"enchanted_prismarine_shard"},HideFlags:1,display:{Name:'{"translate":"%1$s","with":["Enchanted Prismarine Shard",{"translate":"item.gm4.enchanted_prismarine_shard","color":"aqua","italic":false}]}'}}}}
