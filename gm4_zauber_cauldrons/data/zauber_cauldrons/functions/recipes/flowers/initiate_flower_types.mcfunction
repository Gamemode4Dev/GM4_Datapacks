...
scoreboard players set modulo gm4_zc_flowers 2
...
scoreboard players operation red_tulip gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation orange_tulip gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation white_tulip gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation pink_tulip gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation oxeye_daisy gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation dandelion gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation blue_orchid gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation allium gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation azure_bluet gm4_zc_flowers %= modulo gm4_zc_flowers
scoreboard players operation poppy gm4_zc_flowers %= modulo gm4_zc_flowers

#store amount of non poisonous flowers as 10-<sum of flower scores>
scoreboard players set required_flowers gm4_zc_flowers 10
