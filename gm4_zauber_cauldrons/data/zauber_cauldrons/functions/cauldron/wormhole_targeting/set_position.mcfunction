...
execute if score wormhole_d gm4_zc_data matches 0 positioned as @s in overworld run function zauber_cauldrons:cauldron/wormhole_targeting/set_dimension
execute if score wormhole_d gm4_zc_data matches 1 positioned as @s in the_end run function zauber_cauldrons:cauldron/wormhole_targeting/set_dimension
execute if score wormhole_d gm4_zc_data matches -1 positioned as @s in the_nether run function zauber_cauldrons:cauldron/wormhole_targeting/set_dimension
