...
summon vex ~ ~1.5 ~ {CustomName:'{"translate":"%1$s","with":["Possessed Item",{"translate":"entity.gm4.possessed_item"}]}',CustomNameVisible:0,LifeTicks:320,Attributes:[{Name:generic.attackDamage,Base:2}],Health:4.0,Motion:[0.0,0.25,0.0],ActiveEffects:[{Id:11,Amplifier:10,Duration:20,ShowParticles:0b}]}
