...
execute unless entity @a[tag=gm4_zc_wormhole_consumer,tag=gm4_ta_jammed,limit=1] unless entity @e[type=area_effect_cloud,tag=gm4_zauber_cauldron,dx=0,dy=0,dz=0] run summon tnt ~.5 ~.7 ~.5
