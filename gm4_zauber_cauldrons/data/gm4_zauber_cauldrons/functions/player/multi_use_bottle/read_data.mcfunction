...
execute unless score read_coordinates gm4_zc_data matches 1 if predicate gm4_zauber_cauldrons:player/equipment/multi_use_bottle/in_offhand run function gm4_zauber_cauldrons:player/multi_use_bottle/read_offhand_data
# reset fake player
