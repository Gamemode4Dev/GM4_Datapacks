...
execute in overworld run summon item -32 2 -32 {Item:{id:"minecraft:potion",Count:1b},Tags:["gm4_zc_new_nbt_storage","gm4_zc_nbt_storage"],Age:5999,PickupDelay:32767}
