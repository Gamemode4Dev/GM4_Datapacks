...
execute if score gm4_zauber_cauldrons load matches 1 run function zauber_cauldrons:init
execute unless score gm4_zauber_cauldrons load matches 1 run schedule clear zauber_cauldrons:main
