execute if score gm4 load.status matches 1 if score gm4_forceload load.status matches 1 if score gm4_player_heads load.status matches 1 run scoreboard players set gm4_zauber_cauldrons load.status 1
