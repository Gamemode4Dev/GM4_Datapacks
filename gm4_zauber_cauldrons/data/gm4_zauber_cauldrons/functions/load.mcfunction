...
execute if score gm4 load matches 1 run scoreboard players set gm4_forceload load 1
...
execute unless score gm4_forceload load matches 1 run data modify storage gm4:log queue append value {type:"missing",module:"Zauber Cauldrons",require:"lib-forceload"}
