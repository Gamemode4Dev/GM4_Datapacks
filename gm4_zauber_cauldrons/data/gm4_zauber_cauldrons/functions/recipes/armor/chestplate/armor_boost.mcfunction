...
# set blueprint
data modify storage gm4_zauber_cauldrons:blueprint/item/zauber_armor/attribute/armor_boost CustomModelData set value "item/zauber_armor/armor/chestplate"
