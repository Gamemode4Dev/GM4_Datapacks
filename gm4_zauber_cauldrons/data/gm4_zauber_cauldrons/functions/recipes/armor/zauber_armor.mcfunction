...
#recipes
execute if score recipe_success gm4_zc_data matches 0 as @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:golden_chestplate"}},nbt=!{Item:{tag:{gm4_zauber_cauldrons:{item:"zauber_armor"}}}},limit=1] run function gm4_zauber_cauldrons:recipes/armor/chestplate/apply_modifier
