...
# visuals
execute unless score $has_powder_snow gm4_zc_data matches 1 run fill ~-1 ~ ~-1 ~1 ~1 ~1 fire replace #gm4:air
execute unless score $has_powder_snow gm4_zc_data matches 1 run playsound item.firecharge.use block @a[distance=..8] ~ ~ ~ 0.8 0.6
execute if score $has_powder_snow gm4_zc_data matches 1 run playsound block.redstone_torch.burnout block @a[distance=..8] ~ ~ ~ 0.8 0.6
