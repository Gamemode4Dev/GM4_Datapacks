...
data merge storage gm4_zauber_cauldrons:temp/item/potion/common {Item:{tag:{gm4_zauber_cauldrons:{type:"instant_health"},display:{Lore:['[{"translate":"effect.minecraft.instant_health","color":"blue","italic":false}," ",{"translate":"potion.potency.3","color":"blue","italic":false}]','[{"translate":"effect.minecraft.nausea","color":"red","italic":false},{"text":" (0:08)","color":"red","italic":false}]']},Potion:healing,CustomPotionEffects:[{Id:6,Amplifier:3,Duration:1},{Id:9,Amplifier:0,Duration:160}]}}}
