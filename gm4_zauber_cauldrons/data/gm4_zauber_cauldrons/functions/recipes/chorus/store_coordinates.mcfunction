...
execute if score store_mainhand gm4_zc_data matches 1 run function gm4_zauber_cauldrons:recipes/chorus/store_mainhand_coordinates
execute if score store_offhand gm4_zc_data matches 1 run function gm4_zauber_cauldrons:recipes/chorus/store_offhand_coordinates
