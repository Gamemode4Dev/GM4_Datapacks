...
execute unless score cancel_recipe gm4_zc_data matches 2 if score has_blue_fire gm4_zc_data matches 1 run data modify storage gm4_zauber_cauldrons:temp/item/wormhole/common Item.tag merge value {gm4_zauber_cauldrons:{bottle:{sips:3b,multi_use:1b}},display:{Lore:['[{"text":"3/3 ","color":"gray","italic":false},{"translate":"%1$s%3427655$s","with":[{"text":"Sips"},{"translate":"item.gm4.zauber_cauldrons.multi_use_bottle.lore.sips"}],"color":"gray","italic":false}]'],Name:'{"translate":"%1$s%3427655$s","with":["Ghostly Wormhole in a Bottle",[{"translate":"item.gm4.zauber_cauldrons.multi_use_bottle.level.brimful"},{"translate":"item.gm4.wormhole_in_a_bottle"}]],"italic":"false"}'}}
