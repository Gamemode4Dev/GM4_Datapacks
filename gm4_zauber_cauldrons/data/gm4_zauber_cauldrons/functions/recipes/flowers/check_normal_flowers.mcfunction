...
execute if score pink_tulip gm4_zc_flowers matches 0 if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:pink_tulip"}},limit=1,sort=arbitrary] run scoreboard players add normal_flowers_amount gm4_zc_fullness 1
execute if score oxeye_daisy gm4_zc_flowers matches 0 if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:oxeye_daisy"}},limit=1,sort=arbitrary] run scoreboard players add normal_flowers_amount gm4_zc_fullness 1
execute if score dandelion gm4_zc_flowers matches 0 if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:dandelion"}},limit=1,sort=arbitrary] run scoreboard players add normal_flowers_amount gm4_zc_fullness 1
execute if score blue_orchid gm4_zc_flowers matches 0 if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:blue_orchid"}},limit=1,sort=arbitrary] run scoreboard players add normal_flowers_amount gm4_zc_fullness 1
execute if score allium gm4_zc_flowers matches 0 if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:allium"}},limit=1,sort=arbitrary] run scoreboard players add normal_flowers_amount gm4_zc_fullness 1
execute if score azure_bluet gm4_zc_flowers matches 0 if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:azure_bluet"}},limit=1,sort=arbitrary] run scoreboard players add normal_flowers_amount gm4_zc_fullness 1
execute if score poppy gm4_zc_flowers matches 0 if entity @e[type=item,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:poppy"}},limit=1,sort=arbitrary] run scoreboard players add normal_flowers_amount gm4_zc_fullness 1
