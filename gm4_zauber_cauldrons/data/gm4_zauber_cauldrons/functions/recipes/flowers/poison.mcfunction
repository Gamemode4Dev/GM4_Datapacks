...
summon area_effect_cloud ~ ~.75 ~ {CustomName:'"the mess they made"',Radius:2.1f,Duration:2147483647,RadiusOnUse:-0.1f,RadiusPerTick:-0.005f,ReapplicationDelay:40,effects:[{id:"minecraft:poison",amplifier:2,duration:3200}]}
