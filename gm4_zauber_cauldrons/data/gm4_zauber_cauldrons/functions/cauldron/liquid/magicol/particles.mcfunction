...
execute if score $preferred gm4_zc_moon_phase = $current gm4_zc_moon_phase run particle minecraft:electric_spark ~.5 ~.75 ~.5 0.15 0.15 0.15 0.01 3 normal @a[distance=..8,advancements={gm4_zauber_cauldrons:equipment/has_full_armor=true}]
