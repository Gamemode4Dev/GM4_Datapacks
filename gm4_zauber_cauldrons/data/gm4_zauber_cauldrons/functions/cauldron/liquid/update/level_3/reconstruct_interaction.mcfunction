...
tellraw @a {"text":"Found targeted Zauber Cauldron (level=3).","color":"gray"}
...
execute if score $previous_fill_level gm4_zc_data matches 2 as @a[tag=gm4_zc_actor,limit=1] store result score $item_use_code gm4_zc_data run function gm4_zauber_cauldrons:cauldron/liquid/update/level_3/analyze_held_items/select_gamemode
