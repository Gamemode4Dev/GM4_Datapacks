...
# run from gm4_zauber_cauldrons:cauldron/liquid/level/0/reconstruct_interaction
...
function #gm4_zauber_cauldrons:player/cauldron_interaction/fill_bucket_from_cauldron
...
execute unless score $interaction_intercepted gm4_zc_data matches 1.. as @a[tag=gm4_zc_actor,limit=1] run function gm4_zauber_cauldrons:cauldron/liquid/level/return_bucket
