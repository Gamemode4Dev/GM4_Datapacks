...
# run from gm4_zauber_cauldrons:cauldron/liquid/level/3/ray
...
execute unless score $previous_fill_level gm4_zc_data matches 2 run function gm4_zauber_cauldrons:cauldron/liquid/level/3/item_used/filled_bucket
