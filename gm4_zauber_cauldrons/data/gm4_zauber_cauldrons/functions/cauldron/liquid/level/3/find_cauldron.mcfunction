...
tellraw @a ["","Player set Cauldron to ",{"text":"level=3","color":"yellow"},"!"]
...
execute anchored eyes positioned ^ ^ ^ run function gm4_zauber_cauldrons:cauldron/liquid/level/3/ray
