...
# run from gm4_zauber_cauldrons:cauldron/liquid/level/3/reconstruct_interaction
...
function #gm4_zauber_cauldrons:player/cauldron_interaction/drain_bucket_into_cauldron
