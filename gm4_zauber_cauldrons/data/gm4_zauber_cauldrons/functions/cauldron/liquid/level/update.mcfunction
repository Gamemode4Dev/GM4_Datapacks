...
# TODO remove this
execute if score @s gm4_zc_liquid_level matches 1.. unless entity @e[type=item_display,tag=gm4_zc_liquid,dx=0,limit=1] run summon minecraft:item_display ~.5 ~.5781 ~.5 {item:{id:"minecraft:stone",Count:1b},item_display:"fixed",interpolation_duration:200,interpolation_start:0,transformation:[1.984f,0f,0f,0f,0f,0f,0f,0f,0f,0f,1.984f,0f,0f,0f,0f,1f],Tags:["gm4_zc_liquid"]}
