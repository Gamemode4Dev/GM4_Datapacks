...
function #gm4_zauber_cauldrons:player/cauldron_interaction/drain_bottle_into_cauldron
...
execute unless score $interaction_intercepted gm4_zc_data matches 1.. run function gm4_zauber_cauldrons:cauldron/liquid/level/0/set
execute unless score $interaction_intercepted gm4_zc_data matches 1.. as @a[tag=gm4_zc_actor,limit=1] run function gm4_zauber_cauldrons:cauldron/liquid/level/return_water_bottle
