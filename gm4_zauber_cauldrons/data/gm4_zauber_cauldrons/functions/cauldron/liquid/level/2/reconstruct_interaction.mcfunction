...
# run from gm4_zauber_cauldrons:cauldron/liquid/level/2/ray

tellraw @a {"text":"Found targeted Zauber Cauldron (level=2).","color":"gray"}
...
execute if score $previous_fill_level gm4_zc_data matches 3 run function gm4_zauber_cauldrons:cauldron/liquid/level/2/item_used/glass_bottle

# if the cauldron was at level=1 previously a water bottle must have been used on the cauldron
execute if score $previous_fill_level gm4_zc_data matches 1 run function gm4_zauber_cauldrons:cauldron/liquid/level/2/item_used/water_bottle
