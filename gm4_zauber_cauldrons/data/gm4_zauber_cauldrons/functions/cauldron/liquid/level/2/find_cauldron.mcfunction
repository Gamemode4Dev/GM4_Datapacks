# initiates a raycast to locate a zauber cauldron which was set to minecraft:water_cauldron[level=2] by a player
...
tellraw @a ["","Player set Cauldron to ",{"text":"level=2","color":"yellow"},"!"]
...
execute anchored eyes positioned ^ ^ ^ run function gm4_zauber_cauldrons:cauldron/liquid/level/2/ray
