...
execute if score @s gm4_zc_liquid_level matches 0..3 store success score $has_liquid gm4_zc_data run function gm4_zauber_cauldrons:cauldron/liquid/update/from_score
