...
execute if score bottle_count gm4_zc_fullness matches 1.. if score @s gm4_zc_fullness matches 2.. align xyz run function gm4_zauber_cauldrons:cauldron/extra_items/prepare_bottle
