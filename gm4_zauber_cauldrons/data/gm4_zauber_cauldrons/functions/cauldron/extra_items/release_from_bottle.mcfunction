...
# release the vexes
execute if score @s gm4_zc_data matches 1.. run particle minecraft:block glass ~ ~ ~ 0.12 0.12 0.12 0 15
execute if score @s gm4_zc_data matches 1 run playsound minecraft:block.glass.break block @a[distance=..8] ~ ~ ~ 0.1 1.9
