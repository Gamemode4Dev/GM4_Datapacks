...
#release the vexes
execute if score @s gm4_zc_data matches 2.. run particle block glass ~ ~ ~ 0.12 0.12 0.12 0 15
execute if score @s gm4_zc_data matches 2.. run playsound block.glass.break block @a[distance=..8] ~ ~ ~ 1 1.3
