...
execute if score @s gm4_zc_moon_phase = $current gm4_zc_moon_phase run particle enchant ~ ~.2 ~ 0.1 0.1 0.1 0.4 2 normal @a[distance=..8,advancements={gm4_zauber_cauldrons:equipment/has_full_armor=true}]
