...
summon minecraft:item_display ~.5 ~.5 ~.125 {item:{id:"minecraft:structure_void",Count:1b,tag:{CustomModelData:3420000}},item_display:"thirdperson_righthand",Tags:["gm4_zc_texture"]}
