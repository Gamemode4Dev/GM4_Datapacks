...
summon minecraft:item_display ~.5 ~.5 ~.125 {CustomName:'"gm4_zc_texture"',item:{id:"minecraft:structure_void",count:1,tag:{CustomModelData:'block/zauber_cauldron'}},item_display:"thirdperson_righthand",Tags:["gm4_zc_texture","smithed.entity","smithed.strict"]}
