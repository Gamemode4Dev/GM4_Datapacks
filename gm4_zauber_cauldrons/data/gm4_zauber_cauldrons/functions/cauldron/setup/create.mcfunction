...
summon area_effect_cloud ~.5 ~.5 ~.5 {Radius:0,Age:-40,CustomName:'"gm4_zc_creation_animation"',Tags:["gm4_zc_creation_animation"],Particle:{type:"minecraft:block",block_state:"minecraft:air"}}
