...
#give CustomModelData to old zauber armour
execute as @e[type=item,nbt={Item:{tag:{gm4_zauber_cauldrons:{item:"zauber_armor"}}}}] unless data entity @s Item.tag.CustomModelData run data modify entity @s Item.tag.CustomModelData set value 2
