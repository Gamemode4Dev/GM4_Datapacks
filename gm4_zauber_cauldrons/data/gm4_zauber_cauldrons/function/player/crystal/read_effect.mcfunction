...
# move to storage
data modify storage gm4_zauber_cauldrons:temp/player/equipment/offhand gm4_zauber_cauldrons set from entity @s equipment.offhand.components."minecraft:custom_data".gm4_zauber_cauldrons
