...
def read_json(path: Path) -> Any:
    ...
    """
    with open(Path('gm4_zauber_cauldrons', 'raw', 'crystal_lores.json'), mode='r') as file:
...
def generate_armor_recipes(ctx: Context):
    ...
    """
    armor_flavors: List[Dict[str, str]] = read_csv(Path('gm4_zauber_cauldrons', 'raw', 'armor_flavors.csv'))
    armor_pieces: List[Dict[str, str]] = read_csv(Path('gm4_zauber_cauldrons', 'raw', 'armor_pieces.csv'))
...
def generate_crystal_recipes(ctx: Context):
    ...
    """
    crystal_effects: List[Dict[str, str]] = read_csv(Path('gm4_zauber_cauldrons', 'raw', 'crystal_effects.csv'))
    crystal_lores: Any = read_json(Path('gm4_zauber_cauldrons', 'raw', 'crystal_lores.json'))
