...
execute if score @s gm4_bookshelf_nametags_walk matches 1.. run scoreboard players set $evaluate gm4_bookshelf_nametags_data 0
execute if score @s gm4_bookshelf_nametags_sprint matches 1.. run scoreboard players set $evaluate gm4_bookshelf_nametags_data 0
...
execute if score $evaluate gm4_bookshelf_nametags_data matches 0 run scoreboard players reset @s gm4_bookshelf_nametags_standing_still
