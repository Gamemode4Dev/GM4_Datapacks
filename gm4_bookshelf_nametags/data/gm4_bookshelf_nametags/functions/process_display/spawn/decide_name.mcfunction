...
execute if data storage gm4_bookshelf_nametags:temp book_data{id:"minecraft:enchanted_book"}.tag.display.Name store success score $name_given gm4_bookshelf_nametags_data run data modify storage gm4_bookshelf_nametags:temp text append value '[{"text":"","color":"yellow"},{"nbt":"book_data.tag.display.Name","storage":"gm4_bookshelf_nametags:temp","interpret":true}]'
execute unless score $name_given gm4_bookshelf_nametags_data matches 1 if data storage gm4_bookshelf_nametags:temp book_data.tag.Enchantments if data storage gm4_bookshelf_nametags:temp book_data.tag.display.Name unless data storage gm4_bookshelf_nametags:temp book_data{id:"minecraft:enchanted_book"} store success score $name_given gm4_bookshelf_nametags_data run data modify storage gm4_bookshelf_nametags:temp text append value '[{"text":"","color":"aqua"},{"nbt":"book_data.tag.display.Name","storage":"gm4_bookshelf_nametags:temp","interpret":true}]'
...
execute unless score $name_given gm4_bookshelf_nametags_data matches 1 store success score $name_given gm4_bookshelf_nametags_data if data storage gm4_bookshelf_nametags:temp book_data{id:"minecraft:knowledge_book"} run data modify storage gm4_bookshelf_nametags:temp text append value '{"translate":"item.minecraft.knowledge_book","color":"light_purple"}'
...
execute if data storage gm4_bookshelf_nametags:temp book_data{id:"minecraft:enchanted_book"}.tag.StoredEnchantments run function gm4_bookshelf_nametags:process_display/spawn/list_enchantments
