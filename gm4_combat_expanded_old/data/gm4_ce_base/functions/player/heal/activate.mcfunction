...
execute if predicate gm4_ce_base:modified_armor/half run function gm4_ce_base:armor/modifier/type/half/limit_heal
...
execute unless score $remove_health gm4_ce_data matches 0 run function gm4_ce_base:player/heal/eval with storage gm4_combat_expanded:temp heal_player
data remove storage gm4_combat_expanded:temp heal_player.remove_health

# prepare reverting
tag @s add gm4_ce_healed
schedule function gm4_ce_base:player/heal/context 1t
