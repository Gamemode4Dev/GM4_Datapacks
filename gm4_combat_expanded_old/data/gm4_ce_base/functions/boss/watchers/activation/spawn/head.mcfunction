...
execute unless score $boss_has_twin gm4_ce_boss matches 1 run function gm4_ce_base:boss/watchers/activation/spawn/bossbar_no_twin with storage gm4_combat_expanded:temp boss
execute if score $boss_has_twin gm4_ce_boss matches 1 run function gm4_ce_base:boss/watchers/activation/spawn/bossbar_with_twin with storage gm4_combat_expanded:temp boss
data remove storage gm4_combat_expanded:temp boss

execute as @e[tag=gm4_ce_boss.watcher.new] run function gm4_ce_base:boss/watchers/activation/spawn/head_init
scoreboard players reset $boss_has_twin gm4_ce_boss

schedule function gm4_ce_base:clocks/boss/watchers 1t
