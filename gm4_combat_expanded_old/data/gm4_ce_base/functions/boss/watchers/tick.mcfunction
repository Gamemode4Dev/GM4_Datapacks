...
execute if entity @s[tag=gm4_ce_boss.watcher.has_twin] as @e[type=shulker,tag=gm4_ce_boss.watcher.secondary] if score @s gm4_ce_boss.secondary_id = $running_id gm4_ce_boss.id at @s run function gm4_ce_base:boss/watchers/tick_twin
...
execute unless score $health gm4_ce_boss matches 960 if score @s gm4_ce_boss.phase matches 1.. run function gm4_ce_base:boss/watchers/running/health/update
execute if score $health gm4_ce_boss matches 960 if score $twin_health_change gm4_ce_boss matches 1.. run function gm4_ce_base:boss/watchers/running/health/update
scoreboard players reset $twin_health_change gm4_ce_boss

# update health bar
function gm4_ce_base:boss/watchers/running/health/bossbar with storage gm4_combat_expanded:temp boss
...
execute unless score @s gm4_ce_boss.tick_delay matches 1.. run function gm4_ce_base:boss/watchers/running/process
