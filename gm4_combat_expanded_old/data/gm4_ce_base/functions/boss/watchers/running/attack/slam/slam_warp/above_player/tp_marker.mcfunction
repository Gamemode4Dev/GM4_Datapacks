...
execute at @s run function gm4_ce_base:boss/watchers/running/attack/slam/slam_warp/above_player/set_ypos

scoreboard players add $warp_attempt gm4_ce_boss 1
execute unless score $warp_attempt gm4_ce_boss matches 11.. run function gm4_ce_base:boss/watchers/running/attack/slam/slam_warp/above_player/randomize
