...
function gm4_ce_base:boss/watchers/running/attack/aura/particle_ring
...
execute if score @s gm4_ce_boss.attack_progress matches 60 run function gm4_ce_base:boss/watchers/running/attack/aura/end
