...
execute at @s run function gm4_ce_base:boss/watchers/running/attack/warp/pick_location_near/set_ypos

scoreboard players add $warp_attempt gm4_ce_boss 1
execute unless score $warp_attempt gm4_ce_boss matches 33.. run function gm4_ce_base:boss/watchers/running/attack/warp/pick_location_near/randomize
