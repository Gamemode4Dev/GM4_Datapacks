...
execute if score @s gm4_ce_boss.attack_progress matches 2 run function gm4_ce_base:boss/watchers/running/attack/warp/away
execute if score @s gm4_ce_boss.attack_progress matches 3 run function gm4_ce_base:boss/watchers/running/attack/warp/pick_location
execute if score @s gm4_ce_boss.attack_progress matches 4 run function gm4_ce_base:boss/watchers/running/attack/warp/end
