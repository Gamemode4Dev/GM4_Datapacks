...
execute unless score $set_y gm4_ce_boss matches 3.. at @s unless score $warp_safe gm4_ce_boss matches 1 run function gm4_ce_base:boss/watchers/running/attack/warp/pick_location_near/set_ypos
