...
execute if score @s[tag=gm4_ce_boss.watcher.has_twin] gm4_ce_boss.attack_progress matches 45 run function gm4_ce_base:boss/watchers/activation/spawn_sentinel/head

execute if score @s gm4_ce_boss.attack_progress matches 46 run function gm4_ce_base:boss/watchers/running/attack/spawn/end
