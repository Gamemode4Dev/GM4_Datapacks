...
data merge entity @s {ExplosionPower:3b,Tags:["gm4_ce_boss.fireball"],power:[0.0,-0.05,0.0],Item:{id:"minecraft:budding_amethyst",count:1}}
...
# get player pos
execute positioned ^ ^ ^3 summon marker run function gm4_ce_base:boss/watchers/running/attack/fireball/get_target_pos
