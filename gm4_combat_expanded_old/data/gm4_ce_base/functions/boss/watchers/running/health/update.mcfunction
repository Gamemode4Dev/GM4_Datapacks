...
execute if score $health_change gm4_ce_boss matches 1.. if score @s gm4_ce_boss.health matches 1.. summon item_display run function gm4_ce_base:boss/watchers/running/health/init_display
...
execute if score @s gm4_ce_boss.health matches ..0 run function gm4_ce_base:boss/watchers/defeated/kill
