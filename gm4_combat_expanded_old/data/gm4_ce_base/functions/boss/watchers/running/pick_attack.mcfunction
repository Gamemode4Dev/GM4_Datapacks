...
execute unless score @s[scores={gm4_ce_boss.attack_id=0}] gm4_ce_boss.last_attack matches 4 positioned ~-3 ~-20 ~-3 align xyz if entity @a[gamemode=!spectator,gamemode=!creative,dx=6,dy=16,dz=6] if predicate gm4_ce_base:technical/chance/boss/slam_attack run scoreboard players set @s gm4_ce_boss.attack_id 4
...
execute as @e[type=#gm4_ce_base:zombie_types,tag=gm4_ce_boss.watcher.minion] if score @s gm4_ce_boss.id = $running_id gm4_ce_boss.id at @s if entity @p[gamemode=!spectator,gamemode=!creative,distance=..5] run scoreboard players set $explode_minions_valid gm4_ce_boss 1
execute unless score @s[tag=gm4_ce_boss.watcher.main,scores={gm4_ce_boss.attack_id=0,gm4_ce_boss.phase=2..}] gm4_ce_boss.last_attack matches 6 if score $explode_minions_valid gm4_ce_boss matches 1 if predicate gm4_ce_base:technical/chance/boss/explode_minions run scoreboard players set @s gm4_ce_boss.attack_id 6
...
execute store result score $minion_count gm4_ce_boss if entity @e[type=#gm4_ce_base:zombie_types,tag=gm4_ce_boss.watcher.minion,distance=..64]
...
execute unless score @s[scores={gm4_ce_boss.attack_id=0}] gm4_ce_boss.last_attack matches 5 unless score $minion_count gm4_ce_boss >= $mob_limit gm4_ce_boss if entity @a[gamemode=!spectator,gamemode=!creative,distance=5..18] if predicate gm4_ce_base:technical/chance/boss/summon_minions run scoreboard players set @s gm4_ce_boss.attack_id 5
...
execute unless score @s[scores={gm4_ce_boss.attack_id=0,gm4_ce_boss.phase=2..}] gm4_ce_boss.last_attack matches 7 if entity @p[gamemode=!spectator,gamemode=!creative,distance=..5.25] positioned ~-5.5 ~-1.5 ~-5.5 if entity @p[gamemode=!spectator,gamemode=!creative,dx=10,dy=2,dz=10] if predicate gm4_ce_base:technical/chance/boss/aura_attack run scoreboard players set @s gm4_ce_boss.attack_id 7
...
execute unless score @s[scores={gm4_ce_boss.attack_id=0}] gm4_ce_boss.last_attack matches 2 if entity @p[gamemode=!spectator,gamemode=!creative,distance=8..20] if predicate gm4_ce_base:technical/chance/boss/fireball_attack run scoreboard players set @s gm4_ce_boss.attack_id 2
