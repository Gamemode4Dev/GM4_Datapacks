...
execute if items entity @s contents *[custom_data~{gm4_combat_expanded:{identified:0}}] at @s run function gm4_ce_base:identification/prep

# check for spores
execute if score $item_processed gm4_ce_data matches 0 if items entity @s contents *[custom_data~{gm4_ce_spore:{}}] run function gm4_ce_base:mob/process/spore/initialise
