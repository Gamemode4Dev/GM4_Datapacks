...
# set armor
loot replace entity @s[predicate=gm4_ce_base:mob/modifier/nether/crimson_forest] armor.feet loot gm4_ce_base:mob/equip_armor/piglin
# set weapon
loot replace entity @s weapon.mainhand loot gm4_ce_base:weapon/sword/gold
