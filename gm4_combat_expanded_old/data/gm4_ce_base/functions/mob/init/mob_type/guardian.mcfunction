...
# | Biome Modifiers
# reef
execute if predicate gm4_ce_base:mob/modifier/reef run scoreboard players set $mob_damage gm4_ce_data 90
scoreboard players set @s[predicate=gm4_ce_base:mob/modifier/reef] gm4_ce_damage_cap 120
