...
# | Biome Modifiers
# nether wastes
attribute @s[predicate=gm4_ce_base:mob/modifier/nether/nether_wastes] generic.movement_speed modifier add 069b5956-3cc2-4201-8550-a5d2f9552556 "gm4_ce_modifier_nether_wastes" 1 add_multiplied_base
