...
# | Biome Modifiers
# snowy
execute if score $size gm4_ce_data matches 1..2 if predicate gm4_ce_base:mob/modifier/snowy run scoreboard players add $size gm4_ce_data 1
# flowering 
execute if predicate gm4_ce_base:mob/modifier/flowering run function gm4_ce_base:mob/init/special/flowering_slime
# toxic
tag @s[type=slime,predicate=gm4_ce_base:mob/modifier/toxic] add gm4_ce_poison_attack
# growth
execute if score $size gm4_ce_data matches 1.. if entity @s[type=slime,tag=!gm4_ce_extra_mob,predicate=gm4_ce_base:mob/modifier/growth] run function gm4_ce_base:mob/init/special/growth_slime
# basalt deltas
execute if score $size gm4_ce_data matches 1..2 if entity @s[type=magma_cube,predicate=gm4_ce_base:mob/modifier/nether/basalt_deltas] run scoreboard players add $size gm4_ce_data 1
