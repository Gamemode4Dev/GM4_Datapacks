...
# mountainous +20%
execute if predicate gm4_ce_base:mob/modifier/mountainous run scoreboard players add $difficulty_mult gm4_ce_data 20
...
function gm4_ce_base:mob/init/mob_type
