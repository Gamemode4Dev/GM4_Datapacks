...
execute anchored eyes positioned ^ ^ ^3 as @e[distance=..5,tag=!gm4_ce_self,predicate=gm4_ce_base:technical/unblocked_hit,team=!gm4_ce_team_check,tag=!smithed.strict,tag=!gm4_ce_immune_poison] run function gm4_ce_base:weapon/modifier/pierce/apply
