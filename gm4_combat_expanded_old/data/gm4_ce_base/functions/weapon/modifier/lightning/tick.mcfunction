...
execute rotated 0 0 run function gm4_ce_base:weapon/modifier/lightning/particles/eval_rotation with storage gm4_combat_expanded:temp lightning
...
execute if score @s gm4_ce_lightning_charge.striking matches 45.. run function gm4_ce_base:weapon/modifier/lightning/strike
