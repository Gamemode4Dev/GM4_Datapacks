...
execute as @e[distance=0.01..2.5,type=!player,predicate=gm4_ce_base:technical/unblocked_hit,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 21 lightning_bolt at ~ ~ ~
