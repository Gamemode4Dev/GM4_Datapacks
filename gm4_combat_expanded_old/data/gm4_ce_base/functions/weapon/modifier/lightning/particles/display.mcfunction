...
$execute if score $particles_to_display gm4_ce_data matches 1.. rotated ~$(deg_pp) ~ run function gm4_ce_base:weapon/modifier/lightning/particles/display with storage gm4_combat_expanded:temp lightning
