...
execute anchored eyes positioned ^ ^ ^3 as @e[distance=..5,tag=!gm4_ce_self,team=!gm4_ce_team_check,type=!armor_stand,tag=!gm4_ce_delay_active,nbt={HurtTime:10s},tag=!smithed.strict] at @s run function gm4_ce_base:weapon/modifier/delay/prime
