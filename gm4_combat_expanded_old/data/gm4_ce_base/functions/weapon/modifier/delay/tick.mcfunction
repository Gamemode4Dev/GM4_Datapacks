...
execute if score @s[type=!player] gm4_ce_t_delay matches 4.. run function gm4_ce_base:weapon/modifier/delay/explode_entity
execute if score @s[type=player] gm4_ce_t_delay matches 4.. run function gm4_ce_base:weapon/modifier/delay/explode_player
