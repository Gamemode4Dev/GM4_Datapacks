...
loot replace block 29999998 1 7134 container.2 loot gm4_ce_base:technical/sharpness_lore
...
function gm4_ce_base:item_modify_eval/sharpness_lore with storage gm4_combat_expanded:temp sharpness
data remove storage gm4_combat_expanded:temp sharpness

function gm4_ce_base:item_modify_eval/mainhand_update with storage gm4_combat_expanded:temp
