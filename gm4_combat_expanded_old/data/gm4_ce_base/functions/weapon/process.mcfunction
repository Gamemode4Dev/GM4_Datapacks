...
# at @s
advancement revoke @s only gm4_ce_base:used_strike_weapon
...
execute if score $modifier gm4_ce_data matches 101.. run function gm4_ce_base:weapon/check_modifier
...
execute unless score $stored_sharpness gm4_ce_data = $current_sharpness gm4_ce_data run function gm4_ce_base:weapon/update_sharpness

# check netherite conversion
execute if predicate gm4_ce_base:technical/convert_netherite/weapon run function gm4_ce_base:weapon/convert_netherite
