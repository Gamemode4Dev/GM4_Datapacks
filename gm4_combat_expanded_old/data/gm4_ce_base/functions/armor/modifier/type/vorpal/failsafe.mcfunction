...
execute as @e[type=marker,tag=gm4_ce_vorpal] run function gm4_ce_base:armor/modifier/type/vorpal/eval_failsafe with storage gm4_combat_expanded:temp vorpal
data remove storage gm4_combat_expanded:temp vorpal

# teleport
function gm4_ce_base:armor/modifier/type/vorpal/tp_player
