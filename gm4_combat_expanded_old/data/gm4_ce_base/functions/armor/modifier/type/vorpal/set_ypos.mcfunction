...
execute at @s if predicate gm4_ce_base:technical/valid_tp run scoreboard players set $warp_safe gm4_ce_data 1
execute if score $warp_safe gm4_ce_data matches 1 run scoreboard players set $warp_attempt gm4_ce_data 33
execute unless score $set_y gm4_ce_data matches 17.. at @s unless score $warp_safe gm4_ce_data matches 1 run function gm4_ce_base:armor/modifier/type/vorpal/set_ypos
