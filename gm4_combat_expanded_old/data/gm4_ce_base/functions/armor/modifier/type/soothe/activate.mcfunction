...
execute positioned ~ ~.6 ~ summon marker at @s run function gm4_ce_base:armor/modifier/type/soothe/particles
...
function gm4_ce_base:armor/modifier/type/soothe/recharge_text with storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded
