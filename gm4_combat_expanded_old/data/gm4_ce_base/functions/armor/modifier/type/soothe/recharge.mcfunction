...
execute if score $recharge gm4_ce_data >= $max_charge gm4_ce_data run function gm4_ce_base:armor/modifier/type/soothe/recharge_fully
execute unless score $recharge gm4_ce_data >= $max_charge gm4_ce_data run function gm4_ce_base:armor/modifier/type/soothe/recharge_text with storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded
