...
execute if data storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded{modifier:convert} run function gm4_ce_base:armor/modifier/type/convert/calc_conversion
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:item_modify_eval/head_update with storage gm4_combat_expanded:temp
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:armor/slot/silence_equip_sound
...
execute if data storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded{modifier:convert} run function gm4_ce_base:armor/modifier/type/convert/calc_conversion
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:item_modify_eval/chest_update with storage gm4_combat_expanded:temp
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:armor/slot/silence_equip_sound
data remove storage gm4_combat_expanded:temp components
...
execute if data storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded{modifier:convert} run function gm4_ce_base:armor/modifier/type/convert/calc_conversion
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:item_modify_eval/legs_update with storage gm4_combat_expanded:temp
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:armor/slot/silence_equip_sound
data remove storage gm4_combat_expanded:temp components
...
execute if data storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded{modifier:convert} run function gm4_ce_base:armor/modifier/type/convert/calc_conversion
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:item_modify_eval/feet_update with storage gm4_combat_expanded:temp
execute if score $change gm4_ce_data matches 1 run function gm4_ce_base:armor/slot/silence_equip_sound
data remove storage gm4_combat_expanded:temp components

# revoke advancement at the end to not trigger from changes made
advancement revoke @s only gm4_ce_base:wear_convert
