...
# at @s
advancement revoke @s only gm4_ce_base:damaged/armor/burn
...
execute unless score $keep_tick.burn gm4_ce_keep_tick matches 1 run schedule function gm4_ce_base:clocks/temp/burn 1t
