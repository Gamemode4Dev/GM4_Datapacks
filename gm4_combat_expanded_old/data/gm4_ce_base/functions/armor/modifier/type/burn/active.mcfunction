...
# particles
execute positioned ~ ~.9 ~ summon marker at @s run function gm4_ce_base:armor/modifier/type/burn/particles
...
execute as @e[tag=!gm4_ce_self,predicate=!gm4_combat_expanded:modified_armor/burn,predicate=gm4_ce_base:technical/pvp_able,team=!gm4_ce_team_check,tag=!smithed.strict,distance=..5.25] at @s run function gm4_ce_base:armor/modifier/type/burn/eval with storage gm4_combat_expanded:temp burn
