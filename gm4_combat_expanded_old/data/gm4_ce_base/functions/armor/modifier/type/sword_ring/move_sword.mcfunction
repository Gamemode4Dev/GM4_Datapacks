...
execute unless score @s gm4_ce_data = $sword_material gm4_ce_data run function gm4_ce_base:armor/modifier/type/sword_ring/change_material
...
execute if score $sword_material gm4_ce_data matches 1 at @s positioned ~-.15 ~-.15 ~-.15 as @e[tag=!gm4_ce_self,dx=0,dy=0,dz=0,predicate=gm4_ce_base:technical/pvp_able,team=!gm4_ce_team_check,tag=!smithed.strict] positioned ~-.7 ~-.7 ~-.7 if entity @s[dx=0,dy=0,dz=0] store success score $damage_dealt gm4_ce_data run damage @s 2 player_attack by @p[tag=gm4_ce_self]
execute if score $sword_material gm4_ce_data matches 2 at @s positioned ~-.15 ~-.15 ~-.15 as @e[tag=!gm4_ce_self,dx=0,dy=0,dz=0,predicate=gm4_ce_base:technical/pvp_able,team=!gm4_ce_team_check,tag=!smithed.strict] positioned ~-.7 ~-.7 ~-.7 if entity @s[dx=0,dy=0,dz=0] store success score $damage_dealt gm4_ce_data run damage @s 3 player_attack by @p[tag=gm4_ce_self]
execute if score $sword_material gm4_ce_data matches 3..4 at @s positioned ~-.15 ~-.15 ~-.15 as @e[tag=!gm4_ce_self,dx=0,dy=0,dz=0,predicate=gm4_ce_base:technical/pvp_able,team=!gm4_ce_team_check,tag=!smithed.strict] positioned ~-.7 ~-.7 ~-.7 if entity @s[dx=0,dy=0,dz=0] store success score $damage_dealt gm4_ce_data run damage @s 4 player_attack by @p[tag=gm4_ce_self]
execute if score $sword_material gm4_ce_data matches 5..6 at @s positioned ~-.15 ~-.15 ~-.15 as @e[tag=!gm4_ce_self,dx=0,dy=0,dz=0,predicate=gm4_ce_base:technical/pvp_able,team=!gm4_ce_team_check,tag=!smithed.strict] positioned ~-.7 ~-.7 ~-.7 if entity @s[dx=0,dy=0,dz=0] store success score $damage_dealt gm4_ce_data run damage @s 5 player_attack by @p[tag=gm4_ce_self]
execute if score $damage_dealt gm4_ce_data matches 1 at @s run function gm4_ce_base:armor/modifier/type/sword_ring/damage_dealt/run
