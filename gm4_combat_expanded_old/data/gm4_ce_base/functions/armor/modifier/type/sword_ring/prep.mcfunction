...
function gm4_ce_base:armor/modifier/type/sword_ring/get_relevant_data
...
execute if predicate gm4_ce_base:technical/crouching run function gm4_ce_base:armor/modifier/type/sword_ring/set_stats_crouching
execute if score $stats_set gm4_ce_data matches 0 run function gm4_ce_base:armor/modifier/type/sword_ring/set_stats
...
function gm4_ce_base:armor/modifier/type/sword_ring/eval_deg with storage gm4_combat_expanded:temp sword_ring
