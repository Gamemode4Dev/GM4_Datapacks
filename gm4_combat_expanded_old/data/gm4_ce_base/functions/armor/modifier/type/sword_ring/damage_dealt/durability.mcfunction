...
execute store result score $incoming_damage gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_ce_base:technical/roll_damage

# if damage should be dealt apply it
execute if score $incoming_damage gm4_ce_data matches 1.. run function gm4_ce_base:armor/modifier/type/sword_ring/damage_dealt/apply_durability
