...
execute as @p[tag=gm4_ce_target] run function gm4_ce_base:item_modify_eval/set_damage with storage gm4_combat_expanded:temp
execute as @p[tag=gm4_ce_target] run function gm4_ce_base:armor/slot/silence_equip_sound
