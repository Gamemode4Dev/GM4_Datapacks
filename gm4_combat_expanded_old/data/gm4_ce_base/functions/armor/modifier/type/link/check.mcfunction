...
execute if score $renamed gm4_ce_data matches 1 run function gm4_ce_base:armor/modifier/type/link/format_name with storage gm4_combat_expanded:temp format_name_args
...
function gm4_ce_base:armor/modifier/type/link/search_links
...
execute if score @s gm4_ce_link_id matches 0 run function gm4_ce_base:armor/modifier/type/link/create_link
...
# start clock
execute unless score $keep_tick.link gm4_ce_keep_tick matches 1 run schedule function gm4_ce_base:clocks/temp/link 1t
