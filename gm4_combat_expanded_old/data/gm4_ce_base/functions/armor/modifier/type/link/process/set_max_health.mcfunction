...
execute if score @s gm4_ce_link_slot matches 0 run function gm4_ce_base:item_modify_eval/head_update with storage gm4_combat_expanded:temp
execute if score @s gm4_ce_link_slot matches 1 run function gm4_ce_base:item_modify_eval/chest_update with storage gm4_combat_expanded:temp
execute if score @s gm4_ce_link_slot matches 2 run function gm4_ce_base:item_modify_eval/legs_update with storage gm4_combat_expanded:temp
execute if score @s gm4_ce_link_slot matches 3 run function gm4_ce_base:item_modify_eval/feet_update with storage gm4_combat_expanded:temp
function gm4_ce_base:armor/slot/silence_equip_sound
