...
execute if score $link_players gm4_ce_data matches 1 as @p[tag=gm4_ce_link.process] run function gm4_ce_base:armor/modifier/type/link/process/one_player_link
execute if score $link_players gm4_ce_data matches 2.. run function gm4_ce_base:armor/modifier/type/link/process/process_link

# check for more links
data remove storage gm4_combat_expanded:temp run_links[0]
execute if data storage gm4_combat_expanded:temp run_links[0] run function gm4_ce_base:armor/modifier/type/link/process/loop_links
