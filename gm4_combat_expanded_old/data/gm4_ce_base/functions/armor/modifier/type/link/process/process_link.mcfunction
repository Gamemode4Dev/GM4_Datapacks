...
execute if score $link.calc_max_health gm4_ce_data matches 1 run function gm4_ce_base:armor/modifier/type/link/process/calc_max_health
...
execute as @a[tag=gm4_ce_link.process,tag=gm4_ce_was_linked] run function gm4_ce_base:armor/modifier/type/link/process/calc_health_change
...
execute if score $link_health gm4_ce_data matches 1.. as @a[tag=gm4_ce_link.process] run function gm4_ce_base:armor/modifier/type/link/process/set_health
execute unless score $link_health gm4_ce_data matches 1.. run function gm4_ce_base:armor/modifier/type/link/process/death
