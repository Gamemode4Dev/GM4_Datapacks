...
execute unless entity @e[type=armor_stand,tag=gm4_ce_totem,distance=..18,limit=1] run schedule function gm4_ce_base:clocks/temp/totem 1t
...
execute if score $level gm4_ce_data matches 1 as @e[type=armor_stand,tag=gm4_ce_totem,distance=..18,limit=1,sort=nearest] at @s run function gm4_ce_base:armor/modifier/type/totem/regeneration
execute if score $level gm4_ce_data matches 2 as @e[type=armor_stand,tag=gm4_ce_totem,distance=..18,limit=1,sort=nearest] at @s run function gm4_ce_base:armor/modifier/type/totem/resistance
execute if score $level gm4_ce_data matches 3 as @e[type=armor_stand,tag=gm4_ce_totem,distance=..18,limit=1,sort=nearest] at @s run function gm4_ce_base:armor/modifier/type/totem/speed
execute if score $level gm4_ce_data matches 4 as @e[type=armor_stand,tag=gm4_ce_totem,distance=..18,limit=1,sort=nearest] at @s run function gm4_ce_base:armor/modifier/type/totem/strength
