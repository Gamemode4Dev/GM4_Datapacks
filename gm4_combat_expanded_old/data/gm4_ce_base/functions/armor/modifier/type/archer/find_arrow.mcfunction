...
execute anchored eyes positioned ^ ^ ^2 as @e[type=#gm4_ce_base:arrow,tag=!gm4_ce_archer_arrow,distance=..2.5,sort=nearest] at @s run function gm4_ce_base:armor/modifier/type/archer/apply
