...
execute if score $modifier gm4_ce_data matches 10..29 run function gm4_ce_base:armor/modifier/safety
# when having killed a mob in the last 0.8 seconds
execute if score $modifier gm4_ce_data matches 30..39 run function gm4_ce_base:armor/modifier/killing
# when below or above 50% hp
execute if score $modifier gm4_ce_data matches 40..59 run function gm4_ce_base:armor/modifier/hp_check
# when equipped
execute if score $modifier gm4_ce_data matches 60..79 run function gm4_ce_base:armor/modifier/equip
