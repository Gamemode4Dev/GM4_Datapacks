...
execute if entity @s[tag=!gm4_ce_wearing_archer,predicate=gm4_ce_base:modified_armor/archer] run function gm4_ce_base:armor/modifier/type/archer/activate
...
execute if entity @s[tag=gm4_ce_immune_active] run function gm4_ce_base:player/clear_immunities

# process armor
execute if predicate gm4_ce_base:modified_armor/wearing run function gm4_ce_base:armor/process

# shield players if they have stored shield
execute if score @s gm4_ce_absorp matches 1.. run function gm4_ce_base:player/shield/prep
...
execute if entity @s[tag=gm4_ce_dev] at @s as @e[type=#gm4_ce_base:modify,limit=1,sort=nearest] run function gm4_ce_base:debug/dont_run/dev 
