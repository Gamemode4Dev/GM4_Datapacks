...
execute as @a[predicate=gm4_ce_base:modified_armor/sword_ring,gamemode=!spectator] at @s run function gm4_ce_base:armor/modifier/type/sword_ring/prep
...
execute if score $keep_tick.sword_ring gm4_ce_keep_tick matches 1 run schedule function gm4_ce_base:clocks/temp/sword_ring 1t
