...
execute as @a[tag=gm4_ce_linked] run function gm4_ce_base:player/calculate_hp
...
execute if score $keep_tick.link gm4_ce_keep_tick matches 1 run schedule function gm4_ce_base:clocks/temp/link 1t
