...
execute as @e[type=shulker,tag=gm4_ce_boss.watcher.main] at @s run function gm4_ce_base:boss/watchers/tick
...
execute if score $keep_tick.boss gm4_ce_keep_tick matches 1 run schedule function gm4_ce_base:clocks/boss/watchers 1t
