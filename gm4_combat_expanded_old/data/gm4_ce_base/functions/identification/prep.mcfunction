...
execute if data storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded.slot run function gm4_ce_base:identification/armor/pick_mod
execute if data storage gm4_combat_expanded:temp components."minecraft:custom_data".gm4_combat_expanded.strike run function gm4_ce_base:identification/weapon/pick_mod
