...
# attack damage 0.5 - 2
execute store result score $damage gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_ce_base:randomizer/damage
...
# movement speed 5 - 20
execute store result score $speed gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_ce_base:randomizer/speed
...
# attack speed 2 - 5
execute store result score $atkspeed gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_ce_base:randomizer/atkspeed
...
# random value 1 - 3
execute store result score $random_value gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_ce_base:randomizer/armor
