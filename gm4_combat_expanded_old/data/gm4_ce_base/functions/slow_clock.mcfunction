...
# cleanup totems
execute as @e[type=armor_stand,tag=gm4_ce_totem] at @s unless entity @a[distance=..32,gamemode=!spectator] run function gm4_ce_base:armor/modifier/type/totem/remove
