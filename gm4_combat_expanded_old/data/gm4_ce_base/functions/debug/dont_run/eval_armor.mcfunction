execute unless data entity @s SelectedItem.components."minecraft:custom_data".gm4_combat_expanded{identified:0}.armor_clamp run loot replace entity @s weapon.mainhand loot gm4_ce_base:armor/material/iron/chest
data modify storage gm4_combat_expanded:temp components set from entity @s SelectedItem.components

function gm4_ce_base:identification/armor/randomize_stats
$loot replace block 29999998 1 7134 container.4 loot gm4_ce_base:armor/identification/modifier/$(id)
data modify storage gm4_combat_expanded:temp new_components set from block 29999998 1 7134 Items[{Slot:4b}].components

function gm4_ce_base:identification/armor/fix_components
