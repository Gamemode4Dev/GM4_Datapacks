...
data modify storage gm4_lore:temp Target set value '{"italic":false,"color":"blue","translate":"item.gm4.combat_expanded.lore.witch","fallback":"Discharge"}'
data modify storage gm4_lore:temp Input set value ['{"italic":false,"color":"dark_gray","translate":"item.gm4.combat_expanded.lore.witch","fallback":"Discharge"}']
