...
execute if block ~ ~-0.01 ~ #gm4:no_collision run tag @s[type=!#gm4_ce_base:modify_in_air] add gm4_ce_processed
...
execute unless entity @s[tag=gm4_ce_processed] run function gm4_ce_base:mob/init/initiate
