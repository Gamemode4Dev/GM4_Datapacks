...
# at unspecified
# run from mob/init/apply/check_damage_cap_schedule
...
execute if score @s gm4_ce_damage_cap matches ..-1 run function gm4_ce_base:mob/init/apply/eval_damage_cap with storage gm4_combat_expanded:temp picked_stat
