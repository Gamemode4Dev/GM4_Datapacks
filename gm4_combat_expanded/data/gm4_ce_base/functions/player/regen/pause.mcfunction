...
execute store success score $regeneration_paused gm4_ce_data run scoreboard players set @s[advancements={gm4_ce_base:damaged/stop_regen={long_regeneration_pause=true}}] gm4_ce_natural_regen_damage 15
...
# revoke advancement
advancement revoke @s only gm4_ce_base:damaged/stop_regen
