...
# | Biome Modifiers
# snowy
execute if predicate gm4_combat_expanded:mob/modifier/snowy run function gm4_combat_expanded:mob/init/mob_type/creeper/snowy
# mountainous
...
# flowering 
execute if predicate gm4_combat_expanded:mob/modifier/flowering run function gm4_combat_expanded:mob/init/mob_type/creeper/flowering
# toxic
