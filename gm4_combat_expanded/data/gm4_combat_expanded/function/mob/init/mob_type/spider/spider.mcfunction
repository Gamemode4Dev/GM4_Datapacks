...
attribute @s generic.movement_speed modifier add gm4_combat_expanded:stat_change.base_nerf -0.06 add_multiplied_base
...
# flowering 
execute if predicate gm4_combat_expanded:mob/modifier/lush_caves if predicate gm4_combat_expanded:technical/chance/spider_replace run function gm4_combat_expanded:mob/init/mob_type/spider/lush_caves
# toxic
execute if predicate gm4_combat_expanded:mob/modifier/toxic run function gm4_combat_expanded:mob/init/mob_type/spider/toxic
# growth
