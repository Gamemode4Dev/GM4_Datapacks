...
attribute @s generic.attack_damage modifier add minecraft:3182427e-beb4-4f9a-9f39-674baf1d5ee4 -1.5 add_value
attribute @s generic.movement_speed modifier add minecraft:811e516b-a6b2-40e4-b56e-0ffd7173297b -0.12 add_multiplied_base
...
# dark
attribute @s[predicate=gm4_combat_expanded:mob/modifier/dark] generic.movement_speed modifier add minecraft:4e3983be-5075-4cb8-a05d-3911e619b780 0.15 add_multiplied_base
