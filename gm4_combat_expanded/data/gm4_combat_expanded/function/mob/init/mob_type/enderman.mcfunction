...
# base stat nerf
attribute @s[predicate=!gm4_combat_expanded:mob/modifier/the_end] generic.max_health modifier add minecraft:e94edf94-a98a-4dcc-bb23-2b59890663fd -2 add_value
...
# the end
attribute @s[predicate=gm4_combat_expanded:mob/modifier/the_end] generic.attack_damage modifier add minecraft:0872b8ed-f482-4a29-94dc-22df9a28dddb 0.2 add_multiplied_base
attribute @s[predicate=gm4_combat_expanded:mob/modifier/the_end] generic.movement_speed modifier add minecraft:17004032-9186-4202-b662-14841061fbb2 0.15 add_multiplied_base
# warped forest
