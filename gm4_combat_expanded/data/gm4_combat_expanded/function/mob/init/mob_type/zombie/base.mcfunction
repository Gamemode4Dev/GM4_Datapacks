...
# elites
execute if data entity @s attributes[{id:"minecraft:generic.max_health"}].modifiers[{id:"minecraft:leader_zombie_bonus"}] run function gm4_combat_expanded:mob/init/mob_type/zombie/elite/pick
execute if data entity @s {IsBaby:1b} run function gm4_combat_expanded:mob/init/mob_type/zombie/elite/pick
