...
# base stat nerf
attribute @s generic.max_health modifier add minecraft:e94edf94-a98a-4dcc-bb23-2b59890663fd -5 add_value
...
# mountainous
attribute @s[predicate=gm4_combat_expanded:mob/modifier/mountainous] generic.knockback_resistance modifier add minecraft:d1a07954-66f4-4da8-86a4-42fc863b760b 0.4 add_value
# burned
...
# growth
attribute @s[predicate=gm4_combat_expanded:mob/modifier/growth] generic.movement_speed modifier add minecraft:abf4db3b-a9b1-407b-a012-38c1c5c14e5f 0.2 add_multiplied_base
# dark
