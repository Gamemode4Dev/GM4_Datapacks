...
# base stat nerf
attribute @s generic.max_health modifier add minecraft:e94edf94-a98a-4dcc-bb23-2b59890663fd -6 add_value
attribute @s generic.attack_damage modifier add minecraft:3182427e-beb4-4f9a-9f39-674baf1d5ee4 -0.5 add_value
attribute @s generic.movement_speed modifier add minecraft:811e516b-a6b2-40e4-b56e-0ffd7173297b -0.06 add_multiplied_base
