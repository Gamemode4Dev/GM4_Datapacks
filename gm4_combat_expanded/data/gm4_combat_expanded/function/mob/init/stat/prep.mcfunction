...
# dark
execute if predicate gm4_combat_expanded:mob/modifier/dark run function gm4_combat_expanded:mob/init/stat/dark_mob
...
function gm4_combat_expanded:mob/init/stat/eval with storage gm4_combat_expanded:temp picked_stat
