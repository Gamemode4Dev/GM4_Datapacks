...
execute if score @s gm4_ce_damage_cap matches ..-1 run function gm4_combat_expanded:mob/init/stat/eval_damage_cap with storage gm4_combat_expanded:temp picked_stat
