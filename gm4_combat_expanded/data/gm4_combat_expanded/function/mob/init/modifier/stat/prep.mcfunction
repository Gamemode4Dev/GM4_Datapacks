...
# | Biome Modifiers
# snowy
attribute @s[predicate=gm4_combat_expanded:mob/modifier/snowy] generic.movement_speed modifier add minecraft:8b68cb8f-b3ac-489b-bb24-ed6cca2fcacf -0.15 add_multiplied_base
attribute @s[predicate=gm4_combat_expanded:mob/modifier/snowy] generic.max_health modifier add minecraft:9e950abf-f1d2-407d-a886-749059c29325 0.15 add_multiplied_base
# mountainous
attribute @s[predicate=gm4_combat_expanded:mob/modifier/mountainous] generic.armor modifier add minecraft:ba452899-be21-45b2-860c-c28947ba8c23 0.25 add_multiplied_base
attribute @s[predicate=gm4_combat_expanded:mob/modifier/mountainous] generic.armor_toughness modifier add minecraft:899a6423-93ed-4293-bde3-d993a3c50d33 0.5 add_multiplied_base
# burned
attribute @s[predicate=gm4_combat_expanded:mob/modifier/burned] generic.movement_speed modifier add minecraft:00a0987e-646e-4c9e-911e-8b07ad12df20 0.1 add_multiplied_base
# toxic
attribute @s[predicate=gm4_combat_expanded:mob/modifier/toxic] generic.attack_damage modifier add minecraft:0bb9ee29-b563-4cf7-b665-716391af0085 -0.25 add_multiplied_base
# deep
attribute @s[predicate=gm4_combat_expanded:mob/modifier/deep] generic.armor_toughness modifier add minecraft:5f5931f9-24d8-41ae-bab1-1468b5c8f35c 0.6 add_multiplied_base
# dark
