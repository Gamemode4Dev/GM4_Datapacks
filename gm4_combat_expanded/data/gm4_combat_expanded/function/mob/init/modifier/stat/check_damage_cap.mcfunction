...
execute if score $worlddiff gm4_ce_data matches 3 run attribute @s generic.attack_damage modifier add minecraft:660ddab9-8195-40c6-b769-010d4cd8467d -0.333334 add_multiplied_total
