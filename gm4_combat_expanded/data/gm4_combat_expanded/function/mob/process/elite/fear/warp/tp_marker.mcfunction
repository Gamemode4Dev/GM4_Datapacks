...
execute at @s run function gm4_combat_expanded:mob/process/elite/fear/warp/set_ypos

scoreboard players add $warp_attempt gm4_ce_data 1
execute unless score $warp_attempt gm4_ce_data matches 33.. run function gm4_combat_expanded:mob/process/elite/fear/warp/randomize
