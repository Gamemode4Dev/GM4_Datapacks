...
execute if score $has_target gm4_ce_data matches 1 anchored eyes positioned ^ ^-0.25 ^ summon block_display run function gm4_combat_expanded:mob/process/elite/fire/init_flare
