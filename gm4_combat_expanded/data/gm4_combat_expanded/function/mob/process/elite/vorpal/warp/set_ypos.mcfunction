...
execute at @s if block ~ ~ ~ #gm4:no_collision if block ~ ~1 ~ #gm4:no_collision if block ~ ~-1 ~ #gm4:full_collision unless entity @a[gamemode=!creative,gamemode=!spectator,distance=..3] run scoreboard players set $warp_safe gm4_ce_data 1
