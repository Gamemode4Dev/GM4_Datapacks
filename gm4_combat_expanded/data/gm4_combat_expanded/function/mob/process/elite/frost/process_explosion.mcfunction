...
execute if score @s gm4_ce_data matches ..360 rotated 0 80 run function gm4_combat_expanded:mob/process/elite/frost/warning_yaw_loop
...
execute if score @s gm4_ce_data matches 400.. run return run function gm4_combat_expanded:mob/process/elite/frost/explode
scoreboard players set $keep_tick.elite_frost_death gm4_ce_keep_tick 1
