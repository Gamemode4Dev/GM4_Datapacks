...
execute summon block_display run function gm4_combat_expanded:mob/process/elite/mending/init_beam
schedule function gm4_combat_expanded:mob/process/elite/mending/grow_beams_schedule 1t
