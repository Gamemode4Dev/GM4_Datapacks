...
execute if score $curr_health_percent_lost gm4_ce_data matches 50.. run effect give @s[type=!#gm4_combat_expanded:skeleton_types] resistance infinite 0 true
execute if score $curr_health_percent_lost gm4_ce_data matches 75.. run effect give @s[type=!#gm4_combat_expanded:skeleton_types] resistance infinite 1 true

execute if score $curr_health_percent_lost gm4_ce_data matches 50.. run scoreboard players set @s[type=#gm4_combat_expanded:skeleton_types] gm4_ce_arrow_fire_delay 2
execute if score $curr_health_percent_lost gm4_ce_data matches 75.. run scoreboard players set @s[type=#gm4_combat_expanded:skeleton_types] gm4_ce_arrow_fire_delay 3
