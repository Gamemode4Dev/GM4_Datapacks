...
execute unless score @s gm4_ce_timer matches 1.. if score $has_target gm4_ce_data matches 1 unless predicate gm4_combat_expanded:technical/chance/gargantuan_ground_smash run return 0
