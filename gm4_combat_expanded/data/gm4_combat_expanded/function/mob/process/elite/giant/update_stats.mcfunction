...
execute store result storage gm4_combat_expanded:temp set.speed float 0.015 run scoreboard players operation $curr_health_percent_lost gm4_ce_data -= $curr_health gm4_ce_data
...
function gm4_combat_expanded:mob/process/elite/giant/eval_stats with storage gm4_combat_expanded:temp set
