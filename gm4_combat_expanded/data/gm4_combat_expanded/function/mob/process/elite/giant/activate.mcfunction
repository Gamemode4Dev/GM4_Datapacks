...
execute as @a[distance=..7,gamemode=!spectator] run function gm4_combat_expanded:mob/process/elite/giant/player_hit with storage gm4_combat_expanded:temp deal
...
execute rotated 0 0 run function gm4_combat_expanded:mob/process/elite/giant/particle_ring_big
