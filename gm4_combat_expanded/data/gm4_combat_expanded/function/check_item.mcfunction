...
execute if score $item_processed gm4_ce_data matches 0 if items entity @s contents *[custom_data~{gm4_combat_expanded_armor:{identified:0}}] at @s run function gm4_combat_expanded_armor:identification/run
