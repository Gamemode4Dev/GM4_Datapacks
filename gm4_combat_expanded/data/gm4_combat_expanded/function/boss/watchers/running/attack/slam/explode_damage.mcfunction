...
execute store result score $pierced_armor gm4_ce_data run attribute @s generic.armor modifier value get minecraft:df679fe3-2d2a-429f-9dea-55a030b50964 -1
execute if score $pierced_armor gm4_ce_data matches 1.. run attribute @s generic.armor modifier remove minecraft:df679fe3-2d2a-429f-9dea-55a030b50964
