...
data modify storage gm4_combat_expanded:temp new_components."minecraft:attribute_modifiers" append from storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[]
...
# hide tooltip
data modify storage gm4_combat_expanded:temp new_components."minecraft:tooltip_display" set value {hidden_components:["minecraft:attribute_modifiers"]}
