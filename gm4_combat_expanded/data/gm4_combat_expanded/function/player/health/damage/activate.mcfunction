...
execute unless score $remove_health gm4_ce_data matches 0 run function gm4_combat_expanded:player/health/damage/eval with storage gm4_combat_expanded damage_player
...
schedule function gm4_combat_expanded:player/health/damage/context 2t
