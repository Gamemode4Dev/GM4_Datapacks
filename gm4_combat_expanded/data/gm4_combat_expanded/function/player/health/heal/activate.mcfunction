...
execute unless score $remove_health gm4_ce_data matches 0 run function gm4_combat_expanded:player/health/heal/eval with storage gm4_combat_expanded:temp heal_player
data remove storage gm4_combat_expanded:temp heal_player.remove_health

# prepare reverting
tag @s add gm4_ce_healed
schedule function gm4_combat_expanded:player/health/heal/context 1t
