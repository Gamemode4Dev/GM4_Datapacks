...
# get data
execute store result score $curr_level gm4_ce_data run data get storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{id:"gm4_combat_expanded:dynamic"}].amount
...
execute store result storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{id:"gm4_combat_expanded:dynamic"}].amount float 1 run scoreboard players operation $curr_level gm4_ce_data < $max_level gm4_ce_data
