...
execute store result score $armor_negation gm4_ce_data run data get storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{id:"gm4_combat_expanded:permanent_2"}].amount -1
...
execute store result storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{id:"gm4_combat_expanded:permanent_2"}].amount int -1 run scoreboard players get $armor_negation gm4_ce_data
execute store result storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{id:"gm4_combat_expanded:permanent"}].amount int 1 run scoreboard players get $armor_negation gm4_ce_data
