...
scoreboard players operation $damage_health gm4_ce_data -= $link_health_start gm4_ce_data
scoreboard players operation $link_health gm4_ce_data += $damage_health gm4_ce_data
