...
execute if score $death_messages gm4_ce_data matches 1 at @s run tellraw @a [{"text":"","color":"white"},{"selector":"@s","color":"white"},{"text":" could not control the power","color":"white"}]
kill @s
