...
execute if score @s[type=!player] gm4_ce_t_delay matches 40.. run function gm4_combat_expanded:weapon/modifiers/delay/explode_entity
execute if score @s[type=player] gm4_ce_t_delay matches 40.. run function gm4_combat_expanded:weapon/modifiers/delay/explode_player
