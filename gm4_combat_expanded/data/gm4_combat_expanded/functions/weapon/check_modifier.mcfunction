...
execute if score $modifier gm4_ce_data matches 104 run function gm4_combat_expanded:weapon/modifier/chime/activate
execute if score $modifier gm4_ce_data matches 105 run function gm4_combat_expanded:weapon/modifier/delay/activate
execute if score $modifier gm4_ce_data matches 106 if data storage gm4_combat_expanded:temp tag.Enchantments run function gm4_combat_expanded:weapon/modifier/chaos/activate
