...
execute if score $modifier gm4_ce_data matches 5 store result storage gm4_combat_expanded:temp tag.AttributeModifiers[{Name:"gm4_ce_double_sharpness"}].Amount double 0.05 run scoreboard players get $current_sharpness gm4_ce_data
