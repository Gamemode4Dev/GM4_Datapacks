...
execute anchored eyes positioned ^ ^ ^2.5 as @e[distance=..2.4,predicate=gm4_combat_expanded:technical/unblocked_hit,team=!gm4_ce_team_check,tag=!smithed.strict,limit=1,sort=nearest] run function gm4_combat_expanded:weapon/modifier/chime/check_target
