...
execute if score $giant_damage gm4_ce_data matches 10 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 20 player_attack
execute if score $giant_damage gm4_ce_data matches 9 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 18 player_attack
execute if score $giant_damage gm4_ce_data matches 8 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 16 player_attack
execute if score $giant_damage gm4_ce_data matches 7 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 14 player_attack
execute if score $giant_damage gm4_ce_data matches 6 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 12 player_attack
execute if score $giant_damage gm4_ce_data matches 5 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 10 player_attack
execute if score $giant_damage gm4_ce_data matches 4 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 8 player_attack
execute if score $giant_damage gm4_ce_data matches 3 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 6 player_attack
execute if score $giant_damage gm4_ce_data matches 2 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 4 player_attack
execute if score $giant_damage gm4_ce_data matches 1 as @e[distance=0.01..4.5,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] run damage @s 2 player_attack
