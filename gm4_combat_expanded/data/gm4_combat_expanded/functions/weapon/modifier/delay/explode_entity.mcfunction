...
execute if entity @s[tag=gm4_ce_delay_lvl_1] run scoreboard players remove $health gm4_ce_data 5
execute if entity @s[tag=gm4_ce_delay_lvl_2] run scoreboard players remove $health gm4_ce_data 8
execute if entity @s[tag=gm4_ce_delay_lvl_3] run scoreboard players remove $health gm4_ce_data 11
