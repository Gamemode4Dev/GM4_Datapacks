...
# find entities hit
execute anchored eyes positioned ^ ^ ^2.5 as @e[distance=..2.4,team=!gm4_invalid,type=!armor_stand,nbt={HurtTime:10s},tag=!smithed.strict] at @s run function gm4_combat_expanded:weapon/modifier/heal/heal
