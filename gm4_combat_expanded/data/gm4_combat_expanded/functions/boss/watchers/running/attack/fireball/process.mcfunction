...
execute if score @s gm4_ce_boss.attack_progress matches 1 facing entity @p[tag=gm4_ce_boss.current_target] eyes run tp @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] ~ ~ ~ ~ ~
...
execute if score @s gm4_ce_boss.attack_progress matches 1 at @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 run function gm4_combat_expanded:boss/watchers/running/attack/fireball/raycast
execute if score @s gm4_ce_boss.attack_progress matches 1 as @p[tag=gm4_ce_boss.current_target] at @s run playsound minecraft:block.amethyst_block.break hostile @s ~ ~ ~ 2 0.5
...
execute if score @s gm4_ce_boss.attack_progress matches 2..4 at @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon firework_rocket run function gm4_combat_expanded:boss/watchers/running/attack/fireball/spawn_small_fireball
execute if score @s gm4_ce_boss.attack_progress matches 2..4 at @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon firework_rocket run function gm4_combat_expanded:boss/watchers/running/attack/fireball/spawn_small_fireball
execute if score @s gm4_ce_boss.attack_progress matches 2..4 at @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon firework_rocket run function gm4_combat_expanded:boss/watchers/running/attack/fireball/spawn_small_fireball
...
execute if score @s[scores={gm4_ce_boss.phase=2}] gm4_ce_boss.attack_progress matches 5 at @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon fireball run function gm4_combat_expanded:boss/watchers/running/attack/fireball/spawn_fireball
execute if score @s[scores={gm4_ce_boss.phase=3..}] gm4_ce_boss.attack_progress matches 5 at @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon fireball run function gm4_combat_expanded:boss/watchers/running/attack/fireball/spawn_big_fireball
