...
execute if score @s gm4_ce_boss.attack_progress matches 1 run tp @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] ~ ~ ~ 0 90
...
execute if entity @s[tag=gm4_ce_boss.slam_teleporting,scores={gm4_ce_boss.attack_progress=13..15}] run function gm4_combat_expanded:boss/watchers/running/attack/slam/slam_warp/process
...
execute if score @s gm4_ce_boss.attack_progress matches 16 as @e[type=item_display,tag=gm4_ce_boss.slam_block] if score @s gm4_ce_boss.id = $running_id gm4_ce_boss.id run function gm4_combat_expanded:boss/watchers/running/attack/slam/raise_blocks
execute if score @s gm4_ce_boss.attack_progress matches 17 as @e[type=item_display,tag=gm4_ce_boss.slam_block] if score @s gm4_ce_boss.id = $running_id gm4_ce_boss.id run function gm4_combat_expanded:boss/watchers/running/attack/slam/slam_down
