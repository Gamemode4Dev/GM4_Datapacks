...
execute if score @s gm4_ce_boss.attack_progress matches 43 run tp @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.watcher.running] ~ ~ ~ 0 90
