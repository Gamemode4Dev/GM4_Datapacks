...
scoreboard players add @s gm4_ce_boss.health 13
data modify entity @s Health set value 960f

execute if score @s gm4_ce_boss.attack_progress matches 15 as @e[type=block_display,tag=gm4_ce_boss.running,tag=gm4_ce_boss.watcher.crystal] run data modify entity @s block_state.Name set value "medium_amethyst_bud"
execute if score @s gm4_ce_boss.attack_progress matches 31 as @e[type=block_display,tag=gm4_ce_boss.running,tag=gm4_ce_boss.watcher.crystal] run data modify entity @s block_state.Name set value "large_amethyst_bud"
execute if score @s gm4_ce_boss.attack_progress matches 41 as @e[type=block_display,tag=gm4_ce_boss.running,tag=gm4_ce_boss.watcher.crystal] run data modify entity @s block_state.Name set value "amethyst_cluster"
...
execute if score @s gm4_ce_boss.attack_progress matches 43 run tp @e[type=block_display,tag=gm4_ce_boss.watcher.crystal,tag=gm4_ce_boss.running] ~ ~ ~ 0 90
execute if score @s gm4_ce_boss.attack_progress matches 45 run function gm4_combat_expanded:boss/watchers/activation/spawn_sentinel/head
