...
data merge entity @s {DeathLootTable:"empty",CustomName:'{"text":"Amethyst Skeleton"}',CanPickUpLoot:0b,Health:23f,IsBaby:0b,CanBreakDoors:0b,Tags:["gm4_ce_processed","gm4_ce_boss.watcher","gm4_ce_boss.watcher.minion"],ArmorItems:[{},{},{},{id:"minecraft:budding_amethyst",count:1,components:{"minecraft:enchantments":{"minecraft:blast_protection":20}}}],ArmorDropChances:[0.085F,0.085F,0.085F,-327.670F],Attributes:[{Name:"generic.max_health",Base:23},{Name:"generic.knockback_resistance",Base:0.15},{Name:"generic.movement_speed",Base:0.25},{Name:"generic.armor",Base:8},{Name:"generic.armor_toughness",Base:3},{Name:"generic.max_absorption",Base:0}]}
