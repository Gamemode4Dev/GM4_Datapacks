...
data merge entity @s {ExplosionPower:3b,Tags:["gm4_ce_boss.fireball"],power:[0.0,-0.05,0.0],Item:{id:"minecraft:budding_amethyst",Count:1b}}
summon dragon_fireball ~ ~ ~ {Tags:["gm4_ce_boss.fireball","gm4_ce_boss.dragon_fireball"],power:[0.0,-2.0,0.0]}
ride @e[type=dragon_fireball,tag=gm4_ce_boss.dragon_fireball,distance=..0.1,limit=1] mount @s
