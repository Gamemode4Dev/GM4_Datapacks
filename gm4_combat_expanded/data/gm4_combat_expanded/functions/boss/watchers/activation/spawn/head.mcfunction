...
summon item_display ~ ~ ~ {Tags:["gm4_ce_boss.watcher","gm4_ce_boss.watcher.head","gm4_ce_boss.watcher.face","gm4_ce_boss.watcher.new","smithed.entity","smithed.strict"],teleport_duration:2,item:{id:"minecraft:chiseled_deepslate",count:1,components:{"minecraft:custom_data":{return:{scale:[1f,1f,1f],translation:[0f,0f,0f]}}}},Passengers:[\
