...
execute if score @s gm4_ce_boss.attack_progress matches 1 run scoreboard players set @s gm4_ce_boss.health -6
scoreboard players add @s gm4_ce_boss.health 11
data modify entity @s Health set value 960f

execute if score @s gm4_ce_boss.attack_progress matches 15 as @e[type=block_display,tag=gm4_ce_boss.running,tag=gm4_ce_boss.crystal] run data modify entity @s block_state.Name set value "medium_amethyst_bud"
execute if score @s gm4_ce_boss.attack_progress matches 31 as @e[type=block_display,tag=gm4_ce_boss.running,tag=gm4_ce_boss.crystal] run data modify entity @s block_state.Name set value "large_amethyst_bud"
execute if score @s gm4_ce_boss.attack_progress matches 41 as @e[type=block_display,tag=gm4_ce_boss.running,tag=gm4_ce_boss.crystal] run data modify entity @s block_state.Name set value "amethyst_cluster"
...
execute if score @s gm4_ce_boss.attack_progress matches 46 run function gm4_combat_expanded:boss/running/phase/1/end
