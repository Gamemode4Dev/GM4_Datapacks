...
# process attacks
execute if score @s gm4_ce_boss.attack_id matches 1 run function gm4_combat_expanded:boss/activation/process
...
execute if score @s gm4_ce_boss.attack_id matches 7 run function gm4_combat_expanded:boss/running/attack/spawn_sentinel/process
execute if score @s gm4_ce_boss.attack_id matches 8 run function gm4_combat_expanded:boss/running/attack/shield/process
execute if score @s gm4_ce_boss.attack_id matches 9 run function gm4_combat_expanded:boss/running/attack/aura/process
