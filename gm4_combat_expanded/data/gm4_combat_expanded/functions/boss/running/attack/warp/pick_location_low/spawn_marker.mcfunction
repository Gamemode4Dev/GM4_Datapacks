...
execute at @r[gamemode=!spectator,gamemode=!creative,distance=..48] run tp @s ~-8 ~ ~-8
...
function gm4_combat_expanded:boss/running/attack/warp/pick_location_low/randomize
