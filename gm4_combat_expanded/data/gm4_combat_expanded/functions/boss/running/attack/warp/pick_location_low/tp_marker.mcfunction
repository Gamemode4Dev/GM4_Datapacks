...
execute at @s run function gm4_combat_expanded:boss/running/attack/warp/pick_location_low/set_ypos

scoreboard players add $warp_attempt gm4_ce_boss 1
execute unless score $warp_attempt gm4_ce_boss matches 33.. run function gm4_combat_expanded:boss/running/attack/warp/pick_location_low/randomize
