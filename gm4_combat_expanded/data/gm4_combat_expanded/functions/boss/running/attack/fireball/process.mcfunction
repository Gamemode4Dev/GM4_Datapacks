...
execute if score @s gm4_ce_boss.attack_progress matches 1 facing entity @p[tag=gm4_ce_boss.current_target] eyes run tp @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] ~ ~ ~ ~ ~
...
execute if score @s[scores={gm4_ce_boss.phase=3..}] gm4_ce_boss.attack_progress matches 1 run scoreboard players set @s gm4_ce_boss.tick_delay 15
...
execute if score @s gm4_ce_boss.attack_progress matches 1 at @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 run function gm4_combat_expanded:boss/running/attack/fireball/raycast
...
execute if score @s gm4_ce_boss.attack_progress matches 2..4 at @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon firework_rocket run function gm4_combat_expanded:boss/running/attack/fireball/spawn_small_fireball
execute if score @s gm4_ce_boss.attack_progress matches 2..4 at @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon firework_rocket run function gm4_combat_expanded:boss/running/attack/fireball/spawn_small_fireball
execute if score @s gm4_ce_boss.attack_progress matches 2..4 at @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon firework_rocket run function gm4_combat_expanded:boss/running/attack/fireball/spawn_small_fireball
...
execute if score @s gm4_ce_boss.attack_progress matches 6 at @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon fireball run function gm4_combat_expanded:boss/running/attack/fireball/spawn_big_fireball
