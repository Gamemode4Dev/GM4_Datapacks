...
execute if score @s gm4_ce_boss.attack_progress matches 5 run playsound block.amethyst_block.break hostile @a[distance=..32] ~ ~ ~ 1.5 0.7 1
...
execute if score @s gm4_ce_boss.attack_progress matches 6 run scoreboard players add @s gm4_ce_boss.attack_progress 1
execute if score @s gm4_ce_boss.attack_progress matches 7 facing entity @p[tag=gm4_ce_boss.current_target] eyes run tp @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] ~ ~ ~ ~ ~
execute if score @s gm4_ce_boss.attack_progress matches 7 run scoreboard players set $raycast gm4_ce_boss 64
execute if score @s gm4_ce_boss.attack_progress matches 7 at @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 run function gm4_combat_expanded:boss/running/attack/fireball/raycast
execute if score @s gm4_ce_boss.attack_progress matches 7 run playsound block.amethyst_block.break hostile @a[distance=..32] ~ ~ ~ 1.5 0.7 1
execute if score @s gm4_ce_boss.attack_progress matches 7 at @e[type=block_display,tag=gm4_ce_boss.crystal,tag=gm4_ce_boss.running] positioned ^ ^ ^1.5 summon fireball run function gm4_combat_expanded:boss/running/attack/fireball/spawn_fireball
execute if score @s gm4_ce_boss.attack_progress matches 8 run function gm4_combat_expanded:boss/running/attack/fireball/end
