...
execute positioned ~-2 ~-1 ~-2 as @a[gamemode=!spectator,gamemode=!creative,dx=3,dy=17.5,dz=3] at @e[type=shulker,tag=gm4_ce_target] positioned ~-2 ~-20 ~-2 if entity @s[dx=3,dy=18.5,dz=3] run function gm4_combat_expanded:boss/running/attack/slam/explode_damage
