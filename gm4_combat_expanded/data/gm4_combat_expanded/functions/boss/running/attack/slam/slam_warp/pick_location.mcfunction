...
execute if score $pick_location gm4_ce_boss matches 1 summon marker run function gm4_combat_expanded:boss/running/attack/slam/slam_warp/above_player/spawn_marker
