...
execute if entity @s[tag=gm4_ce_boss.shielded] run playsound minecraft:item.shield.block hostile @a[distance=..64] ~ ~ ~ 0.75 0.8 1
...
execute if score $health_change gm4_ce_boss matches 1.. run summon item_display ~ ~0.5 ~ {Silent:1b,Tags:["gm4_ce_boss","gm4_ce_boss.hurtbox","gm4_ce_boss.temp_display","gm4_ce_boss.head"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1.04f,1.04f,1.04f]},item:{id:"minecraft:red_stained_glass",Count:1b}}
