...
# STEP SIZE = score*0.5
# MAX = +7 attack damage
execute if score $mob_damage gm4_ce_data matches 8.. run attribute @s generic.attack_damage modifier add 6d6d4eb0-a826-4697-9280-75cc603c68df "gm4_ce_modifier_damage_4" 4 add
execute if score $mob_damage gm4_ce_data matches 8.. run scoreboard players remove $mob_damage gm4_ce_data 8
