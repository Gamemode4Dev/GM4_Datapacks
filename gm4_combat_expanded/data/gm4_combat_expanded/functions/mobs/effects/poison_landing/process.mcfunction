...
execute if score $onground gm4_ce_data matches 1 if entity @s[tag=gm4_ce_poison_landing_ready] run function gm4_combat_expanded:mobs/effects/poison_landing/land
