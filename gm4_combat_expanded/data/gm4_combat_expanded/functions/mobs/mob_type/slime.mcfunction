...
execute if predicate gm4_combat_expanded:mobs/modifiers/flowering store result score $size gm4_ce_data run data get entity @s Size
execute if predicate gm4_combat_expanded:mobs/modifiers/flowering if predicate gm4_combat_expanded:technical/chance_15 run scoreboard players add $size gm4_ce_data 1
execute if predicate gm4_combat_expanded:mobs/modifiers/flowering if predicate gm4_combat_expanded:technical/chance_15 run scoreboard players add $size gm4_ce_data 1
execute if predicate gm4_combat_expanded:mobs/modifiers/flowering store result entity @s Size int 1 run scoreboard players get $size gm4_ce_data
execute if predicate gm4_combat_expanded:mobs/modifiers/toxic run tag @s[type=slime] add gm4_ce_poison_landing
