...
execute if predicate gm4_combat_expanded:mobs/modifiers/flowering if predicate gm4_combat_expanded:technical/chance_50 run function gm4_combat_expanded:mobs/effects/flowering_enderman
execute if predicate gm4_combat_expanded:mobs/modifiers/the_end run scoreboard players add $mob_stats gm4_ce_data 4
