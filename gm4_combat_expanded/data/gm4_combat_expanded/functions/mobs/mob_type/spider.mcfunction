...
execute if predicate gm4_combat_expanded:mobs/modifiers/growth if entity @s[tag=!gm4_ce_extra_mob] if predicate gm4_combat_expanded:technical/chance_50 store success score $mob_extras gm4_ce_data run summon spider ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
