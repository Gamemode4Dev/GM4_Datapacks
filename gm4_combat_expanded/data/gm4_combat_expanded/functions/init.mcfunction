...
execute unless score $natural_regen_disabled gm4_ce_data matches 1 run data modify storage gm4:log queue append value {type:"text",message:'{"text":"[INFO] Combat Expanded: naturalRegeneration set to false"}'}
...
execute if score $natural_regen_disabled gm4_ce_data matches 1 if score $natural_regen gm4_ce_data matches 1 run data modify storage gm4:log queue append value {type:"text",message:'[{"text":"[WARN]","color":"red"},{"text":" Combat Expanded: Expected naturalRegeneration to be false, but it is true. ","color":"white"},{"text":"click here to fix","color":"red","clickEvent":{"action":"suggest_command","value":"/gamerule naturalRegeneration false"}}]'}
...
execute unless score $phantoms_disabled gm4_ce_data matches 1 run data modify storage gm4:log queue append value {type:"text",message:'{"text":"[INFO] Combat Expanded: doInsomnia set to false"}'}
execute if score $phantoms_disabled gm4_ce_data matches 1 if score $phantoms gm4_ce_data matches 1 run data modify storage gm4:log queue append value {type:"text",message:'[{"text":"[WARN]","color":"red"},{"text":" Combat Expanded: Expected doInsomnia to be false, but it is true. ","color":"white"},{"text":"click here to fix","color":"red","clickEvent":{"action":"suggest_command","value":"/gamerule doInsomnia false"}}]'}
