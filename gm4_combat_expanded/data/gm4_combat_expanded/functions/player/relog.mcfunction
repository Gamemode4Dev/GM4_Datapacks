...
execute unless score $keep_tick.burn gm4_ce_data matches 1 if score @s gm4_ce_burning.duration matches 1.. run schedule function gm4_combat_expanded:armor/modifier/type/burn/clock 1t
