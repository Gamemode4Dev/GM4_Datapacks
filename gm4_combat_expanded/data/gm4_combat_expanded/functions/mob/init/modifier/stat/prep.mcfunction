...
# modify stat buffs using difficulty
...
execute store result storage gm4_combat_expanded:temp picked_stat.toughness float 3 run scoreboard players operation $mob_toughness gm4_ce_data < $mob_toughness.cap gm4_ce_data
