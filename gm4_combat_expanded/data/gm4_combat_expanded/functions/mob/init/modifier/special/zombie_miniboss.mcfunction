...
summon zombie ~0.1 ~0.15 ~0.02 {Tags:["gm4_ce_extra_mob"]}
...
attribute @s generic.max_health modifier add 1ac3ea4d-e61d-4b1e-a575-fb10a478189d "gm4_ce_miniboss" 0.1 multiply
attribute @s generic.armor_toughness modifier add 6512eccc-ca44-4cf0-ad13-0fa881232494 "gm4_ce_miniboss" 2 multiply
attribute @s generic.armor modifier add 52d29350-f0c7-4be5-9bbc-59d1d409b254 "gm4_ce_miniboss" 2 multiply
...
attribute @s generic.attack_damage modifier add d8b8f22e-bba8-47ca-b502-4cf83a847b4d "gm4_ce_miniboss" -5 add
