...
attribute @s generic.movement_speed modifier add 811e516b-a6b2-40e4-b56e-0ffd7173297b "gm4_ce_base_speed_nerf" -0.15 multiply_base

# max stat buffs
scoreboard players set $mob_health gm4_ce_data 32
scoreboard players set $mob_damage gm4_ce_data 0
scoreboard players set $mob_speed gm4_ce_data 15
scoreboard players set $mob_armor gm4_ce_data 34
...
scoreboard players set $mob_speed.cap gm4_ce_data 12
...
execute if score $patrolling gm4_ce_data matches 1 run scoreboard players set $mob_speed.cap gm4_ce_data 14
# raider
...
execute if score $wave gm4_ce_data matches 4.. run scoreboard players set $mob_health.cap gm4_ce_data 18
execute if score $wave gm4_ce_data matches 4.. run scoreboard players set $mob_armor.cap gm4_ce_data 12
