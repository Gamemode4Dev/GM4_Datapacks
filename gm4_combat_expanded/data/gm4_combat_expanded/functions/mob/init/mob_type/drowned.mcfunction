...
execute if predicate gm4_combat_expanded:mob/modifier/growth run function gm4_combat_expanded:mob/init/modifier/special/growth_zombie
execute if predicate gm4_combat_expanded:mob/modifier/reef run function gm4_combat_expanded:mob/init/modifier/special/reef_drowned
