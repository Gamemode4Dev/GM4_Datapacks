...
# dark
attribute @s[predicate=gm4_combat_expanded:mob/modifier/dark] generic.movement_speed modifier add 4e3983be-5075-4cb8-a05d-3911e619b780 "gm4_ce_modifier_dark" 0.15 add_multiplied_base
