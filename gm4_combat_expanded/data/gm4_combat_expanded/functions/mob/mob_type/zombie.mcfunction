...
data modify entity @s[tag=!gm4_ce_spore_mob,predicate=gm4_combat_expanded:mob/modifier/flowering] ArmorDropChances[3] set value 2F
...
item replace entity @s[predicate=gm4_combat_expanded:mob/modifier/flowering] armor.head with flowering_azalea_leaves{gm4_ce_spore:zombie}
# set weapon
