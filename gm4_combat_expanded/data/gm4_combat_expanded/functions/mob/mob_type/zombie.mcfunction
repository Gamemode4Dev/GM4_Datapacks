...
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon zombie ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon zombie ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon zombie ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}

# set armor
loot replace entity @s armor.feet loot gm4_combat_expanded:mob/equip_armor/generic
execute if predicate gm4_combat_expanded:mob/modifier/flowering run item replace entity @s armor.head with flowering_azalea_leaves{gm4_ce_spore:zombie}
# set weapon
