...
execute if predicate gm4_combat_expanded:mob/modifier/toxic run tag @s add gm4_ce_poison_bite
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon cave_spider ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] if predicate gm4_combat_expanded:technical/chance_50 store success score $mob_extras gm4_ce_data run summon cave_spider ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
