...
execute if predicate gm4_combat_expanded:mob/modifier/burned if entity @s[tag=!gm4_ce_extra_mob] run function gm4_combat_expanded:mob/effect/burned_husk
execute if predicate gm4_combat_expanded:mob/modifier/burned run attribute @s generic.max_health modifier add 34931bf4-2d02-4700-bb16-097bc669d313 "gm4_ce_modifier_burned" -0.4 multiply
execute if predicate gm4_combat_expanded:mob/modifier/burned run attribute @s generic.attack_damage modifier add 96ee68f2-4150-4350-af04-e4230fcd2cec "gm4_ce_modifier_burned" -0.25 multiply
...
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon husk ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon husk ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
execute if predicate gm4_combat_expanded:mob/modifier/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon husk ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}

# set armor
loot replace entity @s armor.feet loot gm4_combat_expanded:mob/equip_armor/generic
execute if predicate gm4_combat_expanded:mob/modifier/flowering run item replace entity @s armor.head with flowering_azalea_leaves{gm4_ce_spore:husk}
# set weapon
