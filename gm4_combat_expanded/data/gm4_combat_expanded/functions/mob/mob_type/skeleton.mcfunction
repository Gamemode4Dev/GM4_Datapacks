...
execute if score $difficulty gm4_ce_data matches 8.. if predicate gm4_combat_expanded:technical/chance_15 store success score $arrow gm4_ce_data run loot replace entity @s weapon.offhand loot gm4_combat_expanded:mob/equip_arrow/skeleton_harming
...
execute if predicate gm4_combat_expanded:mob/modifier/toxic store success score $arrow gm4_ce_data run loot replace entity @s weapon.offhand loot gm4_combat_expanded:mob/equip_arrow/skeleton_toxic
