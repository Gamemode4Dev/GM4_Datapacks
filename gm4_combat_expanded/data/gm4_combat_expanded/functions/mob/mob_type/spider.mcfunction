...
execute if predicate gm4_combat_expanded:mob/modifier/dark if predicate gm4_combat_expanded:technical/chance_5 run effect give @s invisibility 1000000 0
