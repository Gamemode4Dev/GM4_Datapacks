...
execute if score $worlddiff gm4_ce_data matches 2 run effect give @s weakness 7 0
execute if score $worlddiff gm4_ce_data matches 3 run effect give @s weakness 15 0
