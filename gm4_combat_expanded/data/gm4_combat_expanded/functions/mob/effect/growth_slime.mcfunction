...
execute as @e[type=slime,tag=gm4_ce_set_slime_size] store result entity @s Size int 1 run scoreboard players get $size gm4_ce_data
tag @e[type=slime,tag=gm4_ce_set_slime_size] remove gm4_ce_set_slime_size
