...
execute if score $modifier gm4_ce_data matches 12 unless score @s gm4_ce_t_hurt matches 1.. run function gm4_combat_expanded:armor/modifier/type/sneak/check
# unsafe (triggered from advancements)
