...
execute if data storage gm4_combat_expanded:temp Items[{Slot:0b}].tag.gm4_combat_expanded.archer store result score $add_storm_arrows gm4_ce_data run data get storage gm4_combat_expanded:temp Items[{Slot:0b}].tag.gm4_combat_expanded.level 2
scoreboard players operation $storm_arrow_target gm4_ce_data += $add_storm_arrows gm4_ce_data

scoreboard players set $add_storm_arrows gm4_ce_data 0
execute if data storage gm4_combat_expanded:temp Items[{Slot:1b}].tag.gm4_combat_expanded.archer store result score $add_storm_arrows gm4_ce_data run data get storage gm4_combat_expanded:temp Items[{Slot:1b}].tag.gm4_combat_expanded.level 2
scoreboard players operation $storm_arrow_target gm4_ce_data += $add_storm_arrows gm4_ce_data

scoreboard players set $add_storm_arrows gm4_ce_data 0
execute if data storage gm4_combat_expanded:temp Items[{Slot:2b}].tag.gm4_combat_expanded.archer store result score $add_storm_arrows gm4_ce_data run data get storage gm4_combat_expanded:temp Items[{Slot:2b}].tag.gm4_combat_expanded.level 2
scoreboard players operation $storm_arrow_target gm4_ce_data += $add_storm_arrows gm4_ce_data

scoreboard players set $add_storm_arrows gm4_ce_data 0
execute if data storage gm4_combat_expanded:temp Items[{Slot:3b}].tag.gm4_combat_expanded.archer store result score $add_storm_arrows gm4_ce_data run data get storage gm4_combat_expanded:temp Items[{Slot:3b}].tag.gm4_combat_expanded.level 2
scoreboard players operation $storm_arrow_target gm4_ce_data += $add_storm_arrows gm4_ce_data
