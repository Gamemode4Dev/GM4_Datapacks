...
execute store result score $level gm4_ce_data run data get storage gm4_combat_expanded:temp components."minecraft:custom_data".level2 2
# for old armor pieces TODO: remove
execute if score $level gm4_ce_data matches 0 run data get storage gm4_combat_expanded:temp components."minecraft:custom_data".level
