...
data modify storage gm4_combat_expanded:temp components."minecraft:custom_name" set from block 29999998 1 7134 Items[{Slot:4b}].components."minecraft:custom_name"
