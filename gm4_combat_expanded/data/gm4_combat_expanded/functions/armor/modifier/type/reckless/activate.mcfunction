...
execute store result storage gm4_combat_expanded:temp components."minecraft:custom_data".deactivates_at int 1 run scoreboard players add $deactive_at gm4_ce_data 300
...
execute store result storage gm4_combat_expanded:temp components."minecraft:custom_data".active int 1 run scoreboard players operation $active gm4_ce_data < $armor_level gm4_ce_data
