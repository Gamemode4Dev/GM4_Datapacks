...
execute if score $level gm4_ce_data matches 1 run data modify storage gm4_lore:temp Input set value ['{"italic":false,"color":"gray","translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"text":"Heal Pulse"},{"translate":"item.gm4.combat_expanded.lore.soothe"}]},{"translate":"potion.potency.0"}]}']
execute if score $level gm4_ce_data matches 2 run data modify storage gm4_lore:temp Input set value ['{"italic":false,"color":"gray","translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"text":"Heal Pulse"},{"translate":"item.gm4.combat_expanded.lore.soothe"}]},{"translate":"potion.potency.1"}]}']
execute if score $level gm4_ce_data matches 3 run data modify storage gm4_lore:temp Input set value ['{"italic":false,"color":"gray","translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"text":"Heal Pulse"},{"translate":"item.gm4.combat_expanded.lore.soothe"}]},{"translate":"potion.potency.2"}]}']
