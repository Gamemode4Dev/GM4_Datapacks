...
execute store result score $max_level gm4_ce_data run data get storage gm4_combat_expanded:temp tag.gm4_combat_expanded.level
...
execute store result storage gm4_combat_expanded:temp tag.AttributeModifiers[{Name:"gm4_combat_expanded"}].Amount float 1 run scoreboard players operation $curr_level gm4_ce_data < $max_level gm4_ce_data
