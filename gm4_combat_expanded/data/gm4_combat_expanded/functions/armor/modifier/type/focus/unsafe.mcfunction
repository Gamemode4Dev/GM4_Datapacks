...
# modify attribute
execute store result storage gm4_combat_expanded:temp tag.AttributeModifiers[{Name:gm4_combat_expanded}].Amount float -0.5 run data get storage gm4_combat_expanded:temp tag.gm4_combat_expanded.level 1
