...
execute unless score $active gm4_ce_data matches 1 unless score @s gm4_ce_tgm4_ce_natural_regen_damage_hurt matches 1.. run function gm4_combat_expanded:armor/modifier/type/focus/safe
