...
execute if score $active gm4_ce_data matches 1 at @s run effect give @e[distance=..16,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] glowing 2 0 true
