...
execute store result score $armor_add gm4_ce_data run data get storage gm4_combat_expanded:temp check_modifier.modifiers[{name:"minecraft:generic.armor"}].amount
