...
execute store result storage gm4_combat_expanded:temp components."minecraft:custom_data".stored_armor int 1 run scoreboard players get @s gm4_ce_armor

# calculate level of bonus movement speed and attack speed
execute store result score $level gm4_ce_data run data get storage gm4_combat_expanded:temp components."minecraft:custom_data".level 2
