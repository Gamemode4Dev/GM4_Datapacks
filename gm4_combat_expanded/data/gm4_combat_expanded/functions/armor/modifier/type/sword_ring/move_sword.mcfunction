...
execute at @s[scores={gm4_ce_data=1}] positioned ~-.1 ~-.1 ~-.1 as @e[tag=!gm4_ce_target,dx=0,dy=0,dz=0,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] positioned ~-.8 ~-.8 ~-.8 if entity @s[dx=0,dy=0,dz=0] store success score $damage_dealt gm4_ce_data run damage @s 2 player_attack
...
execute at @s[scores={gm4_ce_data=3..4}] positioned ~-.1 ~-.1 ~-.1 as @e[tag=!gm4_ce_target,dx=0,dy=0,dz=0,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] positioned ~-.8 ~-.8 ~-.8 if entity @s[dx=0,dy=0,dz=0] store success score $damage_dealt gm4_ce_data run damage @s 4 player_attack
execute at @s[scores={gm4_ce_data=5..6}] positioned ~-.1 ~-.1 ~-.1 as @e[tag=!gm4_ce_target,dx=0,dy=0,dz=0,type=!#gm4_combat_expanded:effect_immune,team=!gm4_ce_team_check,tag=!smithed.strict] positioned ~-.8 ~-.8 ~-.8 if entity @s[dx=0,dy=0,dz=0] store success score $damage_dealt gm4_ce_data run damage @s 5 player_attack
