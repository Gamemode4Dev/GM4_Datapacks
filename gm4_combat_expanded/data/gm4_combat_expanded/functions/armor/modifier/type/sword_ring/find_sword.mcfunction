...
execute if score $sword_damage gm4_ce_data < $sword_durability gm4_ce_data unless entity @e[type=item_display,tag=gm4_ce_sword_ring.current_sword] summon item_display run function gm4_combat_expanded:armor/modifier/type/sword_ring/init_sword

# move the sword to the correct position
tag @s add gm4_ce_self
$execute if score $sword_damage gm4_ce_data < $sword_durability gm4_ce_data as @e[type=item_display,tag=gm4_ce_sword_ring.current_sword,limit=1] positioned ^ ^ ^$(offset) run function gm4_combat_expanded:armor/modifier/type/sword_ring/move_sword
