...
# modify attributes
execute store result storage gm4_combat_expanded:temp tag.AttributeModifiers[{Name:gm4_combat_expanded}].Amount float 0.1 run data get storage gm4_combat_expanded:temp tag.gm4_combat_expanded.level 10
...
data modify storage gm4_combat_expanded:temp tag.AttributeModifiers[{Name:gm4_combat_expanded_4}].Amount set value 0.1
