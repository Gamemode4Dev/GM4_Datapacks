...
scoreboard players set $keep_tick.beacon gm4_ce_data 0
...
execute if score $keep_tick.beacon gm4_ce_data matches 1 run schedule function gm4_combat_expanded:armor/modifier/type/beacon/clock 1t
