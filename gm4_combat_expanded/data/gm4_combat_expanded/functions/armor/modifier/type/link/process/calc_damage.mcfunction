...
scoreboard players operation $damage_taken gm4_ce_data = @s gm4_ce_health.current
scoreboard players operation $damage_taken gm4_ce_data -= $link_health gm4_ce_data
