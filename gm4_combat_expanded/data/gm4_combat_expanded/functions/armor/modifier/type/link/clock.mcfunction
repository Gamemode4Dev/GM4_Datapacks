...
scoreboard players set $keep_tick.link gm4_ce_data 0
...
execute if score $keep_tick.link gm4_ce_data matches 1 run schedule function gm4_combat_expanded:armor/modifier/type/link/clock 1t
