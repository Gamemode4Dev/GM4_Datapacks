...
$data modify storage gm4_combat_expanded:temp tag.display.Name set value '{"translate":"item.gm4.combat_expanded.name.link_no_translate","fallback":$(Name),"italic":false,"color":"light_purple"}'
