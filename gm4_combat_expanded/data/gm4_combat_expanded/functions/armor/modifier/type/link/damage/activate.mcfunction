...
execute unless score $remove_health gm4_ce_data matches 0 run function gm4_combat_expanded:armor/modifier/type/link/damage/eval with storage gm4_combat_expanded damage_player
data remove storage gm4_combat_expanded damage_player

# prepare reverting
tag @s add gm4_ce_damaged
schedule function gm4_combat_expanded:armor/modifier/type/link/damage/context 1t
