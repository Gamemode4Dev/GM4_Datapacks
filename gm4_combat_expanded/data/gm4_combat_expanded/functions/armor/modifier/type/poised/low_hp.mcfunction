...
execute store result storage gm4_combat_expanded:temp tag.AttributeModifiers[{Name:gm4_combat_expanded_2}].Amount float -1 run data get storage gm4_combat_expanded:temp tag.gm4_combat_expanded.level2
