...
execute if score $active gm4_ce_data matches 1 unless score $day gm4_ce_data = $stored_day gm4_ce_data run function gm4_combat_expanded:armor/modifiers/type/soothe/recharge

# check health if ready
execute if score $active gm4_ce_data matches 0 run function gm4_combat_expanded:armor/modifiers/type/soothe/health_check
