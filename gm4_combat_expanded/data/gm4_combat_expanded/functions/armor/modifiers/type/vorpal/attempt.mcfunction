...
function gm4_combat_expanded:armor/modifiers/type/vorpal/randomize
tag @s remove gm4_ce_warper

execute if score $warp_safe gm4_ce_data matches 1 run function gm4_combat_expanded:armor/modifiers/type/vorpal/tp_player
execute if score $warp_safe gm4_ce_data matches 0 run function gm4_combat_expanded:armor/modifiers/type/vorpal/failsafe
