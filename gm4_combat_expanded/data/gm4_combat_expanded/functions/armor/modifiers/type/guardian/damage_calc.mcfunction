...
execute if score @s gm4_ce_health matches 1.. if score $remove_health gm4_ce_data >= $max_health gm4_ce_data run function gm4_combat_expanded:armor/modifiers/type/guardian/guard_death
