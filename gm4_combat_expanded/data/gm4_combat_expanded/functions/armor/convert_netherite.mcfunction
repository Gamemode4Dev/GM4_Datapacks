...
execute store result score $armor gm4_ce_data run data get storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{name:"generic.armor_toughness"}].amount 10
execute store result storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{name:"generic.armor_toughness"}].amount double 0.1 run scoreboard players add $armor gm4_ce_data 10
data modify storage gm4_combat_expanded:temp components."minecraft:attribute_modifiers"[{name:"generic.knockback_resistance"}].amount set value 0.1d
