...
execute if data storage gm4_combat_expanded:temp Items[{Slot:0b}].tag.gm4_combat_expanded.unidentified run function gm4_combat_expanded:armor/slot/head/identify
execute if data storage gm4_combat_expanded:temp Items[{Slot:1b}].tag.gm4_combat_expanded.unidentified run function gm4_combat_expanded:armor/slot/chest/identify
execute if data storage gm4_combat_expanded:temp Items[{Slot:2b}].tag.gm4_combat_expanded.unidentified run function gm4_combat_expanded:armor/slot/legs/identify
execute if data storage gm4_combat_expanded:temp Items[{Slot:3b}].tag.gm4_combat_expanded.unidentified run function gm4_combat_expanded:armor/slot/feet/identify
