...
execute unless block ~ ~ ~ barrel run function gm4_ambrosia:hive/destroy_hive
...
execute if block ~ ~ ~ minecraft:barrel[open=true] unless block ~ ~-1 ~ campfire[lit=true] unless block ~ ~-2 ~ campfire[lit=true] unless block ~ ~-3 ~ campfire[lit=true] unless block ~ ~-4 ~ campfire[lit=true] run function gm4_ambrosia:beehavior/spawn_angry_bee
