...
# guidebook
summon marker ~ 3355.69973880393 ~ {CustomName:'"gm4_phantom_scarecrows_guide"',Tags:["gm4_guide"],data:{type:"module",id:"phantom_scarecrows",page_count:1,line_count:1,module_name:"Phantom Scarecrows"}}
