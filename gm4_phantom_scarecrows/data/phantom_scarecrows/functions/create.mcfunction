...
execute if entity @s[nbt={ArmorItems:[{},{},{},{id:"minecraft:skeleton_skull"}]},tag=!gm4_phantom_scarecrow] run tag @s add gm4_phantom_scarecrow
execute if entity @s[nbt={ArmorItems:[{},{},{},{id:"minecraft:zombie_head"}]},tag=!gm4_phantom_scarecrow] run tag @s add gm4_phantom_scarecrow
