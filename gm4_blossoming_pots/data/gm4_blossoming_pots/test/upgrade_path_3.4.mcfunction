...
execute align xyz run summon block_display ~2.5 ~1.5 ~2.5 {view_range:0.7935f,Tags:["gm4_blossoming_pots.display.flower_pot","gm4_blossoming_pots.display.flower_pot.0","smithed.entity"],block_state:{id:"minecraft:amethyst_cluster"},transformation:{translation:[-0.25f,0.2435f,-0.25f],left_rotation:[0f,0f,0f,1f],scale:[0.5f,0.5f,0.5f],right_rotation:[0f,0f,0f,1f]}}
