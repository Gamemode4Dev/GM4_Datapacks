...
execute if data entity @e[type=minecraft:marker,tag=gm4_blossoming_pots.data.flower_pot,distance=..0.1,limit=1] {data:{full:1}} run return run kill @s
...
data modify storage gm4_blossoming_pots:flower_pots temp.count set from entity @e[type=minecraft:marker,tag=gm4_blossoming_pots.data.flower_pot,distance=..0.1,limit=1] data.count
