...
execute \
    ...
    run return run function gm4_blossoming_pots:flower/item/remove_plant with storage gm4_blossoming_pots:flower_pots temp
...
execute if data entity @e[type=minecraft:marker,tag=gm4_blossoming_pots.data.flower_pot,distance=..0.2,limit=1] {data:{full:1}} run return run kill @s

# if no perma marker yet, summon it
$execute unless entity @e[type=minecraft:marker,tag=gm4_blossoming_pots.data.flower_pot,distance=..0.2,limit=1] \
...
execute as @e[type=minecraft:marker,tag=gm4_blossoming_pots.data.flower_pot,distance=..0.2,limit=1] run function gm4_blossoming_pots:flower/update_count
...
data modify storage gm4_blossoming_pots:flower_pots temp.count set from entity @e[type=minecraft:marker,tag=gm4_blossoming_pots.data.flower_pot,distance=..0.2,limit=1] data.count
