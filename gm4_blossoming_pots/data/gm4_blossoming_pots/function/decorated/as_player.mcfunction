...
execute as @n[type=minecraft:marker,tag=gm4_blossoming_pots.temp.decorated_pot,distance=32] at @s \
...
kill @n[type=minecraft:marker,tag=gm4_blossoming_pots.temp.decorated_pot,distance=32]
