...
execute if block ~ ~ ~ #minecraft:stairs[facing=north] align xyz run summon pig ~.5 ~-.39 ~.55 {NoAI:1,Saddle:1,NoGravity:1,Silent:1,Invulnerable:1,Tags:["gm4_chairs"],Rotation:[0.0f,0.0f],DeathTime:19,Attributes:[{Name:"generic.max_health",Base:1.0},{Name:"generic.movement_speed",Base:0.0}],ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:0b}],DeathLootTable:"minecraft:empty",Team:"gm4_chairs"}
