...
execute if score gm4_chairs load matches 1 run function gm4_chairs:init
execute unless score gm4_chairs load matches 1 run schedule clear gm4_chairs:main
