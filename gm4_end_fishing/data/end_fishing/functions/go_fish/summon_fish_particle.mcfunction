...
execute if score result gm4_ef_data matches 0 run summon area_effect_cloud ~ ~1 ~3 {Duration:32,Particle:"block air",Tags:[gm4_ef_particle_set]}
execute if score result gm4_ef_data matches 1 run summon area_effect_cloud ~ ~1 ~-3 {Duration:32,Particle:"block air",Tags:[gm4_ef_particle_set]}
execute if score result gm4_ef_data matches 2 run summon area_effect_cloud ~3 ~1 ~ {Duration:32,Particle:"block air",Tags:[gm4_ef_particle_set]}
execute if score result gm4_ef_data matches 3 run summon area_effect_cloud ~-3 ~1 ~ {Duration:32,Particle:"block air",Tags:[gm4_ef_particle_set]}
