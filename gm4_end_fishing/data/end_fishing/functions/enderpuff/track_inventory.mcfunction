...
execute if entity @s[tag=gm4_hold_enderpuff,tag=!gm4_enderpuff_fall] at @s run function end_fishing:enderpuff/apply_levitation
...
execute at @s if block ~ ~-1 ~ #end_fishing:traversable if block ~ ~-2 ~ #end_fishing:traversable if block ~ ~-3 ~ #end_fishing:traversable run function end_fishing:enderpuff/apply_slow_falling
