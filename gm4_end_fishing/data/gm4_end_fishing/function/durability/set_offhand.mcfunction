...
execute store result score $unbreaking_lvl gm4_ef_data run data get entity @s Inventory[{Slot:-106b}].components."minecraft:enchantments"."minecraft:unbreaking"
