...
# store lure value
execute unless entity @a[tag=gm4_ef_cast_rod,predicate=gm4_end_fishing:holding_fishing_rod,limit=1] store result score @s gm4_ef_lure run data get entity @a[tag=gm4_ef_cast_rod,limit=1] Inventory[{Slot:-106b}].components."minecraft:enchantments"."minecraft:lure"
