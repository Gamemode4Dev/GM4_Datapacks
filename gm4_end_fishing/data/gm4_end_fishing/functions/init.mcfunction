...
execute unless data storage gm4_player_heads-1.0:register heads[{id:"gm4_end_fishing:enderpuff/v0"}] run data modify storage gm4_player_heads-1.0:register heads append value {id:"gm4_end_fishing:enderpuff/v0",value:'',item:{CustomModelData:14,gm4_end_fishing:{enderpuff:1b},display:{Name:'{"translate":"%1$s%3427655$s","with":["Enderpuff",{"translate":"item.gm4.enderpuff"}],"italic":false}'}}}
# new texture
execute unless data storage gm4_player_heads-1.0:register heads[{id:"gm4_end_fishing:enderpuff/v1"}] run data modify storage gm4_player_heads-1.0:register heads append value {id:"gm4_end_fishing:enderpuff/v1",value:'',item:{CustomModelData:14,gm4_end_fishing:{enderpuff:1b},display:{Name:'{"translate":"%1$s%3427655$s","with":["Enderpuff",{"translate":"item.gm4.enderpuff"}],"italic":false}'}}}
