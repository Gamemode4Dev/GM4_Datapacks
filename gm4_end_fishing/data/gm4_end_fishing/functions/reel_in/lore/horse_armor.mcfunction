...
execute if score @s gm4_ef_data matches 80..99 run data merge entity @s {Item:{tag:{CustomModelData:14,display:{Lore:['{"translate":"%1$s%3427655$s","with":["Made by the finest materials known to man",{"translate":"text.gm4.end_city_horse_armor.5"}]}']}}}}
