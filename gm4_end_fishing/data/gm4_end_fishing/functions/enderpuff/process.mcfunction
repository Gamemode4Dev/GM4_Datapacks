...
#apply levitation
execute as @a[tag=gm4_enderpuff_used] at @s unless block ~ ~-1 ~ #gm4_end_fishing:traversable run tag @s remove gm4_enderpuff_used
...
#apply slow falling
execute unless score @s gm4_ef_sneak matches 1.. at @s if block ~ ~-1 ~ #gm4_end_fishing:traversable if block ~ ~-2 ~ #gm4_end_fishing:traversable if block ~ ~-3 ~ #gm4_end_fishing:traversable run effect give @s slow_falling 2 0
