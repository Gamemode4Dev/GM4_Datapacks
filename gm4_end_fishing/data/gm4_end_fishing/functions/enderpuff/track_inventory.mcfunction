...
execute at @s if block ~ ~-1 ~ #gm4_end_fishing:traversable if block ~ ~-2 ~ #gm4_end_fishing:traversable if block ~ ~-3 ~ #gm4_end_fishing:traversable run function gm4_end_fishing:enderpuff/apply_slow_falling
