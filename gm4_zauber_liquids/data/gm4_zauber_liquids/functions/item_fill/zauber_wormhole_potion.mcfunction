...
loot replace entity @e[type=armor_stand,tag=gm4_liquid_tank_display,limit=1,sort=nearest] weapon.mainhand loot gm4_zauber_cauldrons:recipes/chorus/wormhole
