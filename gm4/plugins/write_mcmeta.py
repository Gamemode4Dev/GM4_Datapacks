...
def beet_default(ctx: Context):
	...
	ctx.data.supported_formats = {"min_inclusive": 71, "max_inclusive": 80}
	ctx.assets.pack_format = 55
	ctx.assets.supported_formats = {"min_inclusive": 55, "max_inclusive": 63}
	...
	for pack in ctx.packs:
		pack.description = [
			...
			"\n",
			{
				"text": f"Gamemode 4 for 1.21.5 - 1.21.6",
				"color": "#4AA0C7"
			}
		]
