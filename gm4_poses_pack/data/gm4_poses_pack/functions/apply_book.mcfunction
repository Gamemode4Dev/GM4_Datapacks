...
# Check presets
execute if data storage gm4_better_armour_stands:temp {pages:["legs default"]} run data merge entity @s {Pose:{LeftLeg:[0.01f,0f,0f],RightLeg:[0.01f,0f,0f]},Tags:[gm4_pose_changed]}
...
execute if data storage gm4_better_armour_stands:temp {pages:["head default"]} run data merge entity @s {Pose:{Head:[0.01f,0f,0f]},Tags:[gm4_pose_changed]}
