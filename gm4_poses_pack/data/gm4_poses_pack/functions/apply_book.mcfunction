...
execute if entity @s[tag=!gm4_pose_changed,nbt={Item:{tag:{pages:["move"]}}}] as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] at @p[distance=..1] run tp @s ~ ~ ~
