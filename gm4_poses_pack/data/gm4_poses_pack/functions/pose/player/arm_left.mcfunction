...
execute store result storage gm4_better_armour_stands:temp Pose.LeftArm[0] float 0.001 run scoreboard players remove $player_rot_x gm4_poses_data 90000
execute store result storage gm4_better_armour_stands:temp Pose.LeftArm[1] float 0.001 run scoreboard players get $player_rot_y gm4_poses_data
