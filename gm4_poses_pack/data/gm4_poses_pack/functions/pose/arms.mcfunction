...
execute if entity @s[nbt={Item:{tag:{pages:["mirror","right"]}}}] as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/mirror_arm_right

#if book contains a page with "swap" or "flip"
execute if entity @s[nbt={Item:{tag:{pages:["swap"]}}}] as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/swap_arms
execute if entity @s[nbt={Item:{tag:{pages:["flip"]}}}] as @e[distance=..1,type=armor_stand,sort=nearest,tag=!gm4_no_edit] run function gm4_poses_pack:pose/player/flip_arms
