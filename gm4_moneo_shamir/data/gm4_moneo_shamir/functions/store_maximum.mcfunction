...
execute if entity @s[nbt={Item:{id:"minecraft:wooden_hoe"}}] run data modify entity @s Item.tag.MaxDurability set value 59
execute if entity @s[nbt={Item:{id:"minecraft:wooden_axe"}}] run data modify entity @s Item.tag.MaxDurability set value 59

execute if entity @s[nbt={Item:{id:"minecraft:stone_shovel"}}] run data modify entity @s Item.tag.MaxDurability set value 131
execute if entity @s[nbt={Item:{id:"minecraft:stone_pickaxe"}}] run data modify entity @s Item.tag.MaxDurability set value 131
execute if entity @s[nbt={Item:{id:"minecraft:stone_hoe"}}] run data modify entity @s Item.tag.MaxDurability set value 131
execute if entity @s[nbt={Item:{id:"minecraft:stone_axe"}}] run data modify entity @s Item.tag.MaxDurability set value 131

execute if entity @s[nbt={Item:{id:"minecraft:iron_shovel"}}] run data modify entity @s Item.tag.MaxDurability set value 250
execute if entity @s[nbt={Item:{id:"minecraft:iron_pickaxe"}}] run data modify entity @s Item.tag.MaxDurability set value 250
execute if entity @s[nbt={Item:{id:"minecraft:iron_hoe"}}] run data modify entity @s Item.tag.MaxDurability set value 250
execute if entity @s[nbt={Item:{id:"minecraft:iron_axe"}}] run data modify entity @s Item.tag.MaxDurability set value 250

execute if entity @s[nbt={Item:{id:"minecraft:diamond_shovel"}}] run data modify entity @s Item.tag.MaxDurability set value 1561
execute if entity @s[nbt={Item:{id:"minecraft:diamond_pickaxe"}}] run data modify entity @s Item.tag.MaxDurability set value 1561
...
execute if entity @s[nbt={Item:{id:"minecraft:elytra"}}] run data modify entity @s Item.tag.MaxDurability set value 432
