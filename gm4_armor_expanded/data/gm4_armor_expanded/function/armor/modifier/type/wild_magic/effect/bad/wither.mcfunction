...
data modify storage gm4_armor_expanded:temp wild_magic.id set value "wither"

# Duration
execute store result storage gm4_armor_expanded:temp wild_magic.duration int 1 run random value 6..20
