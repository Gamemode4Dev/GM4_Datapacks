...
# effects
execute if score $warp_safe gm4_ae_data matches 1.. at @e[type=marker,tag=gm4_ae_vorpal] align xyz run tp @s ~0.5 ~ ~0.5
kill @e[type=marker,tag=gm4_ae_vorpal]
...
# advancement
advancement grant @s only gm4:armor_expanded_vorpal
