...
execute if score gm4_orbis_pre_gen load matches 1 run function gm4_orbis_pre_gen:init
execute unless score gm4_orbis_pre_gen load matches 1 run schedule clear gm4_orbis_pre_gen:tick
