...
tellraw @a[gamemode=!survival,gamemode=!adventure] [{"text":"Progress: ","color":"aqua"},{"score":{"objective":"gm4_orbis_config","name":"z"},"color":"gold"},{"text":" [ ","color":"aqua"},{"score":{"objective":"gm4_orbis_config","name":"#percent"},"color":"gold"},{"text":"% ]","color":"aqua"}]
