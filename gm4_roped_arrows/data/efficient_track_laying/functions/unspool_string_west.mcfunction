...
#recursion
execute positioned ~-1 ~ ~ if block ~ ~ ~ #efficient_track_laying:airtype if score @s gm4_string_count matches 1.. if score string_placed gm4_string_count matches ..39 run function efficient_track_laying:unspool_string_west