...
#recursion
execute positioned ~-1 ~ ~ if block ~ ~ ~ #roped_arrows:airtype if score @s gm4_string_count matches 1.. if score string_placed gm4_string_count matches ..39 run function roped_arrows:unspool_string_west