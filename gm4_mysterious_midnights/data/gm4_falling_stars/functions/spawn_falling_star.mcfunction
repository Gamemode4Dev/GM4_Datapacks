...
#summon falling star
summon shulker_bullet ~ 260 ~ {CustomName:'{"translate":"%1$s%3427655$s","with":["Falling Star",{"translate":"entity.gm4.falling_star"}]}',Steps:0,Passengers:[{id:"potion",CustomName:'"Falling Star"',Potion:{Count:1b,id:"splash_potion",tag:{CustomPotionEffects:[{Id:25,Amplifier:0,Duration:300}],Potion:"thick",CustomPotionColor:16777215}}},{id:"area_effect_cloud",Duration:200,CustomName:'"gm4_falling_star_particle"',Radius:0.5f,Particle:"end_rod"},{id:"item",Age:3600,Tags:["gm4_falling_star_item"],Item:{Count:1b,id:"minecraft:end_stone"}}]}
