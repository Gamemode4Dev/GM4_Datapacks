...
execute if score falling_star_velocity gm4_mm_data >= falling_star_velocity_required gm4_mm_data if entity @a[x=0,limit=1] run function gm4_falling_stars:find_location
