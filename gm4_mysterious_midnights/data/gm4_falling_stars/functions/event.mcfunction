...
summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'"gm4_star_impact_point"',Tags:["gm4_star_impact_point"],Duration:18000,Radius:0.01f,Particle:"block air"}

#randomizer, kill some impact points
execute store result score falling_star_velocity gm4_nights_data run data get entity @e[type=area_effect_cloud,tag=gm4_star_impact_point,limit=1] UUID[0]
