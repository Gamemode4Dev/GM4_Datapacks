...
summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'"gm4_star_impact_point"',Tags:["gm4_star_impact_point"],Duration:18000,Radius:0f,Particle:"block air"}
...
scoreboard players operation falling_star_velocity_required gm4_mm_data = daytime gm4_mm_data
...
execute if score falling_star_velocity gm4_mm_data >= falling_star_velocity_required gm4_mm_data if entity @p run function gm4_falling_stars:find_location
