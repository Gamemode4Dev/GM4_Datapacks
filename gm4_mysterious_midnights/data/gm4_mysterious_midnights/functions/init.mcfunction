...
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 2953.174852106298 ~ {CustomName:'"gm4_nightmare_nights_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"mysterious_midnights",id:"nightmare_nights",page_count:1,line_count:1,module_name:"Nightmare Nights"}}
