...
execute if score difficulty gm4_mm_data matches 0.. run playsound entity.wolf.howl weather @a[x=0] ~ ~100000000000 ~ 0 1 1
execute if score difficulty gm4_mm_data matches 0..6 run function #gm4_mysterious_midnights:setup_common_expansion
execute if score difficulty gm4_mm_data matches 7..11 run function #gm4_mysterious_midnights:setup_uncommon_expansion
