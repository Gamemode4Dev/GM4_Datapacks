...
execute if data storage gm4_rational_villagers:temp/villager Modify{Type:"minor_positive"} if score value gm4_rv_trade matches 76.. run scoreboard players set value gm4_rv_trade 75
