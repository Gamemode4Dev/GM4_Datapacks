...
# burned
effect give @s[predicate=gm4_ce_base:mob/modifier/burned] fire_resistance infinite 0 true
data modify entity @s[predicate=gm4_ce_base:mob/modifier/burned,predicate=gm4_ce_base:technical/chance/grow_phantom_slight] Size set value 1
# flowering
data modify entity @s[predicate=gm4_ce_base:mob/modifier/flowering,predicate=gm4_ce_base:technical/chance/grow_phantom_slight] Size set value 1
data modify entity @s[predicate=gm4_ce_base:mob/modifier/flowering,predicate=gm4_ce_base:technical/chance/grow_phantom_large] Size set value 2
