...
# | Biome Modifiers
# flowering 
execute if predicate gm4_ce_base:mob/modifier/flowering if predicate gm4_ce_base:technical/chance/replace_enderman_slime run function gm4_ce_base:mob/init/special/flowering_enderman
# the end
...
# warped forest
execute if predicate gm4_ce_base:mob/modifier/nether/warped_forest if predicate gm4_ce_base:technical/chance/extra_enderman run function gm4_ce_base:mob/init/special/warped_forest_enderman
# nether wastes
execute if predicate gm4_ce_base:mob/modifier/nether/nether_wastes if predicate gm4_ce_base:technical/chance/replace_enderman_blaze run function gm4_ce_base:mob/init/special/nether_wastes_enderman
# soul sand valley
execute if predicate gm4_ce_base:mob/modifier/nether/soul_sand_valley if predicate gm4_ce_base:technical/chance/replace_enderman_wither_skeleton run function gm4_ce_base:mob/init/special/soul_sand_valley_enderman
