...
# | Modifiers
# crimson forest
execute if predicate gm4_ce_base:mob/modifier/nether/crimson_forest run scoreboard players set $mob_health gm4_ce_data 46

# set armor
loot replace entity @s armor.feet loot gm4_ce_base:mob/equip_armor/piglin
# set weapon
loot replace entity @s weapon.mainhand loot gm4_ce_base:mob/equip_weapon/piglin
