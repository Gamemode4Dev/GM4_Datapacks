...
# set weapon
loot replace entity @s weapon.mainhand loot gm4_ce_base:mob/equip_weapon/generic

# | Biome Modifiers
# snowy
tag @s[predicate=gm4_ce_base:mob/modifier/snowy] add gm4_ce_slowing_attacks
# mountainous
execute if predicate gm4_ce_base:mob/modifier/mountainous run function gm4_ce_base:mob/init/special/mountain_zombie
# burned
execute if entity @s[type=husk,predicate=gm4_ce_base:mob/modifier/burned] run function gm4_ce_base:mob/init/special/burned_husk
# flowering
execute if predicate gm4_ce_base:mob/modifier/flowering run tag @s add gm4_ce_spore_zombie
execute if entity @s[tag=gm4_ce_spore_zombie] run function gm4_ce_base:mob/init/special/flowering_zombie
# toxic
tag @s[predicate=gm4_ce_base:mob/modifier/toxic] add gm4_ce_weakness_attacks
# deep
attribute @s[type=drowned,predicate=gm4_ce_base:mob/modifier/deep] generic.movement_speed modifier add 34e4955b-8f75-4292-89e9-7a1639499717 "gm4_ce_modifier_deep" 0.2 add_multiplied_base
# reef
execute if entity @s[type=drowned,predicate=gm4_ce_base:mob/modifier/reef] run function gm4_ce_base:mob/init/special/reef_drowned
# growth
execute if entity @s[type=!zombie_villager,tag=!gm4_ce_spore_zombie,predicate=gm4_ce_base:mob/modifier/growth] run function gm4_ce_base:mob/init/special/growth_zombie
...
execute if data entity @s[type=!zombie_villager] Attributes[{Name:"minecraft:generic.max_health"}].Modifiers[{Name:"Leader zombie bonus"}] run function gm4_ce_base:mob/init/special/zombie_leader
...
execute if entity @s[type=zombie,tag=gm4_ce_miniboss] run function gm4_ce_base:mob/init/special/zombie_miniboss
execute if entity @s[type=husk,tag=gm4_ce_miniboss] run function gm4_ce_base:mob/init/special/husk_miniboss
execute if entity @s[type=drowned,tag=gm4_ce_miniboss] run function gm4_ce_base:mob/init/special/drowned_miniboss
