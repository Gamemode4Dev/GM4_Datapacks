...
function gm4_ce_base:mob/init/special/burned_husk_army
...
loot replace entity @s armor.feet loot gm4_ce_base:mob/equip_armor/miniboss
loot replace entity @s weapon.mainhand loot gm4_ce_base:mob/equip_weapon/miniboss
loot replace entity @s weapon.offhand loot gm4_ce_base:mob/equip_weapon/shield
