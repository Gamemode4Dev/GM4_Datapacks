...
execute align xyz positioned ~ ~-1 ~ unless entity @e[type=armor_stand,tag=gm4_no_edit,tag=!gm4_liquid_tank_display,nbt={Invisible:1b,Marker:1b,NoGravity:1b},dx=0,dz=0,dy=1] at @s[gamemode=!creative] run summon item ~ ~ ~ {Item:{id:"minecraft:player_head",Count:1b,tag:{CustomModelData:26,gm4_relocator:1b,display:{Name:'{"translate":"%1$s%3427655$s","with":["Relocator",{"translate":"item.gm4.relocator"}],"italic":false}'},SkullOwner:{Id:"2c0fa9da-b8e7-4dfe-81eb-7885c62d6a92",Properties:{textures:[{Value:""}]}}}}}

execute align xyz positioned ~ ~-1 ~ if entity @e[type=armor_stand,tag=gm4_no_edit,tag=!gm4_liquid_tank_display,nbt={Invisible:1b,Marker:1b,NoGravity:1b},dx=0,dz=0,dy=1] run advancement grant @s only gm4:relocators

execute align xyz positioned ~ ~-1 ~ as @e[type=armor_stand,tag=gm4_no_edit,tag=!gm4_liquid_tank_display,nbt={Invisible:1b,Marker:1b,NoGravity:1b},limit=1,sort=nearest,dx=0,dz=0,dy=1] positioned ~ ~1 ~ run function relocators:store_machine_data
