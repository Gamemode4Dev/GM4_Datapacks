...
execute if score gm4_custom_crafters load.status matches 2 if entity @s[tag=gm4_custom_crafter] run function gm4_relocators:custom_crafter_relocating/set_pick_up_data
