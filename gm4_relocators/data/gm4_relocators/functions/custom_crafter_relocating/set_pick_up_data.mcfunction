...
data modify storage gm4_relocators:temp merge_data.block_state set value {lore:'{"translate":"%1$s%3427655$s","with":["Custom Crafter",{"translate":"block.gm4.custom_crafter"}],"color":"gray","italic":true}'}
