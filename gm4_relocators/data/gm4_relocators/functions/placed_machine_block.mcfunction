...
execute as @e[tag=gm4_relocated_ray] at @s run function gm4_relocators:ray
...
execute at @e[type=armor_stand,tag=gm4_rl_set_stand_data] run function gm4_relocators:set_machine_data
