...
execute if entity @s[gamemode=!creative,gamemode=!spectator] run loot spawn ~ ~.3 ~ loot gm4_relocators:items/relocator_empty
data merge entity @e[type=item,distance=..0.6,nbt={Age:0s,Item:{id:"minecraft:player_head",Count:1b,tag:{gm4_machines:{id:"relocator_empty"}}}},limit=1] {PickupDelay:0}
