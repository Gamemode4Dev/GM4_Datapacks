...
data merge entity @e[type=item,distance=..7,nbt={Age:0s,Item:{id:"minecraft:player_head",count:1,components:{"minecraft:custom_data":{gm4_machines:{id:"relocator_empty"}}}}},limit=1] {PickupDelay:0}
