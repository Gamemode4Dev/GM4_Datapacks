...
# run from advancement "backwards_compatibility/place_relocated_block"
...
execute as @e[tag=gm4_relocated_ray] at @s run function gm4_relocators:backwards_compatibility/ray
...
execute at @s[gamemode=!creative] run summon item ~ ~ ~ {Item:{id:"minecraft:player_head",Count:1b,tag:{CustomModelData:3420027,gm4_relocator:1b,display:{Name:'{"translate":"%1$s%3427655$s","with":["Relocator",{"translate":"item.gm4.relocator"}],"italic":false}'},SkullOwner:{Id:[I;739224026,-1192800770,-2115274619,-970102126],Properties:{textures:[{Value:""}]}}}}}

execute at @e[type=armor_stand,tag=gm4_rl_set_stand_data] run function gm4_relocators:backwards_compatibility/set_machine_data
