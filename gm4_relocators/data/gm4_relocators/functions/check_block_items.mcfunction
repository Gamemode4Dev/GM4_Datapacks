...
execute if score block_entity gm4_rl_data matches 1 unless data block ~ ~ ~ Items[0] run function relocators:store_machine_data
...
execute if score block_entity gm4_rl_data matches 0 run function relocators:store_machine_data
