...
execute if score @s gm4_fa_slot_cnt matches 2 if block ~ ~ ~ minecraft:dropper{Items:[{id:"minecraft:firework_rocket",Slot:0b},{id:"minecraft:flint",Slot:1b}]} unless block ~ ~ ~ minecraft:dropper{Items:[{tag:{Fireworks:{Flight:1b}}}]} run function firework_assemblers:recipes/duration/subtract

#flight duration 1 rockets
execute if score @s gm4_fa_slot_cnt matches 2 if block ~ ~ ~ minecraft:dropper{Items:[{id:"minecraft:paper",Slot:0b},{id:"minecraft:gunpowder",Slot:1b}]} run function firework_assemblers:recipes/firework_rocket/checks
...
execute if score @s gm4_fa_slot_cnt matches 2 if block ~ ~ ~ minecraft:dropper{Items:[{id:"minecraft:firework_rocket",Slot:0b},{id:"minecraft:paper",Slot:1b,tag:{gm4_firework_assemblers:{firework_pattern:1b}}}]} unless block ~ ~ ~ minecraft:dropper{Items:[{id:"minecraft:firework_rocket",tag:{Fireworks:{Explosions:[]}}}]} run function firework_assemblers:recipes/pattern/to_item/firework_rocket
execute if score @s gm4_fa_slot_cnt matches 2 if block ~ ~ ~ minecraft:dropper{Items:[{id:"minecraft:firework_star",Slot:0b},{id:"minecraft:paper",Slot:1b,tag:{gm4_firework_assemblers:{firework_pattern:1b}}}]} unless block ~ ~ ~ minecraft:dropper{Items:[{id:"minecraft:firework_star",tag:{Explosion:{}}}]} run function firework_assemblers:recipes/pattern/to_item/firework_star
