...
execute align xyz store success score $dropped_item gm4_apple_data run kill @e[type=item,nbt={Item:{id:"minecraft:oak_sapling",count:1}},nbt=!{Item:{tag:{}}},limit=1,dx=0]
