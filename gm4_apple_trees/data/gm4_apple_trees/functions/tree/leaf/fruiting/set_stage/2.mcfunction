...
data merge entity @s {HandItems:[{},{id:"minecraft:apple",Count:1b}],Small:0b,DisabledSlots:30,Tags:["gm4_fruiting_leaf","gm4_apple_leaf","gm4_ripe_apple"],Pose:{LeftArm:[0.0f,90.0f,90.0f]}}
tp @s ~0.5 ~-0.9 ~0.5
