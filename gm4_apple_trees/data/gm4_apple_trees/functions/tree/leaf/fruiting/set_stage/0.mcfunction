...
# visuals
execute if data entity @s HandItems[0].id positioned ~0.5 ~1.5 ~0.5 positioned ^-.25 ^ ^.1 run function gm4_apple_trees:tree/leaf/fruiting/spawn_apple
data merge entity @s {Marker:1b,HandItems:[],Small:1b,DisabledSlots:2171166,Tags:["gm4_fruiting_leaf","gm4_apple_leaf"]}
tp @s ~0.5 ~1.05 ~0.5
