...
# place leaves
# layer 0
fill ^-1 ^ ^ ^1 ^ ^2 minecraft:oak_leaves replace #gm4_apple_trees:tree_replaceable
fill ^ ^ ^-1 ^ ^ ^-1 minecraft:oak_leaves replace #gm4_apple_trees:tree_replaceable
...
fill ^-1 ^2 ^ ^1 ^2 ^ minecraft:oak_leaves replace #gm4_apple_trees:tree_replaceable

# layer 3
fill ^ ^3 ^ ^ ^3 ^ minecraft:oak_leaves replace #gm4_apple_trees:tree_replaceable
