...
execute unless score $max_layer gm4_tree_layer >= #max_height gm4_apple_data positioned ~ ~1 ~ if predicate gm4_apple_trees:5x5_clear run function gm4_apple_trees:tree/layer/check_clear_space
