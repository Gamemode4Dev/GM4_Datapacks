...
execute positioned ^ ^ ^2.5 as @e[type=minecraft:armor_stand,tag=gm4_ripe_apple,distance=..3,sort=nearest,limit=1,predicate=gm4_apple_trees:apple_picked] run function gm4_apple_trees:leaf/apple/pick
