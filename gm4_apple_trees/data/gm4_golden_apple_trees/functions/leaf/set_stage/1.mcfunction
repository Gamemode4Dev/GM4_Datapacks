...
data merge entity @s {Marker:0b,ShowArms:1b,HandItems:[{},{id:"minecraft:golden_apple",Count:1b,tag:{CustomModelData:"block/golden_apple_unripe"}}],Pose:{LeftArm:[0.0f,90.0f,90.0f]}}
