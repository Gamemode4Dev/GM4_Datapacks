...
data merge entity @s {HandItems:[{},{id:"minecraft:golden_apple",Count:1b}],ShowArms:1b,Small:0b,DisabledSlots:30,Tags:["gm4_no_edit","gm4_golden_apple","gm4_ripe_apple","smithed.entity","smithed.strict"],Pose:{LeftArm:[0.0f,90.0f,90.0f]}}
tp @s ~0.5 ~-0.9 ~0.5
