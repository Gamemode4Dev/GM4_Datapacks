...
# kill interaction
kill @e[type=interaction,tag=gm4_golden_apple_interaction,limit=1,sort=nearest,distance=..0.5]

# visuals
loot spawn ~ ~-0.1 ~ loot gm4_golden_apple_trees:blocks/golden_apple
