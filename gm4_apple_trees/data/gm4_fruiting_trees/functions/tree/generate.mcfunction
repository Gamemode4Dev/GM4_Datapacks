...
execute unless score $current_layer gm4_tree_layer > $max_layer gm4_tree_layer unless score $cancel_generation gm4_tree_layer matches 1.. at @s run function gm4_fruiting_trees:tree/generate
