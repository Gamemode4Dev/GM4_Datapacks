execute if score gm4 load matches 1 if score gm4_orbis load matches 1 run scoreboard players set gm4_fruiting_trees load 1
...
execute unless score gm4_orbis load matches 1 run data modify storage gm4:log queue append value {type:"missing",module:"Apple Trees",require:"Orbis"}
