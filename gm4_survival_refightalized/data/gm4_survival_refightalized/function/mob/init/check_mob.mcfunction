...
# remove gm4_sr_processed tag if this mob is riding another mob (spider / chicken jockeys)
...
execute unless entity @s[tag=gm4_sr_processed] run function gm4_survival_refightalized:mob/init/calc_difficulty_base
