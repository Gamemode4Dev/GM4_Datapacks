...
execute if entity @s[type=trident] run return run execute store result entity @s item.components."minecraft:enchantments"."gm4_survival_refightalized:trident_damage_reduction" int -1 run scoreboard players get $arrow_damage_change gm4_sr_data
