...
execute store result score $dev.health_max gm4_sr_data run attribute @s max_health get 1
...
execute if score $worlddiff gm4_sr_data matches 1 store result score $dev.damage gm4_sr_data run attribute @s attack_damage get 77
execute if score $worlddiff gm4_sr_data matches 2 store result score $dev.damage gm4_sr_data run attribute @s attack_damage get 100
execute if score $worlddiff gm4_sr_data matches 3 store result score $dev.damage gm4_sr_data run attribute @s attack_damage get 150
...
execute store result score $dev.speed gm4_sr_data run attribute @s movement_speed get 100
