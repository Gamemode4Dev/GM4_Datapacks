...
execute if score $total_durability gm4_sr_data matches 0 store result score $total_durability gm4_sr_data run function gm4_survival_refightalized:player/armor_durability/head/find_durability
...
execute if score $current_damage gm4_sr_data > $total_durability gm4_sr_data run return run function gm4_survival_refightalized:player/armor_durability/head/break
...
function gm4_survival_refightalized:player/armor_durability/head/eval with storage gm4_survival_refightalized:temp set
