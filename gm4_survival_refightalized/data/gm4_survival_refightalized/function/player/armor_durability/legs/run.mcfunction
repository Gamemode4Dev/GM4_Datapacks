...
execute store result score $unbreaking_level gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[{Slot:2b}].components."minecraft:enchantments".levels."minecraft:unbreaking"
...
execute if score $total_durability gm4_sr_data matches 0 store result score $total_durability gm4_sr_data run function gm4_survival_refightalized:player/armor_durability/legs/find_durability
...
execute if score $current_damage gm4_sr_data > $total_durability gm4_sr_data run return run function gm4_survival_refightalized:player/armor_durability/legs/break
...
function gm4_survival_refightalized:player/armor_durability/legs/eval with storage gm4_survival_refightalized:temp set
