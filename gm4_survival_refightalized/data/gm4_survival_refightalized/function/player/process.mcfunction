...
execute if score $natural_regen gm4_sr_config matches 0 unless score @s[scores={gm4_sr_hunger=7..}] gm4_sr_combat_regen_timer matches 1.. run function gm4_survival_refightalized:player/health/regen_combat_health
execute if score $natural_regen gm4_sr_config matches 0 unless score @s[scores={gm4_sr_fast_regen_health=1..}] gm4_sr_fast_regen_timer matches 1.. run function gm4_survival_refightalized:player/health/regen_fast_health
...
scoreboard players remove @s[scores={gm4_sr_armor_reduction_timer=1..}] gm4_sr_armor_reduction_timer 10
