...
execute store result storage gm4_survival_refightalized damage_player.remove_health int 1 run scoreboard players operation $remove_health gm4_sr_data += $damage_health gm4_sr_data
