...
execute store result score $enchant.protection gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[0].components."minecraft:enchantments".levels."minecraft:protection" 4
execute store result score $enchant.protection.add gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[1].components."minecraft:enchantments".levels."minecraft:protection" 4
scoreboard players operation $enchant.protection gm4_sr_data += $enchant.protection.add gm4_sr_data
execute store result score $enchant.protection.add gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[2].components."minecraft:enchantments".levels."minecraft:protection" 4
scoreboard players operation $enchant.protection gm4_sr_data += $enchant.protection.add gm4_sr_data
execute store result score $enchant.protection.add gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[3].components."minecraft:enchantments".levels."minecraft:protection" 4
scoreboard players operation $enchant.protection gm4_sr_data += $enchant.protection.add gm4_sr_data
