...
execute store result score $enchant.protection gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[0].components."minecraft:enchantments".levels."minecraft:protection" 1
execute store result score $enchant.protection.add gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[1].components."minecraft:enchantments".levels."minecraft:protection" 1
scoreboard players operation $enchant.protection gm4_sr_data += $enchant.protection.add gm4_sr_data
execute store result score $enchant.protection.add gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[2].components."minecraft:enchantments".levels."minecraft:protection" 1
scoreboard players operation $enchant.protection gm4_sr_data += $enchant.protection.add gm4_sr_data
execute store result score $enchant.protection.add gm4_sr_data run data get storage gm4_survival_refightalized:temp Items[3].components."minecraft:enchantments".levels."minecraft:protection" 1
scoreboard players operation $enchant.protection gm4_sr_data += $enchant.protection.add gm4_sr_data
...
# damage is only reduced at the end to let all protection enchantments work fully
