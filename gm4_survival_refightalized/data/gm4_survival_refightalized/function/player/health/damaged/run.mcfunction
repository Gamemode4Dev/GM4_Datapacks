...
execute unless score @s[scores={gm4_sr_shield.timer=1..2,gm4_sr_shield.use_ticks=1..}] gm4_sr_stat.damage_taken matches 1.. unless score @s gm4_sr_stat.damage_absorbed matches 1.. run return run function gm4_survival_refightalized:player/health/damaged/shield_blocked
...
execute if score @s gm4_sr_stat.damage_resisted matches 1.. run function gm4_survival_refightalized:player/health/damaged/calculate_reduction
...
execute if score @s gm4_sr_stat.damage_resisted matches 1.. run function gm4_survival_refightalized:player/health/damaged/calculate_damage
...
execute if entity @s[advancements={gm4_survival_refightalized:damaged={combat_damage=false}}] run scoreboard players operation $set gm4_sr_health.regeneration_timer < #50 gm4_sr_data
