...
scoreboard players operation $lethal_damage gm4_sr_data = @s gm4_sr_armor
scoreboard players operation $lethal_damage gm4_sr_data += @s gm4_sr_health.current
scoreboard players operation $lethal_damage gm4_sr_data *= #10 gm4_sr_data
execute if score @s gm4_sr_damage_resisted >= $lethal_damage gm4_sr_data run advancement grant @s only gm4:survival_refightalized_parry_lethal_damage
