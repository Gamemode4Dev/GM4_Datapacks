...
# give a short burst
execute unless score @s gm4_sr_shield.timer matches 1.. run attribute @s knockback_resistance modifier add gm4_survival_refightalized:using_shield 1 add_value
