...
execute if score $success gm4_arb_data matches 0 store success score $success gm4_arb_data if data storage gm4_arborenda_shamir:temp {item:"minecraft:pale_oak_log"} align xyz run summon marker ~0.5 ~0.5 ~0.5 {Tags:[gm4_arborenda_trunk_source,gm4_arborenda_trunk,gm4_arborenda_init]}
...
execute if score $success gm4_arb_data matches 0 store success score $success gm4_arb_data if data storage gm4_arborenda_shamir:temp {item:"minecraft:pale_oak_wood"} align xyz run summon marker ~0.5 ~0.5 ~0.5 {Tags:[gm4_arborenda_trunk_source,gm4_arborenda_trunk,gm4_arborenda_init]}
