...
execute store result score $unbreaking_level gm4_arb_data run data get entity @s SelectedItem.tag.Enchantments[{id:"minecraft:unbreaking"}].lvl
...
execute store result score $current_damage gm4_arb_data run data get entity @s SelectedItem.tag.Damage
...
execute store result storage gm4_metallurgy:temp Damage int 1 run scoreboard players get $current_damage gm4_arb_data
