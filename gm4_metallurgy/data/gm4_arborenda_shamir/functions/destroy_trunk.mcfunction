...
execute if score @s[tag=gm4_acacia_feller] gm4_arb_stat matches 1.. run function gm4_arborenda_shamir:fell_acacia

execute store result score @s[tag=gm4_birch_feller] gm4_arb_stat run fill ~ ~1 ~ ~ ~1 ~ air replace birch_log
execute if score @s[tag=gm4_birch_feller] gm4_arb_stat matches 1.. run function gm4_arborenda_shamir:fell_birch

execute store result score @s[tag=gm4_dark_oak_feller] gm4_arb_stat run fill ~3 ~1 ~3 ~-3 ~1 ~-3 air replace dark_oak_log
execute if score @s[tag=gm4_dark_oak_feller] gm4_arb_stat matches 1.. run function gm4_arborenda_shamir:fell_dark_oak
...
execute if score @s[tag=gm4_jungle_feller] gm4_arb_stat matches 1.. run function gm4_arborenda_shamir:fell_jungle

execute store result score @s[tag=gm4_oak_feller] gm4_arb_stat run fill ~5 ~1 ~5 ~-5 ~1 ~-5 air replace oak_log
execute if score @s[tag=gm4_oak_feller] gm4_arb_stat matches 1.. run function gm4_arborenda_shamir:fell_oak
...
execute store result score @s[tag=gm4_red_mushroom_feller] gm4_arb_stat run fill ~3 ~1 ~3 ~-3 ~1 ~-3 air replace red_mushroom_block
