...
execute if score $current_depth gm4_ml_data matches ..32 if score $chop_count gm4_ml_data matches ..256 if entity @e[type=marker,tag=gm4_arborenda_init] run function gm4_arborenda_shamir:trunk/next_depth
