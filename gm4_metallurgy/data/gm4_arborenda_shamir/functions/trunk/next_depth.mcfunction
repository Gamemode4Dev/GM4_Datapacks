...
execute store result score @e[type=marker,tag=gm4_arborenda_init] gm4_arb_depth run scoreboard players operation $current_depth gm4_arb_data += $axe_speed gm4_arb_data
