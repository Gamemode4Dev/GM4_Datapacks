...
execute unless score valid_tool gm4_ml_data matches 1 store success score valid_tool gm4_ml_data if entity @s[nbt={Item:{id:"minecraft:diamond_sword"}}]
...
execute if score valid_tool gm4_ml_data matches 1 run data merge entity @s {Item:{tag:{gm4_metallurgy:{has_shamir:1b,active_shamir:"ender_bolt",ore_type:"thorium"},display:{Lore:["§8Thorium Band","§bShamir:","§7Ender Bolt"]}}},Tags:["gm4_ml_smooshed"]}
