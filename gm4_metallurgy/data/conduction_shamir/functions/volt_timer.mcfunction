...
execute unless score @s gm4_volt_damage matches 40.. run title @s title ["",{"text":"⚡","color":"gray"}]
#show yellow marker if enough damage dealt
execute if score @s gm4_volt_damage matches 40.. run title @s title ["",{"text":"⚡","color":"yellow"}]
