...
execute if score @s gm4_volt_time matches 0 unless score @s gm4_volt_damage matches 3000.. at @s run function conduction_shamir:failed_to_deplete_charge

#remove charge, cast lightning at looking vector and restart cycle
execute if score @s gm4_volt_time matches 0 if score @s gm4_volt_damage matches 3000.. at @s run function conduction_shamir:successfully_deplete_charge
