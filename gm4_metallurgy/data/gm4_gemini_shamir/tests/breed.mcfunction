...
item replace entity @s weapon.offhand with iron_hoe{gm4_metallurgy:{has_shamir:1b,active_shamir:"gemini"}}
item replace entity @s weapon.mainhand with carrot 2
