#@s = tool with a levity shamir on it
...
execute as @e[type=item,dx=0,limit=1,nbt={Item:{Count:1b,id:"minecraft:obsidian"}}] run function levity_shamir:transfer_shamir/dock_band
