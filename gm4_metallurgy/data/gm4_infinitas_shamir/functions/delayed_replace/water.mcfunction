...
execute store success score @s gm4_infinitas_success_check run item replace entity @s[advancements={gm4_infinitas_shamir:water/place={place_water_mainhand=true}},predicate=gm4_infinitas_shamir:mainhand/after/water] weapon.mainhand with water_bucket
...
execute store success score @s gm4_infinitas_success_check run item replace entity @s[advancements={gm4_infinitas_shamir:water/place={place_water_offhand=true}},predicate=gm4_infinitas_shamir:offhand/after/water] weapon.offhand with water_bucket
