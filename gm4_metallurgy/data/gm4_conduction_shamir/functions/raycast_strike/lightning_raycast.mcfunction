...
#stirke if in block
execute unless score @s gm4_volt_dist matches 20.. at @s unless block ~ ~ ~ #conduction_shamir:air run function gm4_conduction_shamir:raycast_strike/summon_lightning
