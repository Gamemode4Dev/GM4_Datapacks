...
execute as @a[tag=gm4_has_levity,scores={gm4_levity_sneak=1..}] at @s run function gm4_levity_shamir:player_sneaking

#remove floating levitation when sneaking ceases
execute as @a[tag=gm4_has_levity,scores={gm4_levity_sneak=0}] run function gm4_levity_shamir:cancel_levitation
