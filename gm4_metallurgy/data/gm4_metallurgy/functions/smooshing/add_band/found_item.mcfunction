...
execute unless data entity @e[type=item,tag=gm4_ml_source,dx=0,limit=1] Item.tag.SkullOwner.Name run function gm4_metallurgy:smooshing/add_band/update_skull_owner
