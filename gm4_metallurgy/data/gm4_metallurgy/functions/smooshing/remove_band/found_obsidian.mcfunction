...
execute if entity @s[nbt={Item:{tag:{gm4_metallurgy:{metal:{type:"bismuth"}}}}}] run loot spawn ~ ~ ~ loot gm4_metallurgy:bismuth_band
execute if entity @s[nbt={Item:{tag:{gm4_metallurgy:{metal:{type:"copper"}}}}}] run loot spawn ~ ~ ~ loot gm4_metallurgy:bismuth_band
execute if entity @s[nbt={Item:{tag:{gm4_metallurgy:{metal:{type:"curies_bismium"}}}}}] run loot spawn ~ ~ ~ loot gm4_metallurgy:curies_bismium_band
