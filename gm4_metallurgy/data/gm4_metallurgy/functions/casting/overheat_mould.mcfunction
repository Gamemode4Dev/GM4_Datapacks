...
summon item ~ ~ ~ {Item:{id:"minecraft:magma_block",Count:1b,tag:{display:{Lore:['{"translate":"item.gm4.slightly_overheated_obsidian","fallback":"Slightly Overheated Obsidian","italic":false}']}}},Motion:[0.0,0.2,0.0]}
