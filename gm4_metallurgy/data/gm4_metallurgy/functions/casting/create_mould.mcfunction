...
summon armor_stand ~.65 ~-0.545 ~.5 {Small:1,NoGravity:1,Marker:1,Invisible:1,Silent:1,DisabledSlots:2039552,Tags:["gm4_no_edit","gm4_sand_ring_display"],Fire:200000,CustomName:'"gm4_sand_ring_display"',HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{CustomModelData:23}},{}],Pose:{RightArm:[0f, 0f, 0f]}}
