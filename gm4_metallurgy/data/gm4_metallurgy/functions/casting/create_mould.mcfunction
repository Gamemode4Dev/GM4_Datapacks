...
summon armor_stand ~.45 ~-1.150 ~.65 {CustomName:'"gm4_sand_ring"',Tags:["gm4_sand_ring","gm4_new_sand_ring"],ArmorItems:[{id:"minecraft:stick",count:1},{},{},{id:"minecraft:player_head",count:1,tag:{CustomModelData:"block/mould/cool_empty",SkullOwner:"$mould/cool_empty"}}],Silent:1,Invulnerable:1,Marker:1b,Invisible:1b,NoGravity:1b,Small:1b,HasVisualFire:1b}
...
kill @e[type=item,limit=1,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:clay_ball",count:1},OnGround:1b}]
kill @e[type=item,limit=1,dx=0,dy=0,dz=0,nbt={Item:{id:"minecraft:obsidian",count:1},OnGround:1b}]
