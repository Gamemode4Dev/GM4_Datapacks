...
# add primary metal
scoreboard players operation @s gm4_ml_ore_al += ore_amount gm4_ml_data
...
scoreboard players operation @s gm4_ml_ore_ba += ore_amount gm4_ml_data
...
kill @e[type=item,tag=gm4_ml_in_animation,dx=0,dz=0,limit=1,nbt={Item:{Count:1b,tag:{gm4_metallurgy:{ore:{type:"barimium"}}}},OnGround:1b}]