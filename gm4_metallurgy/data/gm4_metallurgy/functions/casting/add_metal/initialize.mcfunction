...
data modify storage gm4_metallurgy:temp/item/ore gm4_metallurgy set from entity @e[type=item,tag=gm4_ml_in_animation,dx=0,dz=0,nbt={Item:{count:1,tag:{gm4_metallurgy:{metal:{castable:1b}}}},OnGround:1b},limit=1] Item.tag.gm4_metallurgy
...
execute as @e[type=item,tag=!gm4_ml_in_animation,dx=0,dz=0,limit=1,nbt={Item:{count:1,tag:{gm4_metallurgy:{metal:{castable:1b}}}},OnGround:1b}] run data merge entity @s {Motion:[0.0,0.35,0.0],PickupDelay:30,Tags:["gm4_ml_in_animation"],Item:{tag:{gm4_metallurgy:{ore_in_animation:1b}}}}
