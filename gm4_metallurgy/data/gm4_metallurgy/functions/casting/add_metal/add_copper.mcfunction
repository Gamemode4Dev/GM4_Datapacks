...
execute if entity @e[type=item,tag=gm4_ml_in_animation,dx=0,dz=0,nbt=!{Item:{Count:1b,tag:{gm4_metallurgy:{has_shamir:1b}}},OnGround:1b}] run scoreboard players add @s gm4_ml_ore_cu 1
execute if entity @e[type=item,tag=gm4_ml_in_animation,dx=0,dz=0,nbt={Item:{Count:1b,tag:{gm4_metallurgy:{has_shamir:1b}}},OnGround:1b}] run scoreboard players add @s gm4_ml_ore_cu 12
