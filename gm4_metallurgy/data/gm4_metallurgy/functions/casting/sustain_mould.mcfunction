...
execute if score @s gm4_ml_heat matches 50..89 align xyz if entity @e[type=item,nbt={Item:{count:1,tag:{gm4_metallurgy:{metal:{castable:1b}}}},OnGround:1b},dx=0,dy=0,dz=0] run function gm4_metallurgy:casting/add_metal/initialize
