...
execute if score band_applied gm4_ml_data matches 0 run summon item ~ ~ ~ {Item:{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;2090045838,1070000930,-1136417339,1085846924],Properties:{textures:[{Value:""}]}},display:{Name:'{"translate":"%1$s%3427655$s","with":["Obsidian Cast",{"translate":"item.gm4.metallurgy.obsidian_cast"}],"italic":false}',Lore:['{"translate":"%1$s%3427655$s","with":["Mundane Band",{"translate":"item.gm4.metallurgy.mundane_band"}],"italic":false,"color":"gray"}']}}}}

# spawn xp if band was applied
execute if score band_applied gm4_ml_data matches 1 if entity @p[distance=..4] run summon experience_orb ~ ~ ~ {Value:37s}
