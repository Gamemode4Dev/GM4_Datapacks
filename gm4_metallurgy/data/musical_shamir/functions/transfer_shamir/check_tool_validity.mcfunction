...
execute if score valid_tool gm4_ml_data matches 1 run data merge entity @s {Item:{tag:{gm4_metallurgy:{has_shamir:1b,active_shamir:"musical",ore_type:"barimium"},display:{Lore:['{"text":"Barimium Band","color":"light_purple","italic":false}','{"text":"Shamir","color":"aqua","italic":false}','{"text":"Musical","color":"gray","italic":false}']}}},Tags:["gm4_ml_smooshed"]}
