...
execute if score valid_tool gm4_ml_data matches 1 run data merge entity @s {Item:{tag:{gm4_metallurgy:{has_shamir:1b,active_shamir:"musical",ore_type:"barimium"},display:{Lore:["§dBarimium Band","§bShamir:","§7Musical"]}}},Tags:["gm4_ml_smooshed"]}
