#@s = tool with a musical shamir on it
...
execute as @e[type=item,dx=0,limit=1,nbt={Item:{Count:1b,id:"minecraft:obsidian"}}] run function musical_shamir:transfer_shamir/dock_band
