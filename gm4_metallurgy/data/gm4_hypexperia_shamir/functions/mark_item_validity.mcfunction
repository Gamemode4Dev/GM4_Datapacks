...
execute unless score valid_item gm4_ml_data matches 1 store success score valid_item gm4_ml_data if predicate gm4_metallurgy:item_type/sword
...
execute unless score valid_item gm4_ml_data matches 1 store success score valid_item gm4_ml_data if predicate gm4_metallurgy:item_type/fishing_rod
