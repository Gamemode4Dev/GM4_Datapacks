...
function #metallurgy:random_band_init/barimium

#select and tag a random representative AEC
tag @e[type=area_effect_cloud,distance=..0.5,tag=gm4_ml_raw_barimium_band,sort=random,limit=1] add gm4_ml_selected_shamir
