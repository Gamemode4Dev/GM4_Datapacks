...
summon item ~ ~1.2 ~ {Item:{id:"minecraft:magma_block",Count:1b,tag:{display:{Lore:['{"translate":"%1$s%3427655$s","with":["Slightly Overheated Obsidian",{"translate":"item.gm4.slightly_overheated_obsidian"}],"italic":false}']}}},Motion:[0.0f,0.9f,0.0f]}
