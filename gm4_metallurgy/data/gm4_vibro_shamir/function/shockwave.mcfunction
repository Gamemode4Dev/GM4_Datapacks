...
execute if predicate {type: "minecraft:random_chance", chance: {type: "minecraft:score", target: {type: "minecraft:fixed", name: "$probability"}, score: "gm4_desire_lines", scale: 0.01}} run function gm4_vibro_shamir:desire_lines
