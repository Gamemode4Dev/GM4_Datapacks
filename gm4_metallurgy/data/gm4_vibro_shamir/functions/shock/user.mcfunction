...
execute as @e[team=!invalid_team,type=!armor_stand,tag=!gm4_vibro_user,distance=..6] at @s run function gm4_vibro_shamir:shock/calculate
...
particle dust_color_transition 0.239 0.251 0.247 1 1.000 0.996 0.961 ~ ~.2 ~ 2 0 2 0 200

playsound minecraft:entity.generic.explode block @a[distance=..8] ~ ~ ~ 0.3 1.5
