#@s = tool with a sensus shamir on it
...
execute as @e[type=item,dx=0,limit=1,nbt={Item:{Count:1b,id:"minecraft:obsidian"}}] run function sensus_shamir:transfer_shamir/dock_band
