...
# spread
execute as @e[distance=..1.6,team=!gm4_invalid,type=!armor_stand] unless score @s gm4_ender_bolt_own_id = $source gm4_ender_bolt_foreign_id unless score @s gm4_bolt_time matches -40.. run function gm4_ender_bolt_shamir:infection/infect
