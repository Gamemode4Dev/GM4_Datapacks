...
#4
execute if score @s gm4_stack_size matches ..16 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:bone"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:bone_meal",Count:1b,tag:{gm4_pulverizers:{multiplier:4,chance:{id:"bone"}}}}]}
...
#7
execute if score @s gm4_stack_size matches ..6 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:oak_log"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:10,chance:{id:"log"}}}}]}
execute if score @s gm4_stack_size matches ..64 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:granite"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:cobblestone",Count:1b,tag:{gm4_pulverizers:{multiplier:1,chance:{id:"granite"}}}}]}
execute if score @s gm4_stack_size matches ..64 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:diorite"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:cobblestone",Count:1b,tag:{gm4_pulverizers:{multiplier:1,chance:{id:"diorite"}}}}]}

#8
execute if score @s gm4_stack_size matches ..6 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:oak_wood"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:10,chance:{id:"log"}}}}]}
...
execute if score @s gm4_stack_size matches ..64 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:andesite"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:cobblestone",Count:1b,tag:{gm4_pulverizers:{multiplier:1,chance:{id:"andesite"}}}}]}
...
execute if score @s gm4_stack_size matches ..6 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:birch_log"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:10,chance:{id:"log"}}}}]}
execute if score @s gm4_stack_size matches ..21 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:blaze_rod"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:blaze_powder",Count:1b,tag:{gm4_pulverizers:{multiplier:3,chance:{id:"blaze_rod"}}}}]}
...
execute if score @s gm4_stack_size matches ..6 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:spruce_log"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:10,chance:{id:"log"}}}}]}
execute if score @s gm4_stack_size matches ..6 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:jungle_log"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:10,chance:{id:"log"}}}}]}
execute if score @s gm4_stack_size matches ..6 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:acacia_log"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:10,chance:{id:"log"}}}}]}
execute if score @s gm4_stack_size matches ..6 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:birch_wood"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:10,chance:{id:"log"}}}}]}
execute if score @s gm4_stack_size matches ..21 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:oak_planks"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:stick",Count:1b,tag:{gm4_pulverizers:{multiplier:3,chance:{id:"planks"}}}}]}
...
execute if score @s gm4_stack_size matches ..32 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:sugar_cane"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:sugar",Count:1b,tag:{gm4_pulverizers:{multiplier:2,chance:{id:"sugar_cane"}}}}]}