...
scoreboard players operation @s gm4_pv_chance = @s gm4_stack_size
scoreboard players set chance_stack gm4_stack_size 0
...
#apply chance
execute if score @s gm4_slot_count matches 1 if score @s gm4_stack_size matches 1.. if block ~ ~ ~ dropper{Items:[{tag:{gm4_pulverizers:{chance:{}}}}]} run function pulverizers:chance/apply_chance
