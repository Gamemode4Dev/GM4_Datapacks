...
execute if score updateHappened gm4_up_check matches 0 run tellraw @a[gamemode=creative] ["",{"text":"[GM4]: No updates found.","color":"aqua"}]
execute unless entity @p run execute if score updateHappened gm4_up_check matches 0 run say GM4: No updates found.
execute if score updateHappened gm4_up_check matches 1 run tellraw @a[gamemode=creative] ["",{"text":"[GM4]: Updates completed.","color":"aqua"}]
execute unless entity @p run execute if score updateHappened gm4_up_check matches 1 run say GM4: Updates completed.