...
#create solid ice
execute in overworld as @e[type=item,nbt={Item: {Count:1b, tag: {gm4_solid_ice: 1}}}] at @s unless entity @e[distance=..0.866025,type=area_effect_cloud,tag=gm4_solid_ice] if block ~ ~-.000000000001 ~ ice run function solid_ice:ice_block/create
execute in the_end as @e[type=item,nbt={Item: {Count:1b, tag: {gm4_solid_ice: 1}}}] at @s unless entity @e[distance=..0.866025,type=area_effect_cloud,tag=gm4_solid_ice] if block ~ ~-.000000000001 ~ ice run function solid_ice:ice_block/create
