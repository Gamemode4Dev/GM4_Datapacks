execute if score gm4 load.status matches 1 run scoreboard players set gm4_lightning_in_a_bottle load.status 1
...
execute unless score gm4_lightning_in_a_bottle load.status matches 1 run schedule clear gm4_lightning_in_a_bottle:tick
