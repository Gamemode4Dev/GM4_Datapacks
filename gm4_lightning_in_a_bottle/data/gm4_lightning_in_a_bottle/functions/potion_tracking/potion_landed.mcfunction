...
execute as @e[type=area_effect_cloud,distance=..0.05,limit=1,sort=nearest] if data entity @s potion_contents.custom_effects[{id:'minecraft:night_vision',amplifier:12b,duration:1}] run function gm4_lightning_in_a_bottle:potion_tracking/modify_cloud
