...
execute if block ~ ~-.01 ~ #minecraft:lightning_rods[facing=up] if block ~ ~-1.01 ~ brewing_stand positioned ~ ~-1.01 ~ run function gm4_lightning_in_a_bottle:brewing_stand/try_brew
execute if block ~ ~-.01 ~ #minecraft:lightning_rods[facing=down] if block ~ ~.99 ~ brewing_stand positioned ~ ~.99 ~ run function gm4_lightning_in_a_bottle:brewing_stand/try_brew
