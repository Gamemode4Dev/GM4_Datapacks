...
summon armor_stand ~ ~-1.44 ~ {NoGravity:1,Marker:1,Invulnerable:1,Invisible:1,Silent:1,DisabledSlots:4144959,Tags:["gm4_no_edit","gm4_auto_crafter_stand","gm4_machine_stand","smithed.entity","smithed.strict","gm4_new_machine"],HasVisualFire:1,CustomName:'"gm4_auto_crafter_stand"',ArmorItems:[{},{},{},{id:"minecraft:crafting_table",count:1,components:{"minecraft:custom_model_data":"block/auto_crafter"}}],Rotation:[90.0f,0.0f],Pose:{Head:[90.0f,0.0f,0.0f]}}
