...
# located at @s
# run from gm4_auto_crafting:auto_crafter/craft/finish_crafting
...
execute if data storage gm4_custom_crafters:temp/output Items[-1] run function gm4_auto_crafting:auto_crafter/craft/apply_multiplier
