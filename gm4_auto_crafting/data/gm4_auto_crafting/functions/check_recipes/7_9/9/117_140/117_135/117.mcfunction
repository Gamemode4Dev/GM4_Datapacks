...
execute if score $minecraft:ice gm4_craft_shapeless matches 9 store result score $crafted gm4_crafting run loot replace block ~ ~ ~ container.0 loot gm4_auto_crafting:crafting/packed_ice
