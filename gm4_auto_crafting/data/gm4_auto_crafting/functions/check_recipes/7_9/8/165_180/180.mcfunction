...
execute if score $minecraft:gold_ingot gm4_craft_shapeless matches 4 store result score $crafted gm4_crafting unless data storage gm4_custom_crafters:temp/crafter Items[{Slot:8b}] run loot replace block ~ ~ ~ container.0 loot gm4_auto_crafting:crafting/vanilla/netherite_ingot
