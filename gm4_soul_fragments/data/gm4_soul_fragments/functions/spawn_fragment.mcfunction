...
execute if entity @s[type=minecraft:player] run particle minecraft:soul ~ ~1.2 ~ .2 0 .2 .03 5 normal
execute if entity @s[type=minecraft:item] run particle minecraft:soul ~ ~.4 ~ .3 0 .2 .03 5 normal
execute if entity @s[type=#gm4_soul_fragments:soul_target] run playsound minecraft:block.chorus_flower.death player @a[distance=..16] ~ ~ ~ .9 2
...
execute if entity @s[type=item] run function gm4_soul_fragments:totem/wipe
