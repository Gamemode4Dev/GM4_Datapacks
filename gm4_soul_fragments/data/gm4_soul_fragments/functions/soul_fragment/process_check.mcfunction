...
execute if score @s gm4_sf_fire matches 0 run execute store result score @s gm4_sf_fire run clone ~-2 ~-1 ~-2 ~2 ~2 ~2 ~-2 ~-1 ~-2 filtered #gm4_soul_fragments:sf_campfire[lit=true] force
