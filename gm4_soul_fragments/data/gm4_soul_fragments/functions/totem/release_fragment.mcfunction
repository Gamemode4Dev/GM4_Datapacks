...
execute if score @s gm4_sf_id = @e[type=player,gamemode=!spectator,gamemode=!creative,scores={gm4_sf_fragments=1..},distance=..16,limit=1] gm4_sf_id run function gm4_soul_fragments:spawn_fragment
