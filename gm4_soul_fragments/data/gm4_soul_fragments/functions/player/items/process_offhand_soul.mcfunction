...
execute if score @s gm4_sf_o_timer matches 1..3 run playsound minecraft:block.note_block.cow_bell player @a[distance=..10] ~ ~ ~ .6 .4 .6
execute if score @s gm4_sf_o_timer matches 4 run function gm4_soul_fragments:player/items/spawn_fragment_offhand
