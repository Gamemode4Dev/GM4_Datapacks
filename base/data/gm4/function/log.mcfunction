...
execute if data storage gm4:log log.ecid if data storage gm4:log log.result{passed:-1} run tellraw @a[tag=gm4_show_log] [{"text":"-","color":"white"},{"nbt":"log.ecid","storage":"gm4:log","interpret":true, "color": "yellow"},{"text":" has timed out!","color":"white"}]
execute if data storage gm4:log log.ecid if data storage gm4:log log.result{passed:0} run tellraw @a[tag=gm4_show_log] [{"text":"-","color":"white"},{"nbt":"log.ecid","storage":"gm4:log","interpret":true, "color": "yellow"},{"text":" has failed! ","color":"white"},{"nbt":"log.result.probable_cause","storage":"gm4:log","interpret":true,"color":"white"}]
