...
scoreboard players remove $environment_check_timeout gm4_data 1
execute if score $environment_check_timeout gm4_data matches ..0 run return run function gm4:announce_environment_check_results
...
function gm4:announce_environment_check_results
