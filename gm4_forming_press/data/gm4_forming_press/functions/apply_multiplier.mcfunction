...
data remove storage gm4_forming_press:temp/output Items[-1]
execute if data storage gm4_forming_press:temp/output Items[-1] run function gm4_forming_press:apply_multiplier
