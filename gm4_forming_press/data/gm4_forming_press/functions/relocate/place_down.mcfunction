...
data merge block ~ ~ ~ {CustomName:'{"translate":"%1$s%3427655$s","with":["Forming Press,{"translate":"block.gm4.forming_press"}]}'}
summon armor_stand ~ ~-.4 ~ {NoGravity:1,Marker:1,Invulnerable:1,Invisible:1,DisabledSlots:2039552,Tags:["gm4_no_edit","gm4_forming_press"],HasVisualFire:1,CustomName:'"gm4_forming_press"',ArmorItems:[{},{},{},{id:"minecraft:piston",Count:1b,tag:{CustomModelData:3420001}}],Pose:{Head:[180f,0f,0f]}}
