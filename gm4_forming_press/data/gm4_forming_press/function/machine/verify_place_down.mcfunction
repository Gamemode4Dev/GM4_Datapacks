...
execute if score $placed_block gm4_machine_data matches 0 if data storage gm4_machines:temp {id:"forming_press"} run function gm4_forming_press:machine/create
