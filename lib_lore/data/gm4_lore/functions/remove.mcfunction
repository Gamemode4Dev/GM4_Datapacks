# remove a specified line of Lore from a source line
...
execute if score $start gm4_lore matches ..-1 run function gm4_lore-1.0:utilities/remove/start_before
execute if score $start gm4_lore matches 1.. run function gm4_lore-1.0:utilities/remove/start_after
...
# clean up
scoreboard players reset * gm4_lore
data remove storage gm4_lore:temp TempSource
