...
item modify entity @s weapon.mainhand _example_gm4_lore:update_player
...
# set inputs
data modify storage gm4_lore:temp Source set from entity @e[type=item,limit=1,sort=nearest] Item.tag.display.Lore
data modify storage gm4_lore:temp Target set value '{"text":"This line will be replaced"}'
...
function #gm4_lore:replace
# update item
data modify entity @e[type=item,limit=1,sort=nearest] Item.tag.display.Lore set from storage gm4_lore:temp Source
...
# set inputs
summon item ~ ~ ~ {Tags:["item_1"],Item:{tag:{display:{Lore:['{"text":"TARGET_LINE"}','{"text":"The first two lines will be skipped/ignored"}','{"text":"The line after this one will be replaced"}','{"text":"TARGET_LINE"}','{"text":"This line will remain at the end"}']}}}}
data modify storage gm4_lore:temp Source set from entity @e[type=item,tag=item_1,limit=1] Item.tag.display.Lore
...
data modify entity @e[type=item,tag=item_1,limit=1] Item.tag.display.Lore set from storage gm4_lore:temp Source
# appends replaced lore line to the closest item
data modify entity @e[type=item,tag=!item_1,sort=nearest,limit=1] Item.tag.display.Lore append from storage gm4_lore:temp Dump
