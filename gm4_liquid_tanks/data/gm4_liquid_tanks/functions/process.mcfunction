...
#entity processing
execute if block ~ ~ ~ hopper[enabled=true] positioned ~-0.5 ~0.5 ~-0.5 if entity @e[type=!armor_stand,dx=0] run function #gm4_liquid_tanks:util_above
execute if block ~ ~ ~ hopper[enabled=true] positioned ~-0.5 ~-1.5 ~-0.5 if entity @e[type=!armor_stand,dx=0] run function #gm4_liquid_tanks:util_below
