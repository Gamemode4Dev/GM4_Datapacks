...
execute if score $placed_block gm4_machine_data matches 0 if data storage gm4_machines:temp {id:"gm4_liquid_tank"} run function gm4_liquid_tanks:machine/create
