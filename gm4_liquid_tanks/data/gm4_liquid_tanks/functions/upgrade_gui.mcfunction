...
execute unless block ~ ~ ~ hopper{CustomName:'{"translate":"%1$s%3427655$s","with":["Empty Tank",{"translate":"block.gm4.liquid_tank.empty"}]}'} run tag @s remove gm4_upgraded_liquid_tank
