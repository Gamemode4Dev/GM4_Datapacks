...
execute unless block ~ ~ ~ hopper{Items:[]} run summon armor_stand ~ ~ ~ {CustomName:'"gm4_liquid_tank"',Tags:["gm4_no_edit","gm4_liquid_tank","gm4_machine"],NoGravity:1,Marker:1,Silent:1,Invisible:1,Invulnerable:1,Small:1,DisabledSlots:2039552,ArmorItems:[{},{},{},{id:"glass",Count:1,tag:{CustomModelData:3420001}}]}
