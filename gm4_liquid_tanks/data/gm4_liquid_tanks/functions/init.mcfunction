...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4064.873907663935 ~ {CustomName:'"gm4_standard_liquids_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"liquid_tanks",id:"standard_liquids",page_count:1,line_count:1,module_name:"Standard Liquids"}}
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 2544.348486877165 ~ {CustomName:'"gm4_liquid_tanks_guide"',Tags:["gm4_guide"],data:{type:"base",expansions:[],id:"liquid_tanks",page_count:1,line_count:1,module_name:"Liquid Tanks"}}
