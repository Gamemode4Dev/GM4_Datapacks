...
#add milk to tank
execute if score @s gm4_lt_util matches 1 as @e[type=armor_stand,tag=gm4_liquid_tank,tag=gm4_processing_tank,tag=gm4_lt_milk] if score @s gm4_lt_value matches ..87 run scoreboard players add @s gm4_lt_buffer 3
