...
title @s actionbar ["",{"score":{"name":"gm4_lt_report_calc","objective":"gm4_lt_value"},"color":"dark_green"},{"text":" / 100  ","color":"dark_green"},{"translate":"%1$s","with":["Buckets",{"translate":"text.gm4.liquid_tanks.level_report.buckets"}],"color":"dark_green"}]
