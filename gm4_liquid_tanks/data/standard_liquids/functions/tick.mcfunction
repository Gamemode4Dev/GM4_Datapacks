...
#experience withdraw
execute if score standard_liquids_withdraw_experience gm4_lt_util matches 1.. as @e[type=armor_stand,tag=gm4_liquid_tank] at @s if block ~ ~ ~ hopper{CustomName:"{\"text\":\"Experience Tank\"}"} positioned ~ ~-2 ~ if entity @a[distance=..0.5,gamemode=!spectator] if score @s gm4_lt_value matches 1.. run function standard_liquids:util/withdraw_experience
