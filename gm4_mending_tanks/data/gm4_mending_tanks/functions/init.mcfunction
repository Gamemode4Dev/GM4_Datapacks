...
# guidebook
summon marker ~ 2718.712251362882 ~ {CustomName:'"gm4_mending_tanks_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"liquid_tanks",id:"mending_tanks",page_count:1,line_count:1,module_name:"Mending Tanks"}}
