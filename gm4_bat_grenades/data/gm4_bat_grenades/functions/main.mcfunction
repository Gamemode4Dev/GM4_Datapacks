...
execute as @e[type=bat,tag=!gm4_defused_bat] at @s if entity @a[gamemode=!creative,gamemode=!spectator,distance=..4] unless entity @s[nbt={NoAI:1b}] run function gm4_bat_grenades:explode
