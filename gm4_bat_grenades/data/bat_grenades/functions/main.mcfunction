...
execute at @e[type=bat] if entity @a[gamemode=!creative,gamemode=!spectator,distance=..3] run summon creeper ~ ~ ~ {CustomName:"\"Bat\"",ExplosionRadius:1b,ignited:1b,Fuse:0s,Tags:["gm4_bat_grenade"]}
