...
execute if score gm4_bat_grenades load matches 1 run function bat_grenades:init
execute unless score gm4_bat_grenades load matches 1 run schedule clear bat_grenades:main
