...
execute if score gm4_potion_swords load matches 1 run function gm4_potion_swords:init
execute unless score gm4_potion_swords load matches 1 run schedule clear gm4_potion_swords:tick
