...
execute at @s[nbt={Inventory:[{id:"minecraft:potion",tag:{Potion:"minecraft:strong_poison"}}]}] anchored eyes positioned ^ ^ ^2 run function potion_swords:wither_potion
...
execute at @s[nbt={Inventory:[{id:"minecraft:potion",tag:{Potion:"minecraft:long_slowness"}}]}] anchored eyes positioned ^ ^ ^2 run effect give @e[distance=..2.5,tag=!gm4_gold_user] slowness 4 10
