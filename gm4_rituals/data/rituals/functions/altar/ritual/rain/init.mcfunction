#initial functions
#@s - @e[type=minecraft:area_effect_cloud,tag=gm4_altar] if entity @s[tag=gm4_altar.ritual.rain.init]
...
#start timer
scoreboard players add @s gm4_rit_r_rain 1
...
#tags
tag @s add gm4_altar.ritual.rain
tag @s remove gm4_altar.ritual.rain.init
