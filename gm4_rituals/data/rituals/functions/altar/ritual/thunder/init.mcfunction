...
#start timer
scoreboard players add @s gm4_rit_r_thun 1

#destroy block
setblock ~ ~ ~ minecraft:air destroy

#remove stock
scoreboard players remove $item_trident gm4_rit_stock 4
scoreboard players remove $drowned gm4_rit_stock 2

#tags
tag @s add gm4_altar.ritual.thunder
tag @s remove gm4_altar.ritual.thunder.init
