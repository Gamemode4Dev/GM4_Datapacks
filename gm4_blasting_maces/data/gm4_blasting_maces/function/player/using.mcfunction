...
execute if items entity @s weapon.mainhand minecraft:mace[minecraft:enchantments~[{enchantments:"gm4_blasting_maces:blasting"}],minecraft:consumable] run scoreboard players set @s gm4_blast_slot 0
execute unless items entity @s weapon.mainhand minecraft:mace[minecraft:enchantments~[{enchantments:"gm4_blasting_maces:blasting"}],minecraft:consumable] run scoreboard players set @s gm4_blast_slot -1
