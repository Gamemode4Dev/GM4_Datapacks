...
# at @s
# run from gm4_blasting_maces:player/durability/apply
...
# calculate damage using binomial distribution
...
# break at max durability, otherwise apply the damage
execute if score $current_damage gm4_blast_data >= $max_damage gm4_blast_data run return run function gm4_blasting_maces:player/durability/break_mace with storage gm4_blasting_maces:temp
...
function gm4_blasting_maces:player/durability/set_damage with storage gm4_blasting_maces:temp
data remove storage gm4_blasting_maces:temp damage
