...
execute if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches ..-45 run function gm4_blasting_maces:mining/horizontal_plane_3x3
execute if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches 45.. run function gm4_blasting_maces:mining/horizontal_plane_3x3
# horizontal - mine 3x3 vertical plane based on facing direction
execute if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches -44..44 run function gm4_blasting_maces:mining/vertical_wall_3x3
...
# level 1 (3x3x1)
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches ..-45 run particle explosion ~ ~0.5 ~ 1.5 0.25 1.5 0.1 6
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches ..-45 run particle campfire_cosy_smoke ~ ~0.5 ~ 1.0 0.1 1.0 0.01 4
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches 45.. run particle explosion ~ ~0.5 ~ 1.5 0.25 1.5 0.1 6
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches 45.. run particle campfire_cosy_smoke ~ ~0.5 ~ 1.0 0.1 1.0 0.01 4
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches -44..44 run particle explosion ~ ~1 ~ 1.5 1.5 0.25 0.1 6
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 if score @s gm4_blast_pitch matches -44..44 run particle campfire_cosy_smoke ~ ~1 ~ 1.0 1.0 0.1 0.01 4
...
# layered sounds
# level 1 (3x3x1)
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 run playsound minecraft:entity.generic.explode block @a ~ ~ ~ 0.5 1.2
execute if score $blast_count gm4_blast_data matches 1.. if predicate gm4_blasting_maces:blasting_level_1 unless predicate gm4_blasting_maces:blasting_level_2 run playsound minecraft:block.stone.break block @a ~ ~ ~ 0.8 0.8
