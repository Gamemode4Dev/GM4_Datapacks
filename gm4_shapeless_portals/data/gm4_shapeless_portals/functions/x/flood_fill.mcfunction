...
execute if score $portal_blocks gm4_sp_data <= $max_portal_size gm4_sp_data unless entity @e[type=marker,tag=gm4_sp_portal_new] run function gm4_shapeless_portals:x/build
