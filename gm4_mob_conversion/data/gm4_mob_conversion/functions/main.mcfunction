...
execute at @e[type=item,nbt={Item:{id:"minecraft:sponge"}},limit=1,sort=random] as @e[type=guardian,distance=..1.5,limit=1,nbt={ActiveEffects:[{Id:11b},{Id:2b}]}] at @s run function gm4_mob_conversion:convert_guardian
