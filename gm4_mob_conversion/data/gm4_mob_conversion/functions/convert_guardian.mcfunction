#@s = guardian with slowness and resistance needing conversion
#run from main
...
execute as @e[type=item,limit=1,nbt={Item:{id:"minecraft:sponge"}},distance=..3,sort=nearest] run function gm4_mob_conversion:consume_item
