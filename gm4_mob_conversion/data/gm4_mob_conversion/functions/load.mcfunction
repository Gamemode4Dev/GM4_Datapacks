...
execute if score gm4_mob_conversion load matches 1 run function gm4_mob_conversion:init
execute unless score gm4_mob_conversion load matches 1 run schedule clear gm4_mob_conversion:main
