...
execute align xyz run summon marker ~1.5 ~0.5 ~0.5 {Tags:["gm4_smeltery","gm4_machine_marker","smithed.block","gm4_new_machine"],CustomName:'"gm4_smeltery"'}
...
data merge entity @s {Silent:1,Small:0,Tags:["gm4_no_edit","gm4_smeltery_cauldron","gm4_machine_display","smithed.block","gm4_new_machine"],HasVisualFire:1,CustomName:'"gm4_smeltery_cauldron"',ArmorItems:[{},{},{},{}],Rotation:[-90.0f,0.0f]}
