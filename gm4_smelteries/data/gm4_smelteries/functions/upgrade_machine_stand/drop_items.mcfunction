...
summon item ~ ~ ~ {Tags:["gm4_smeltery_item"],Item:{id:"minecraft:stick",Count:1b}}
data modify entity @e[type=item,tag=gm4_smeltery_item,distance=0,limit=1] Item set from storage gm4_smelteries:temp Items[-1]
tag @e[type=item,distance=0] remove gm4_smeltery_item
