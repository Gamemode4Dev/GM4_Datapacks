...
data merge entity @s {Silent:1,Small:0,Tags:["gm4_no_edit","gm4_smeltery_cauldron","gm4_machine_display","smithed.block","smithed.entity","smithed.strict","gm4_new_machine"],HasVisualFire:1,CustomName:'"gm4_smeltery_cauldron"',ArmorItems:[{},{},{},{}],HandItems:[{},{}],Rotation:[90.0f,0.0f]}
