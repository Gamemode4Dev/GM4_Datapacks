...
execute if score $placed_block gm4_machine_data matches 0 store success score $placed_block gm4_machine_data if data storage gm4_machines:temp {id:"gm4_smeltery"} run function gm4_smelteries:machine/create
