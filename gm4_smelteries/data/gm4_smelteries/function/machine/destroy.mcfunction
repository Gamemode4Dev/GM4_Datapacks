...
# kill entities related to machine block (armor stand kills needed for legacy compat)
...
execute as @e[type=item_display,tag=gm4_smeltery_cauldron,distance=..0.01] if score @s gm4_smelt_id = $current gm4_smelt_id run kill @s
