...
execute if score gm4_machines load.status matches 1 unless score gm4_machines_minor load.status matches 0.. run scoreboard players set gm4_machines_minor load.status 0
