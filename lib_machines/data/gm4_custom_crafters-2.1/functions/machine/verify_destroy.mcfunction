...
execute if score gm4_custom_crafters load.status matches 2 if score gm4_custom_crafters_minor load.status matches 1 if entity @s[tag=gm4_custom_crafter] run function gm4_custom_crafters-2.0:machine/destroy
