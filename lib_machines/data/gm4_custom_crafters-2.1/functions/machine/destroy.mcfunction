...
# located at @s
# run from gm4_custom_crafters-2.1:machine/verify_destroy
...
execute if score $dropped_item gm4_machine_data matches 1 run loot spawn ~ ~ ~ loot gm4_custom_crafters-2.1:items/custom_crafter
