...
# located at @s
# run from gm4_custom_crafters-3.0:process_output/finish_crafting
...
execute if data storage gm4_custom_crafters:temp/output Items[-1] run function gm4_custom_crafters-3.0:process_output/apply_multiplier
