...
def write_function_file(tags):
    ...
    with open(filename, "w") as file:
        ...
        file.write(contents + "\n")
        for tag in tags:
            contents = f"execute if predicate gm4_custom_crafters-3.0:vanilla_item_tags/{tag} run data modify storage gm4_custom_crafters:temp/crafter item.item_tags.minecraft.{tag} set value 1b"
            file.write(contents + "\n")
