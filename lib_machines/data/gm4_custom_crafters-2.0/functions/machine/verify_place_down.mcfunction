...
execute if score $placed_block gm4_machine_data matches 0 store success score $placed_block gm4_machine_data if score gm4_custom_crafters load.status matches 2 if score gm4_custom_crafters_minor load.status matches 0 if data storage gm4_machines:temp {id:"gm4_custom_crafter"} run function gm4_custom_crafters-2.0:machine/create
