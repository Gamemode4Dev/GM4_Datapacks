...
execute if score $ray gm4_count matches 0..50 unless score $found gm4_count matches 1 positioned ^ ^ ^0.1 run function gm4_custom_crafters-2.0:machine/craft_in_place/ray
