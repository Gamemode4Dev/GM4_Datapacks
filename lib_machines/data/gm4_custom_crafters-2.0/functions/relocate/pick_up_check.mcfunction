...
execute align xyz if entity @e[type=armor_stand,tag=gm4_custom_crafter,tag=!gm4_master_crafting,tag=gm4_rl_selected,dx=0,dy=0,dz=0,limit=1] positioned ~.5 ~.5 ~.5 run loot spawn ~ ~ ~ loot gm4_custom_crafters-2.0:items/relocator
