...
scoreboard players set tool_max_damage gm4_ml_data 1561
...
execute if score tool_max_damage gm4_ml_data matches 21..50 at @s run playsound minecraft:block.note_block.bit master @s ~ ~ ~ 1 0.8
