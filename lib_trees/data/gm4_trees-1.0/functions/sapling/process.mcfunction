...
execute unless block ~ ~ ~ #minecraft:saplings run function gm4_trees-1.0:sapling/destroy
...
execute if block ~ ~ ~ #minecraft:saplings[stage=1] run function gm4_trees-1.0:sapling/advance_stage
