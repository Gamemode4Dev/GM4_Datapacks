...
execute positioned ~-7.5 ~-1.5 ~-7.5 as @e[type=tropical_fish,tag=!gm4_hy_tracked_fish,limit=6,sort=random,dx=14,dy=7,dz=14] run function gm4_hydromancy:fish/tag
