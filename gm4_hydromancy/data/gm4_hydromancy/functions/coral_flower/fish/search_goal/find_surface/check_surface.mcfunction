...
execute if score @s gm4_hy_goal matches 0 if block ~ ~ ~ lily_pad run function gm4_hydromancy:coral_flower/fish/search_goal/lily_pad
# if lily pad was not the goal and surface is free check other goals
execute if score @s gm4_hy_goal matches 1.. if block ~ ~ ~ #gm4:air run function gm4_hydromancy:coral_flower/fish/search_goal/goal_type
