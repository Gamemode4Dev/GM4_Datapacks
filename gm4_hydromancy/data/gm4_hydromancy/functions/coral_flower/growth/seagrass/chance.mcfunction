...
execute if block ~ ~ ~ seagrass if block ~ ~1 ~ water if predicate gm4_hydromancy:chance/seagrass_growth run function gm4_hydromancy:coral_flower/growth/seagrass/grow
