...
execute if score $kelp_growth gm4_hy_data matches 1 run function gm4_hydromancy:coral_flower/growth/kelp/vfx
execute if score $kelp_growth gm4_hy_data matches 0 run function gm4_hydromancy:coral_flower/growth/kelp/raycast
