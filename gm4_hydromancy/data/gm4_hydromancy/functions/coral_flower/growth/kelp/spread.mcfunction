...
execute positioned ~1 ~1 ~ run function gm4_hydromancy:coral_flower/growth/kelp/check_spread
execute positioned ~-1 ~1 ~ run function gm4_hydromancy:coral_flower/growth/kelp/check_spread
execute positioned ~ ~1 ~1 run function gm4_hydromancy:coral_flower/growth/kelp/check_spread
execute positioned ~ ~1 ~-1 run function gm4_hydromancy:coral_flower/growth/kelp/check_spread
...
execute as @e[type=marker,tag=gm4_hy_possible_kelp] at @s if block ~ ~ ~ kelp run function gm4_hydromancy:coral_flower/growth/vfx
