...
execute as @e[type=tropical_fish,tag=gm4_hy_charged_fish] at @s if entity @e[type=marker,tag=gm4_hy_coral_vine.alive,tag=gm4_hy_coral_vine.budded,distance=..1.5] run function gm4_hydromancy:fish/discharge
