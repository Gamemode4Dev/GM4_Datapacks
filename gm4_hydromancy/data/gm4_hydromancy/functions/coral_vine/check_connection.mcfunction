...
tag @e[type=marker,tag=gm4_hy_coral_vine.rooted] remove gm4_hy_coral_vine.connected
execute at @s[tag=gm4_hy_coral_vine.connected] positioned ~ ~-1 ~ run function gm4_hydromancy:coral_vine/check_root
...
execute as @e[type=marker,tag=gm4_hy_coral_vine.alive,tag=!gm4_hy_coral_vine.connected] at @s run function gm4_hydromancy:coral_vine/die
