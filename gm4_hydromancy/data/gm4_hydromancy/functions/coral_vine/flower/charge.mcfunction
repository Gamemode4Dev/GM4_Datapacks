...
execute if score @s gm4_hy_charge matches ..4 as @e[type=block_display,tag=gm4_hy_coral_flower,tag=!gm4_hy_coral_flower.charged,dx=0,dy=0,dz=0,limit=1,sort=random] run function gm4_hydromancy:coral_vine/flower/check_side
