...
data merge entity @s {transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,1f,1f],translation:[1f,0.25f,-0.25f],scale:[0.25f,0.25f,0.25f]},block_state:{Name:"minecraft:spore_blossom"}}
