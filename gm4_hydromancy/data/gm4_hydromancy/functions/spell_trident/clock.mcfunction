...
execute if score $trident_clock gm4_hy_data matches 16.. as @e[type=trident,tag=gm4_hy_spell_trident.process_slow] at @s run function gm4_hydromancy:spell_trident/process_slow
