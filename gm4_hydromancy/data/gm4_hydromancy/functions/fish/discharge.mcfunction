...
execute as @e[type=marker,tag=gm4_hy_coral_vine.alive,tag=gm4_hy_coral_vine.flowering,limit=1,sort=nearest] at @s align xyz run function gm4_hydromancy:coral_vine/flower/charge
