...
summon armor_stand ~ ~ ~ {Tags:["gm4_disassembler","gm4_no_edit"],Small:1b,CustomName:'"gm4_disassembler"',NoGravity:1b,Invisible:1b,Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:tnt",Count:1b,tag:{CustomModelData:3420001}}]}
