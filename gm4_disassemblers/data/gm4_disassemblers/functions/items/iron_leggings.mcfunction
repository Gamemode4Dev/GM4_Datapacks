...
execute if score result_items gm4_disassembler matches 2.. run item replace block ~ ~ ~ container.1 with minecraft:iron_ingot
execute if score result_items gm4_disassembler matches 3.. run item replace block ~ ~ ~ container.2 with minecraft:iron_ingot
execute if score result_items gm4_disassembler matches 4.. run item replace block ~ ~ ~ container.3 with minecraft:iron_ingot
...
execute if score result_items gm4_disassembler matches 7.. run item replace block ~ ~ ~ container.8 with minecraft:iron_ingot
