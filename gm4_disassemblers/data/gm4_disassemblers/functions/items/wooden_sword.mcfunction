...
execute if score result_items gm4_disassembler matches 1.. run item replace block ~ ~ ~ container.1 with minecraft:oak_planks
execute if score result_items gm4_disassembler matches 2.. run item replace block ~ ~ ~ container.4 with minecraft:oak_planks
