scoreboard players set max_damage gm4_disassembler 429
...
execute if score result_items gm4_disassembler matches 4.. run item replace block ~ ~ ~ container.5 with minecraft:diamond
