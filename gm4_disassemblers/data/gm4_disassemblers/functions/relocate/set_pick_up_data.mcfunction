...
data modify storage gm4_relocators:temp merge_data set value {custom_block:"gm4_disassembler",lore:'{"translate":"%1$s%3427655$s","with":["Disassembler",{"translate":"block.gm4.disassembler"}],"color":"gray","italic":true}'}
