...
data merge block ~ ~ ~ {Items:[{}],CustomName:'{"translate":"%1$s%3427655$s","with":["Disassembler",{"translate":"block.gm4.disassembler"}]}'}
kill @s
playsound block.anvil.place master @a ~ ~ ~ 0.9 0.1
