...
item replace block ~1 ~1 ~1 container.1 with minecraft:tnt
item replace block ~1 ~1 ~1 container.2 with minecraft:iron_ingot
item replace block ~1 ~1 ~1 container.3 with minecraft:obsidian
item replace block ~1 ~1 ~1 container.4 with minecraft:stonecutter
item replace block ~1 ~1 ~1 container.5 with minecraft:obsidian
...
await items block ~1 ~1 ~1 container.* minecraft:player_head[custom_data~{gm4_machines:{id:"disassembler"}}]
