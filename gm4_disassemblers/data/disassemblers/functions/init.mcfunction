...
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Installing Disassemblers...",{"translate":"text.gm4.modules.update.installing","with":["Disassemblers"]}]}]
...
#announce success
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Disassemblers Installed!",{"translate":"text.gm4.modules.update.installed","with":["Disassemblers"]}]}]
