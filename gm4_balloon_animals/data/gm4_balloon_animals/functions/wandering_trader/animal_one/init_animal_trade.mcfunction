...
# at @s
# run from gm4_balloon_animal:wandering_trader/animal_one/choose_common or /choose_rare
...
loot replace entity @e[type=trader_llama,limit=1,tag=gm4_new_trade_option] horse.0 loot gm4_balloon_animals:trade_1/lead
