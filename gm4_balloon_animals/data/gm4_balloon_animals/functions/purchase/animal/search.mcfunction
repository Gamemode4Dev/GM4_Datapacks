...
execute store result score $trade_success gm4_balloon_animals_data as @e[type=#gm4_balloon_animals:balloon_animal,tag=gm4_balloon_animal,tag=!gm4_balloon_animal_purchased] if score @s gm4_balloon_animals_id = $id gm4_balloon_animals_data run function gm4_balloon_animals:purchase/animal/update

# if animal not found, refund player (in purchased_animal)
execute if score $trade_success gm4_balloon_animals_data matches 0 run playsound entity.villager.no neutral @a[distance=..8] ~ ~ ~
