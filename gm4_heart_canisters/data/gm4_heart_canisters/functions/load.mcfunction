execute if score gm4 load matches 1 if score gm4_custom_crafters load matches 1 run scoreboard players set gm4_heart_canisters load 1
...
execute if score gm4_heart_canisters load matches 1 run function heart_canisters:init
