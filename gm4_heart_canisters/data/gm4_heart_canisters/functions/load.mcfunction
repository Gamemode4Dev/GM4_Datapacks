execute if score gm4 load matches 1 if score gm4_custom_crafters load matches 2 run scoreboard players set gm4_heart_canisters load 1
...
execute unless score gm4_custom_crafters load matches 2 run data modify storage gm4:log queue append value {type:"missing",module:"Heart Canisters",require:"Custom Crafters"}
