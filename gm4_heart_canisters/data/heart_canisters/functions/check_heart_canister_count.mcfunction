...
scoreboard players add @s[nbt={Inventory:[{Count:1b,tag:{gm4_heart_canister_tier:2b}}]}] gm4_heart_can 1
scoreboard players add @s[nbt={Inventory:[{Count:2b,tag:{gm4_heart_canister_tier:2b}}]}] gm4_heart_can 2
scoreboard players add @s[nbt={Inventory:[{Count:3b,tag:{gm4_heart_canister_tier:2b}}]}] gm4_heart_can 3
scoreboard players add @s[nbt={Inventory:[{Count:4b,tag:{gm4_heart_canister_tier:2b}}]}] gm4_heart_can 4
scoreboard players add @s[nbt={Inventory:[{Count:5b,tag:{gm4_heart_canister_tier:2b}}]}] gm4_heart_can 5
