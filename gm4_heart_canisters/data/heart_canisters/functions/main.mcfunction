...
scoreboard players set @a[scores={gm4_heart_can=1..}] gm4_heart_can 0
...
execute as @a[gamemode=!spectator,gamemode=!creative] run function heart_canisters:apply_health_boost
