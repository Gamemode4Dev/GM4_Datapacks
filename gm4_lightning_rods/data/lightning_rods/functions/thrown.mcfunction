...
data merge entity @s[tag=gm4_lightning_rod_count_2] {CustomName:"{\"text\":\"<2>\",\"color\":\"gold\"}",CustomNameVisible:true,Tags:[gm4_lightning_rod_count_1,gm4_lightning_rod_counting]}
