...
execute if score gm4_lightning_rods load matches 1 run function lightning_rods:init
execute unless score gm4_lightning_rods load matches 1 run schedule clear lightning_rods:main
