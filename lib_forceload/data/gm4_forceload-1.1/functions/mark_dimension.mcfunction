...
function gm4_forceload-1.1:init_chunk
...
execute as @e[type=marker,tag=gm4_new_dimension,limit=1] in minecraft:overworld run function gm4_forceload-1.1:set_marker_data
