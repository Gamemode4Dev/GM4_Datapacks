...
execute if score $initialized gm4_dimension matches 0 as @e[type=marker,tag=gm4_new_dimension,limit=1] run function gm4_forceload-1.1:init_ow_chunk
function gm4_forceload-1.1:load_wait
