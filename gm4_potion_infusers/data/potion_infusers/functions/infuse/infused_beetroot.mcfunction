...
execute unless block ~ ~ ~ beetroots[age=3] run function potion_infusers:effects/failed
execute if block ~ ~ ~ beetroots[age=3] run function potion_infusers:effects/success
