...
execute unless block ~ ~ ~ dead_brain_coral run function potion_infusers:effects/failed
execute if block ~ ~ ~ dead_brain_coral run function potion_infusers:effects/success
