...
execute unless block ~ ~ ~ dead_bubble_coral run function potion_infusers:effects/failed
execute if block ~ ~ ~ dead_bubble_coral run function potion_infusers:effects/success
