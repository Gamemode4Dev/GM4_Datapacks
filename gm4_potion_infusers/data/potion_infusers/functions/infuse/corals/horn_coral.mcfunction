...
execute unless block ~ ~ ~ horn_coral_fan unless block ~ ~ ~ horn_coral_wall_fan run function potion_infusers:effects/failed
execute if block ~ ~ ~ horn_coral_fan run function potion_infusers:effects/success
execute if block ~ ~ ~ horn_coral_wall_fan run function potion_infusers:effects/success
