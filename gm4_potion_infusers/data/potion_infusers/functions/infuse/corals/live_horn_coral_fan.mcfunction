...
execute unless block ~ ~ ~ dead_horn_coral_fan run function potion_infusers:effects/failed
execute if block ~ ~ ~ dead_horn_coral_fan run function potion_infusers:effects/success
