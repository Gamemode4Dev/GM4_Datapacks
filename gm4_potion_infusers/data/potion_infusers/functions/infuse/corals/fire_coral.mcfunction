...
execute unless block ~ ~ ~ fire_coral_fan unless block ~ ~ ~ fire_coral_wall_fan run function potion_infusers:effects/failed
execute if block ~ ~ ~ fire_coral_fan run function potion_infusers:effects/success
execute if block ~ ~ ~ fire_coral_wall_fan run function potion_infusers:effects/success
