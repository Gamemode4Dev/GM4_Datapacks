...
execute unless block ~ ~ ~ dead_fire_coral run function potion_infusers:effects/failed
execute if block ~ ~ ~ dead_fire_coral run function potion_infusers:effects/success
