...
execute unless block ~ ~ ~ dead_tube_coral_fan run function potion_infusers:effects/failed
execute if block ~ ~ ~ dead_tube_coral_fan run function potion_infusers:effects/success
