...
execute unless block ~ ~ ~ carved_pumpkin run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ carved_pumpkin run function gm4_potion_infusers:effects/success
