...
execute unless block ~ ~ ~ sweet_berry_bush[age=3] run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ sweet_berry_bush[age=3] run function gm4_potion_infusers:effects/success
