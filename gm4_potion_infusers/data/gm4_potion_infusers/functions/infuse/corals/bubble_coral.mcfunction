...
execute unless block ~ ~ ~ bubble_coral_fan unless block ~ ~ ~ bubble_coral_wall_fan run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ bubble_coral_fan run function gm4_potion_infusers:effects/success
execute if block ~ ~ ~ bubble_coral_wall_fan run function gm4_potion_infusers:effects/success
