...
execute unless block ~ ~ ~ tube_coral_fan unless block ~ ~ ~ tube_coral_wall_fan run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ tube_coral_fan run function gm4_potion_infusers:effects/success
execute if block ~ ~ ~ tube_coral_wall_fan run function gm4_potion_infusers:effects/success
