...
execute unless block ~ ~ ~ dead_fire_coral_fan run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ dead_fire_coral_fan run function gm4_potion_infusers:effects/success
