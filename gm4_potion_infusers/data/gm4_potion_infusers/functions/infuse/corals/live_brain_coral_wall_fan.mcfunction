...
execute unless block ~ ~ ~ dead_brain_coral_wall_fan run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ dead_brain_coral_wall_fan run function gm4_potion_infusers:effects/success
