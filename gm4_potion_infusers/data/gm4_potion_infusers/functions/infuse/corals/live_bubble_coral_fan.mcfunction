...
execute unless block ~ ~ ~ dead_bubble_coral_fan run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ dead_bubble_coral_fan run function gm4_potion_infusers:effects/success
