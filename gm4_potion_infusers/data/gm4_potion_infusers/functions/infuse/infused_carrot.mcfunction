...
execute unless block ~ ~ ~ carrots[age=7] run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ carrots[age=7] run function gm4_potion_infusers:effects/success
