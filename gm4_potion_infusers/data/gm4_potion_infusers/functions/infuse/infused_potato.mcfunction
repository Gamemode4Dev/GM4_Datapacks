...
execute unless block ~ ~ ~ potatoes[age=7] run function gm4_potion_infusers:effects/failed
execute if block ~ ~ ~ potatoes[age=7] run function gm4_potion_infusers:effects/success
