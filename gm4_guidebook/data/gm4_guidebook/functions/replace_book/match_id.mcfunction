...
execute store result score $num_id gm4_guide run data get storage gm4_guidebook:temp modules[-1].num_id
execute if score $num_id gm4_guide = @s gm4_guide run data modify storage gm4_guidebook:temp LootTable set from storage gm4_guidebook:temp modules[-1].LootTable
