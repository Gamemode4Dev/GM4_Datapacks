...
execute if entity @s[advancements={gm4_corripio_shamir:kill_entity/silverfish=true,gm4_corripio_shamir:kill_entity/ignore_kill=false}] run loot spawn ~ ~.3 ~ fish gm4_corripio_shamir:entities/silverfish ~ ~ ~ mainhand
...
advancement revoke @s only gm4_corripio_shamir:hurt_entity/silverfish
