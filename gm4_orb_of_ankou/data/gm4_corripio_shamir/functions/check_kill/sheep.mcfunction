...
execute if entity @s[advancements={gm4_corripio_shamir:kill_entity/sheep=true,gm4_corripio_shamir:kill_entity/ignore_kill=false}] run loot spawn ~ ~.3 ~ fish gm4_corripio_shamir:entities/sheep ~ ~ ~ mainhand
...
advancement revoke @s only gm4_corripio_shamir:hurt_entity/sheep
