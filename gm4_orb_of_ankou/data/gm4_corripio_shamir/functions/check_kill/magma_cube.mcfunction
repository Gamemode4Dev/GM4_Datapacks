...
execute if entity @s[advancements={gm4_corripio_shamir:kill_entity/magma_cube=true,gm4_corripio_shamir:kill_entity/ignore_kill=false}] run loot spawn ~ ~.3 ~ fish gm4_corripio_shamir:entities/magma_cube ~ ~ ~ mainhand
...
advancement revoke @s only gm4_corripio_shamir:hurt_entity/magma_cube
