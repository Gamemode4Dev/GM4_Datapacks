...
data modify entity @e[type=armor_stand,tag=gm4_soul_forge,limit=1,sort=nearest,distance=..1] ArmorItems[2] set from entity @s Item
data modify entity @e[type=armor_stand,tag=gm4_soul_forge,limit=1,sort=nearest,distance=..1] ArmorItems[2].Count set value 1b
tag @e[type=armor_stand,tag=gm4_soul_forge,limit=1,sort=nearest,distance=..1] add gm4_oa_has_shard

# convert extra shards to congealed shards
execute store result score shard_count gm4_oa_forge run data get entity @s Item.Count
