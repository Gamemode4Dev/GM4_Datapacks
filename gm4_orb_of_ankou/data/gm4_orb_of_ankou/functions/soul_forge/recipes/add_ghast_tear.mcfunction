# @s = ghast tear item in a soul forge
...
execute store result score add gm4_oa_tears run data get entity @s Item.Count
scoreboard players operation @e[type=armor_stand,tag=gm4_soul_forge,limit=1,sort=nearest,distance=..1] gm4_oa_tears += add gm4_oa_tears
