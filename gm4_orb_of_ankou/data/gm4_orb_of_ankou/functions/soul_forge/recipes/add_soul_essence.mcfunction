...
execute store result score add gm4_oa_essence run data get entity @s Item.Count
scoreboard players operation @e[type=armor_stand,tag=gm4_soul_forge,limit=1,sort=nearest,distance=..1] gm4_oa_essence += add gm4_oa_essence
