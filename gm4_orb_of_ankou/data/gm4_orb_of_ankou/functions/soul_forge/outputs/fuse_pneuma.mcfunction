...
data modify storage gm4_orb_of_ankou:temp Item.tag.display.Lore[0] set value '{"translate":"%1$s%3427655$s","with":["Pneumas:",{"translate":"text.gm4.orb_of_ankou.pneumas"}],"italic":false,"color":"light_purple"}'
