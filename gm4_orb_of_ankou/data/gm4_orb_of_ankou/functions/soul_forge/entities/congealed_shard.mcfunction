...
# spawn bat
summon bat ~ ~0.2 ~ {CustomName:'{"translate":"%1$s%3427655$s","with":["Congealed Soul Shard§",{"translate":"entity.gm4.congealed_shard"}]}',CustomNameVisible:0,Team:"gm4_hide_name",Health:2.0f,DeathLootTable:"minecraft:empty",PersistenceRequired:1b,Tags:["gm4_oa_unset","gm4_oa_congealed_shard","gm4_oa_ignore","gm4_defused_bat"],HandDropChances:[2.0f,1.0f],Motion:[0.0,0.6,0.0],ActiveEffects:[{Id:12,Amplifier:0b,Duration:1000000,ShowParticles:0b}]}
