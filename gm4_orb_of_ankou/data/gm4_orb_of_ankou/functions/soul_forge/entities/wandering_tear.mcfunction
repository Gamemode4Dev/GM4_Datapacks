...
# spawn vex
summon minecraft:vex ~ ~0.2 ~ {Silent:1b,Glowing:1b,CustomNameVisible:0b,LifeTicks:1200,DeathLootTable:"minecraft:empty",Tags:["gm4_oa_ignore","gm4_oa_wandering_tear"],CustomName:'{"text":"Wandering Tear"}',ActiveEffects:[{Id:14b,Amplifier:0b,Duration:1000000,ShowParticles:0b}],Attributes:[{Name:"generic.follow_range",Base:48},{Name:"generic.attack_damage",Base:3}]}
