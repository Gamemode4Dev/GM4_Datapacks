...
summon minecraft:small_fireball ~ ~1 ~ {Tags:["gm4_oa_fireball"],power:[0.0,0.0,0.0],direction:[0.0,0.0,0.0],Motion:[0.0,0.0,0.0]}

# copy motion of arrow to fireball
data modify entity @e[tag=gm4_oa_fireball,distance=..2,limit=1] power set from entity @e[type=minecraft:arrow,limit=1,distance=..2] Motion
...
data modify entity @e[tag=gm4_oa_fireball,distance=..2,limit=1] Owner set from entity @s UUID
