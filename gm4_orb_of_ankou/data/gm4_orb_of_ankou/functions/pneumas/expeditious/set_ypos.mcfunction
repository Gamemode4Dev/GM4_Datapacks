...
execute at @s if block ~ ~ ~ #gm4_orb_of_ankou:traversable unless block ~ ~-1 ~ #gm4_orb_of_ankou:traversable run scoreboard players set expeditious_safe gm4_pneuma_data 1
