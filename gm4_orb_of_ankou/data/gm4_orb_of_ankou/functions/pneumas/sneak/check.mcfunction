...
execute at @s[tag=gm4_pneuma_scaling] anchored eyes positioned ^ ^ ^1 align xyz unless block ~ ~ ~ #gm4_orb_of_ankou:traversable run effect give @s levitation 1 0 true
