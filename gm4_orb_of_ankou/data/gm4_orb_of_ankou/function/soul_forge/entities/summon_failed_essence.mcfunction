...
# summon endermite
execute positioned ~ ~0.2 ~ summon endermite run function gm4_orb_of_ankou:soul_forge/entities/set_loot/severed_soul with storage gm4_orb_of_ankou:temp equipment.feet.components."minecraft:custom_data".gm4_orb_of_ankou.stored_pneuma
