...
execute if score gm4_custom_crafters load matches 1 run function gm4_custom_crafters:init
execute unless score gm4_custom_crafters load matches 1 run schedule clear gm4_custom_crafters:main
