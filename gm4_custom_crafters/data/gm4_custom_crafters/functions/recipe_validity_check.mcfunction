...
data modify storage gm4_custom_crafters:recipe Items set from block ~ ~ ~ Items

#store number of full slots
execute store result score @s gm4_slot_count run data get storage gm4_custom_crafters:recipe Items

#get number of items from first array element
execute store result score first_stack_count gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[0].Count

#check if each slot with an item in it has the same stack size
execute if score @s gm4_slot_count matches 2.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[1].Count
...
execute if score @s gm4_slot_count matches 3.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[2].Count
...
execute if score @s gm4_slot_count matches 4.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[3].Count
...
execute if score @s gm4_slot_count matches 5.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[4].Count
...
execute if score @s gm4_slot_count matches 6.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[5].Count
...
execute if score @s gm4_slot_count matches 7.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[6].Count
...
execute if score @s gm4_slot_count matches 8.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[7].Count
...
execute if score @s gm4_slot_count matches 9.. store result score @s gm4_stack_size run data get storage gm4_custom_crafters:recipe Items[8].Count
