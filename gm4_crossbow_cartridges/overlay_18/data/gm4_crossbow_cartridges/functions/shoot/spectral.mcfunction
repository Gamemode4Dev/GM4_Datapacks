...
execute if predicate gm4_crossbow_cartridges:items/bucket run data modify storage gm4_crossbow_cartridges:temp projectile.ActiveEffects set value [{id:'minecraft:glowing',amplifier:0b,duration:200}]
