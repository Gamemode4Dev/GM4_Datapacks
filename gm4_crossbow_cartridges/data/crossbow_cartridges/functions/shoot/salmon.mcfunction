...
execute unless entity @s[gamemode=creative] run replaceitem entity @s[nbt={Inventory:[{Slot:-106b,id:"minecraft:salmon_bucket"}]}] weapon.offhand minecraft:water_bucket
