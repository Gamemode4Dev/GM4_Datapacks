...
execute if score @s gm4_cb_strplace matches 0 run setblock ~ ~ ~ minecraft:tripwire[attached=true,east=true,west=true] replace
execute if score @s gm4_cb_strplace matches 1..39 run setblock ~ ~ ~ minecraft:tripwire[east=true,west=true] replace
execute if score @s gm4_cb_strplace matches 40 run setblock ~ ~ ~ minecraft:tripwire[attached=true,east=true,west=true] replace
...
#recursion
execute positioned ~1 ~ ~ if block ~ ~ ~ #gm4_crossbow_cartridges:string_replaceable if score @s gm4_cb_strcount matches 1.. if score @s gm4_cb_strplace matches ..39 run function gm4_crossbow_cartridges:cables/unspool_string_east
