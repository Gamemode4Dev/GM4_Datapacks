...
#recursion
execute positioned ~1 ~ ~ if block ~ ~ ~ #gm4_crossbow_cartridges:airtype if score @s gm4_string_count matches 1.. if score string_placed gm4_string_count matches ..39 run function gm4_crossbow_cartridges:cables/unspool_string_east