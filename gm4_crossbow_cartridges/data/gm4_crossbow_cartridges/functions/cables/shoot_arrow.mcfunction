...
execute store result score @s gm4_cb_strcount run data get entity @s Inventory[-1].Count
scoreboard players set @s[scores={gm4_cb_strcount=40..}] gm4_cb_strcount 40
