...
summon minecraft:potion ~ ~1.2 ~ {Tags:["gm4_cb_proj"],Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:water"}}}
...
item replace entity @s[gamemode=!creative,nbt={Inventory:[{Slot:-106b,id:"minecraft:splash_potion"}]}] weapon.offhand with minecraft:air
