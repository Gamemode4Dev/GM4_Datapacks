...
execute if predicate gm4_crossbow_cartridges:items/splash_potion run summon minecraft:potion ~ ~ ~ {Tags:["gm4_cb_projectile"],Item:{id:"minecraft:splash_potion",count:1,tag:{Potion:"minecraft:water"}}}
execute if predicate gm4_crossbow_cartridges:items/lingering_potion run summon minecraft:potion ~ ~ ~ {Tags:["gm4_cb_projectile"],Item:{id:"minecraft:lingering_potion",count:1,tag:{Potion:"minecraft:water"}}}
