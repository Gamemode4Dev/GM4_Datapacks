...
execute if block ~ ~ ~ poplar_sapling run summon marker ~ ~ ~ {CustomName:"gm4_poplar_tree_sapling",Tags:["gm4_tree_sapling","gm4_towering_trees_sapling","gm4_poplar_tree_sapling","smithed.entity","smithed.strict","smithed.block"]}
