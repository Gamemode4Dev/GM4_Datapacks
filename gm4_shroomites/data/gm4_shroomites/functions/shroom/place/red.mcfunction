...
execute if score $global_shroom_count gm4_shroom_data < #global_shroom_cap gm4_shroom_data align xyz positioned ~.5 ~.5 ~.5 unless entity @e[type=marker,tag=gm4_shroomite_shroom,distance=..0.1] run summon marker ~ ~ ~ {Tags:["gm4_shroomite_shroom","gm4_red_shroomite"],CustomName:'"gm4_shroomite_shroom"'}
