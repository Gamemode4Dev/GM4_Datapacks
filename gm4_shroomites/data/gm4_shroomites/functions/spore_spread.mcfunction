...
summon area_effect_cloud ~ ~ ~1 {Tags:["gm4_shroomite_spore_check"],Duration:1}
summon area_effect_cloud ~ ~ ~-1 {Tags:["gm4_shroomite_spore_check"],Duration:1}
execute as @e[type=area_effect_cloud,tag=gm4_shroomite_spore_check] at @s unless block ~ ~ ~ #gm4_shroomites:spore_porous unless block ~ ~1 ~ #gm4_shroomites:spore_porous run kill @s
...
execute at @s unless block ~ ~ ~ #gm4_shroomites:spore_porous run tp @s ~ ~1 ~
execute at @s if block ~ ~-1 ~ #gm4_shroomites:spore_porous run tp @s ~ ~-1 ~
