...
execute as @e[tag=gm4_shroomite_shroom,type=area_effect_cloud,scores={gm4_shroom_time=73..}] at @s run function gm4_shroomites:spore_spawn

#spore spreader. Moves spores one block every 16 seconds (shroom_time=20..)
execute as @e[tag=gm4_shroomite_spore,type=area_effect_cloud,scores={gm4_shroom_time=20..}] at @s run function gm4_shroomites:spore_spread
...
execute if score gm4_shroom_countdown gm4_shroom_time matches 4500.. run function gm4_shroomites:slow_shroom_timer
