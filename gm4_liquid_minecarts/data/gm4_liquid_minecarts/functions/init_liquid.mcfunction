...
execute anchored eyes facing entity @s feet positioned ^ ^ ^1 as @e[type=armor_stand,limit=1,sort=nearest,distance=..1,tag=gm4_liquid_minecart_stand] positioned ^ ^ ^-1 run function gm4_liquid_minecarts:copy_tank_data
