...
data merge entity @s {Tags:["gm4_no_edit","gm4_liquid_minecart_stand","gm4_machine_cart","smithed.entity","smithed.strict"],HasVisualFire:1,CustomName:'"gm4_liquid_minecart_stand"'}
