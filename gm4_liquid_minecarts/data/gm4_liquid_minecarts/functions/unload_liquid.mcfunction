...
execute if score @s gm4_lt_value matches 0 as @e[type=armor_stand,limit=1,sort=nearest,tag=gm4_liquid_minecart_display] run function gm4_liquid_minecarts:set_empty_data
