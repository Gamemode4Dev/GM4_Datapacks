...
#apply liquid tag
data modify entity @e[type=armor_stand,tag=gm4_liquid_tank,limit=1,sort=nearest,distance=..0.5] Tags append from entity @s Passengers[0].ArmorItems[0].tag.gm4_liquid_minecarts.liquid_tag
tag @e[type=armor_stand,tag=gm4_liquid_tank,limit=1,sort=nearest,distance=..0.5] remove gm4_lt_empty
