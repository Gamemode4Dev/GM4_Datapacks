#@s = gm4_liquid_minecart_display copying tank data to it's armor items, at location of tank
#run from init_liquid

data modify entity @s ArmorItems[0].tag.gm4_liquid_minecarts.liquid_tag set from entity @e[type=armor_stand,limit=1,tag=gm4_liquid_tank,sort=nearest] ArmorItems[3].tag.gm4_liquid_tanks.liquid_tag
