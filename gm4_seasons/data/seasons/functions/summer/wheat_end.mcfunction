...
execute if entity @a[scores={gm4_szn_mine_wheat=1..}] if score #gm4_randval gm4_szn_rng matches 0..3 at @a[scores={gm4_szn_mine_wheat=1..}] if entity @e[type=item,tag=!gm4_szn_checked,nbt={Item:{id:"minecraft:wheat",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!gm4_szn_checked,nbt={Item:{id:"minecraft:wheat",Count:1b}},limit=1,distance=..7] {Item:{Count:2b}}
execute if entity @a[scores={gm4_szn_mine_wheat=1..}] if score #gm4_randval gm4_szn_rng matches 4 at @a[scores={gm4_szn_mine_wheat=1..}] if entity @e[type=item,tag=!gm4_szn_checked,nbt={Item:{id:"minecraft:wheat",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!gm4_szn_checked,nbt={Item:{id:"minecraft:wheat",Count:1b}},limit=1,distance=..7] {Item:{Count:3b}}
