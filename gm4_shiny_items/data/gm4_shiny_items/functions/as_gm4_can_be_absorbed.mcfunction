...
execute if entity @s[scores={gm4_xporb_xp=1..}] run particle dust 1.000 0.031 0.000 1 ~ ~.2 ~ .05 .05 .05 .1 1 
execute if entity @e[scores={gm4_xporb_xp=1..}] at @e[tag=gm4_can_become_shiny,limit=1,sort=nearest] run particle minecraft:enchant ~ ~.4 ~ .2 .2 .2 .01 3
execute if entity @e[scores={gm4_xporb_xp=..0}] run particle dust 1.000 0.031 0.000 1 ~ ~.3 ~ .1 .1 .1 .1 5 
