...
summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option"],Items:[{id:"minecraft:grass_block",count:1,Slot:2b},{id:"minecraft:emerald",count:1,Slot:3b},{id:"minecraft:wheat_seeds",count:1,Slot:4b}],body_armor_item:{id:"minecraft:light_blue_carpet",count:1,tag:{gm4_trades:{options:{maxUses:8,rewardXp:1b,xp:1,priceMultiplier:0.05f}}}}}

# another hardcoded trade as in line 7, but this one only appears for traders in the end
execute if predicate example_pack:the_end run summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option"],Items:[{id:"minecraft:end_stone",count:1,Slot:2b},{id:"minecraft:emerald",count:1,Slot:3b},{}],body_armor_item:{id:"minecraft:light_blue_carpet",count:1,tag:{gm4_trades:{pool:"example_pack:foo_trades",options:{maxUses:8,rewardXp:1b,xp:1,priceMultiplier:0.05f}}}}}

# a trade in the trade pool "example_pack:foo_trades"
summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option"],Items:[{id:"minecraft:spawner",count:1,Slot:2b},{id:"minecraft:emerald",count:64,Slot:3b},{}],body_armor_item:{id:"minecraft:light_blue_carpet",count:1,tag:{gm4_trades:{pool:"example_pack:foo_trades",options:{maxUses:1,rewardXp:1b,xp:1,priceMultiplier:0.05f}}}}}

# a trade that uses a loot table for the sell and the buy option
summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option","gm4_new_trade_option"],Items:[{},{},{}],body_armor_item:{id:"minecraft:light_blue_carpet",count:1,tag:{gm4_trades:{options:{maxUses:24,rewardXp:0b}}}}}
...
summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option"],Items:[{id:"minecraft:slime_block",count:1,Slot:2b},{id:"minecraft:emerald",count:1,Slot:3b},{}],body_armor_item:{id:"minecraft:light_blue_carpet",count:1,tag:{gm4_trades:{pool:"example_pack:bar_trades",options:{maxUses:1,rewardXp:1b,xp:1,priceMultiplier:0.05f}}}}}

# a trade in the trade pool "example_pack:bar_trades", that uses one loot table to populate the entire trade
summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option","gm4_new_trade_option"],Items:[{},{},{}],body_armor_item:{id:"minecraft:light_blue_carpet",count:1,tag:{gm4_trades:{options:{maxUses:2,rewardXp:1b,xp:1,priceMultiplier:0.05f}}}}}
