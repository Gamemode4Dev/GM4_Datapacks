...
execute if data entity @s DecorItem.tag.gm4_trades.pool store success score $pools_differ gm4_trades_data run data modify storage gm4_trades-1.0:temp/wandering_trader/comparison pool set from entity @s DecorItem.tag.gm4_trades.pool
