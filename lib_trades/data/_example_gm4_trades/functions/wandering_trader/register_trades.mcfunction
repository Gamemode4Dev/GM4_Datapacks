...
loot replace entity @e[type=trader_llama,limit=1,tag=gm4_new_trade_option] horse.0 loot _example_gm4_trades:blocks
loot replace entity @e[type=trader_llama,limit=1,tag=gm4_new_trade_option] horse.1 loot _example_gm4_trades:shinies
tag @e[type=trader_llama] remove gm4_new_trade_option

# another trade in the trade pool "_example_gm4_trades:foo_trades"
summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option","gm4_new_trade_option"],Items:[{},{},{id:"minecraft:rotten_flesh",Count:1b,Slot:4b}],DecorItem:{id:"minecraft:light_blue_carpet",Count:1b,tag:{gm4_trades:{pool:"_example_gm4_trades:foo_trades",options:{maxUses:1,rewardXp:1b,xp:24,priceMultiplier:0.1f}}}}}
loot replace entity @e[type=trader_llama,limit=1,tag=gm4_new_trade_option] horse.0 loot _example_gm4_trades:spawn_eggs
loot replace entity @e[type=trader_llama,limit=1,tag=gm4_new_trade_option] horse.1 loot _example_gm4_trades:shinies
tag @e[type=trader_llama] remove gm4_new_trade_option

# a trade in the trade pool "_example_gm4_trades:bar_trades"
summon trader_llama ~ 0 ~ {Silent:1b,NoGravity:1b,Invulnerable:1b,ChestedHorse:1b,Variant:0,Strength:1,DespawnDelay:1,Tags:["gm4_trade_option"],Items:[{id:"minecraft:slime_block",Count:1b,Slot:2b},{id:"minecraft:emerald",Count:1b,Slot:3b},{}],DecorItem:{id:"minecraft:light_blue_carpet",Count:1b,tag:{gm4_trades:{pool:"_example_gm4_trades:bar_trades",options:{maxUses:1,rewardXp:1b,xp:1,priceMultiplier:0.05f}}}}}

# a trade in the trade pool "_example_gm4_trades:bar_trades", that uses one loot table to populate the entire trade
...
loot replace entity @e[type=trader_llama,limit=1,tag=gm4_new_trade_option] horse.0 loot _example_gm4_trades:pickaxe_trade
tag @e[type=trader_llama] remove gm4_new_trade_option
