...
execute if score #stack gm4_tc_data matches 1.. at @s run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",Count:1b},Tags:["gm4_tc_stack","gm4_tc_locked"]}
