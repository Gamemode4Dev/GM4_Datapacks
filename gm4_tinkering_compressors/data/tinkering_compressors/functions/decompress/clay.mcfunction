...
execute if score #stack gm4_tc_data matches 1..4 at @s run summon item ~ ~ ~ {Item:{id:"minecraft:clay_ball",Count:64b}}
execute if score #stack gm4_tc_data matches 2..4 at @s run summon item ~ ~ ~ {Item:{id:"minecraft:clay_ball",Count:64b}}
execute if score #stack gm4_tc_data matches 3..4 at @s run summon item ~ ~ ~ {Item:{id:"minecraft:clay_ball",Count:64b}}
execute if score #stack gm4_tc_data matches 4 at @s run summon item ~ ~ ~ {Item:{id:"minecraft:clay_ball",Count:64b}}

execute if score #remainder gm4_tc_data matches 1.. run summon item ~ ~ ~ {Item:{id:"minecraft:clay_ball",Count:1b},Tags:["gm4_tc_remainder"]}
