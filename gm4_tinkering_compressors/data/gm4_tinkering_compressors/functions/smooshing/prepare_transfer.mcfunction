...
execute if data entity @s Item.tag.gm4_machines{id:"tinkering_compressor"} as @e[type=item,dx=0,limit=1,nbt={Item:{count:1,id:"minecraft:obsidian"}}] run function gm4_tinkering_compressors:smooshing/remove_band/found_obsidian
