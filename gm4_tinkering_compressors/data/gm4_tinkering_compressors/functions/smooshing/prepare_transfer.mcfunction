...
execute if data entity @s Item.tag.gm4_machines{id:"tinkering_compressor"} as @e[type=item,dx=0,limit=1,nbt={Item:{Count:1b,id:"minecraft:obsidian"}}] run function gm4_metallurgy:smooshing/remove_band/found_obsidian
