...
execute as @e[type=item,tag=!gm4_ml_smooshed,nbt={Item:{count:1,tag:{gm4_metallurgy:{has_shamir:1b}}}}] at @s if block ~ ~-1 ~ #minecraft:anvil run function gm4_tinkering_compressors:smooshing/item_on_anvil
