...
data merge entity @s {Small:0,Tags:["gm4_no_edit","gm4_tinkering_compressor_stand","gm4_machine_stand","smithed.block","smithed.entity","smithed.strict"],HasVisualFire:1,CustomName:'"gm4_tinkering_compressor_stand"',ArmorItems:[{},{},{},{id:"minecraft:oxidized_cut_copper",Count:1b,tag:{CustomModelData:3420001}}],HandItems:[{},{}],Pose:{Head:[180f,0f,0f]},Rotation:[0.0f,0.0f]}
tp @s ~ ~-0.565 ~
