...
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:copper_ingot"}}] run function gm4_tinkering_compressors:compress/copper_ingot
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:raw_iron"}}] run function gm4_tinkering_compressors:compress/raw_iron
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:raw_copper"}}] run function gm4_tinkering_compressors:compress/raw_copper
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:raw_gold"}}] run function gm4_tinkering_compressors:compress/raw_gold
