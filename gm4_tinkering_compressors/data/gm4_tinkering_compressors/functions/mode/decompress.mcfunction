...
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:copper_block"}}] run function gm4_tinkering_compressors:decompress/copper_block
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:raw_iron_block"}}] run function gm4_tinkering_compressors:decompress/raw_iron_block
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:raw_copper_block"}}] run function gm4_tinkering_compressors:decompress/raw_copper_block
execute unless score $ran_compressor gm4_tc_data matches 1.. if entity @s[nbt={Item:{id:"minecraft:raw_gold_block"}}] run function gm4_tinkering_compressors:decompress/raw_gold_block
