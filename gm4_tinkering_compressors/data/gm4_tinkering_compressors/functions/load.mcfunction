execute if score gm4 load.status matches 1 if score gm4_block_compressors load.status matches 1 if score gm4_metallurgy load.status matches 1 run scoreboard players set gm4_tinkering_compressors load.status 1
