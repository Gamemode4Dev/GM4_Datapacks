...
execute positioned ~ ~-0.995 ~ as @e[type=armor_stand,tag=gm4_tinkering_compressor_stand,tag=gm4_compressor_depressed,distance=..0.01,limit=1] at @s run function gm4_tinkering_compressors:pressure_plate_up
...
execute if entity @s[tag=gm4_compressor_sound] run playsound block.stone_pressure_plate.click_off block @a[distance=..6] ~ ~0.505 ~ 0.7 0.3
