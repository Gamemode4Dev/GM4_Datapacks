...
execute if score $placed_block gm4_machine_data matches 0 if data storage gm4_machines:temp {id:"gm4_tinkering_compressor"} run function gm4_tinkering_compressors:machine/create
