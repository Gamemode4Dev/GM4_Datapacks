...
execute if score structure_height gm4_count matches ..50 if block ~ 3 ~ bedrock if score ocean gm4_orbis_biome matches 1 run summon area_effect_cloud ~ ~ ~ {Tags:["gm4_dangerous_dungeons"]}
