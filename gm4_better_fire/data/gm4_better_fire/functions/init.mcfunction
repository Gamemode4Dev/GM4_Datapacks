...
# guidebook
summon marker ~ 455.770248169734 ~ {CustomName:'"gm4_better_fire_guide"',Tags:["gm4_guide"],data:{type:"module",id:"better_fire",page_count:1,line_count:1,module_name:"Better Fire"}}
