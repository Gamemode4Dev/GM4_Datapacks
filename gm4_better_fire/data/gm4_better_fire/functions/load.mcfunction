...
execute if score gm4_better_fire load matches 1 run function better_fire:init
execute unless score gm4_better_fire load matches 1 run schedule clear better_fire:main
