...
data merge entity @s {CustomName:'"gm4_blast_furnace"',Rotation:[45f,0f],ArmorItems:[{},{},{},{id:gray_stained_glass,Count:1}],Tags:["gm4_blast_furnace","gm4_no_edit","gm4_bf_has_furnace"],Silent:1,Rotation:[45f,0f]}
