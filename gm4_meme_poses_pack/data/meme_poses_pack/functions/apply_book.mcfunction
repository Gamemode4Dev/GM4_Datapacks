...
execute if entity @s[nbt={Item:{tag:{pages:["dabbing"]}}}] run scoreboard players set @e[type=armor_stand,distance=..1,limit=1,sort=nearest,tag=!gm4_no_edit] gm4_meme_pose 1
