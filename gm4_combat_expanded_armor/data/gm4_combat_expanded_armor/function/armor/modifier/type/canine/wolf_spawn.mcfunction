...
# obtain player UUID
data modify storage gm4_combat_expanded_armor:temp uuid set from entity @s UUID

# BPR told me to add this ¯\_(ツ)_/¯ "stupid chunk loading stuff"
kill @e[type=wolf,tag=gm4_ce_new_wolf]
# spawn wolf
execute summon wolf run function gm4_combat_expanded_armor:armor/modifier/type/canine/wolf_initiate
