...
data modify storage gm4_combat_expanded_armor:temp archer_arrow set from entity @s {}
function gm4_combat_expanded_armor:armor/modifier/type/archer/spawn_arrows
data remove storage gm4_combat_expanded_armor:temp archer_arrow
