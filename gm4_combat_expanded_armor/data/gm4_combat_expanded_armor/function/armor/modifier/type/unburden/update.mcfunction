...
execute store result storage gm4_combat_expanded_armor:temp components."minecraft:custom_data".gm4_combat_expanded_armor.stored_armor int 1 run scoreboard players get @s gm4_ce_armor

# calculate level of bonus movement speed and attack speed
execute store result score $level gm4_ce_data run data get storage gm4_combat_expanded_armor:temp components."minecraft:custom_data".gm4_combat_expanded_armor.level 2
...
execute store result storage gm4_combat_expanded_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_combat_expanded_armor:dynamic"}].amount float 0.0001 run scoreboard players get $level gm4_ce_data
execute store result storage gm4_combat_expanded_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_combat_expanded_armor:dynamic_2"}].amount float 0.0001 run scoreboard players get $level gm4_ce_data
