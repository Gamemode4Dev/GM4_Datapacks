...
execute if score $death_messages gm4_ce_data matches 1 if score $killed_player_count gm4_ce_data matches 0 at @s run tellraw @a {"translate":"death.gm4.combat_expanded_armor.link_0","fallback":"%s followed eachother to their death","with":[{"selector":"@a[tag=gm4_ce_link.process]"}]}
execute if score $death_messages gm4_ce_data matches 1 if score $killed_player_count gm4_ce_data matches 1 at @s run tellraw @a {"translate":"death.gm4.combat_expanded_armor.link_1","fallback":"%s followed %s to their death","with":[{"selector":"@s"},{"selector":"@p[tag=gm4_ce_link.killed]"}]}
execute if score $death_messages gm4_ce_data matches 1 if score $killed_player_count gm4_ce_data matches 2.. at @s run tellraw @a {"translate":"death.gm4.combat_expanded_armor.link_2+","fallback":"%s followed %s and %s to their deaths","with":[{"selector":"@s"},{"selector":"@a[tag=gm4_ce_link.killed,tag=!gm4_ce_link.killed_2]"},{"selector":"@a[tag=gm4_ce_link.killed_2]"}]}
