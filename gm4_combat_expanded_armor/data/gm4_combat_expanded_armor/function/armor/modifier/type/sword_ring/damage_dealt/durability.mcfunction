...
execute store result score $unbreaking_level gm4_ce_data run data get storage gm4_combat_expanded_armor:temp sword_ring.data[0].components."minecraft:enchantments".levels."minecraft:unbreaking"
...
execute store result score $incoming_damage gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_combat_expanded_armor:technical/roll_damage

# if damage should be dealt apply it
execute if score $incoming_damage gm4_ce_data matches 1.. run function gm4_combat_expanded_armor:armor/modifier/type/sword_ring/damage_dealt/apply_durability
