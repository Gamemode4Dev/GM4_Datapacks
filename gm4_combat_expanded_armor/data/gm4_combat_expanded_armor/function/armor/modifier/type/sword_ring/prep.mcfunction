...
function gm4_combat_expanded_armor:armor/modifier/type/sword_ring/get_relevant_data
execute store result score $sword_ring.count gm4_ce_data run data get storage gm4_combat_expanded_armor:temp sword_ring.data

# check for crouching
scoreboard players set $stats_set gm4_ce_data 0
execute if predicate gm4_combat_expanded_armor:technical/crouching run function gm4_combat_expanded_armor:armor/modifier/type/sword_ring/set_stats_crouching
execute if score $stats_set gm4_ce_data matches 0 run function gm4_combat_expanded_armor:armor/modifier/type/sword_ring/set_stats
...
execute store result storage gm4_combat_expanded_armor:temp sword_ring.deg int 1 run scoreboard players get @s gm4_ce_sword_ring.deg
...
function gm4_combat_expanded_armor:armor/modifier/type/sword_ring/eval_deg with storage gm4_combat_expanded_armor:temp sword_ring

# cleanup
tag @s remove gm4_ce_target
data remove storage gm4_combat_expanded_armor:temp sword_ring
