...
execute as @a[tag=gm4_ce_wearing_archer,scores={gm4_ce_used_bow=1..}] at @s run function gm4_combat_expanded_armor:armor/modifier/type/archer/find_arrow
...
execute if score $keep_tick.archer gm4_ce_keep_tick matches 1 run schedule function gm4_combat_expanded_armor:clocks/temp/archer 1t
