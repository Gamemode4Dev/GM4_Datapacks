...
# armor 1 - 3
execute store result score $armor gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_combat_expanded_armor:randomizer/armor
...
execute store result score $armor_clamp gm4_ce_data run data get storage gm4_combat_expanded_armor:temp components."minecraft:custom_data".gm4_combat_expanded_armor.armor_clamp
scoreboard players operation $armor- gm4_ce_data > $armor_clamp gm4_ce_data
# attack damage 0.5 - 2
execute store result score $damage gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_combat_expanded_armor:randomizer/damage
...
# movement speed 5 - 20
execute store result score $speed gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_combat_expanded_armor:randomizer/speed
...
# attack speed 10 - 25
execute store result score $atkspeed gm4_ce_data run loot spawn 29999998 1 7133 loot gm4_combat_expanded_armor:randomizer/atkspeed
...
execute store result storage gm4_combat_expanded_armor:temp armor int 1 run scoreboard players get $armor gm4_ce_data
execute store result storage gm4_combat_expanded_armor:temp damage float 0.1 run scoreboard players get $damage gm4_ce_data
execute store result storage gm4_combat_expanded_armor:temp level float 0.2 run scoreboard players get $damage gm4_ce_data
execute store result storage gm4_combat_expanded_armor:temp speed int 1 run scoreboard players get $speed gm4_ce_data
execute store result storage gm4_combat_expanded_armor:temp atkspeed int 1 run scoreboard players get $atkspeed gm4_ce_data
