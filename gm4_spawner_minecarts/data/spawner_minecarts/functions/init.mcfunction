...
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Installing Spawner Minecarts...",{"translate":"text.gm4.modules.update.installing","with":["Spawner Minecarts"]}]}]
...
#announce success
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Spawner Minecarts Installed!",{"translate":"text.gm4.modules.update.installed","with":["Spawner Minecarts"]}]}]
