...
execute unless predicate {type:"random_chance",chance:{type:"score",score:"gm4_spawner_minecarts_data",target:{type:"fixed",name:"$nearby_carts"},scale:0.25}} run return fail
