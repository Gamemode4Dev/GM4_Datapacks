...
execute unless predicate {type:"random_chance",chance:{type:"mul",inputs:[{type:"from_int",input:{type:"score",score:"gm4_spawner_minecarts_data",target:{type:"fixed",name:"$nearby_carts"}}},0.25]}} run return fail
