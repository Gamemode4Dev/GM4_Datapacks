...
execute if score $valid_spawner gm4_spawner_data matches 1.. run summon spawner_minecart ~ ~ ~ {Tags:["gm4_spawner_minecart"],MaxNearbyEntities:6s,RequiredPlayerRange:16s,SpawnCount:4s,SpawnData:{id:"minecraft:pig"},MaxSpawnDelay:600s,Delay:171s,SpawnRange:4s,MinSpawnDelay:100s,SpawnPotentials:[{Entity:{id:"minecraft:pig"},Weight:1}],Invulnerable:1b}
