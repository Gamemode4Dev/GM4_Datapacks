...
execute if score gm4_spawner_minecarts load matches 1 run function gm4_spawner_minecarts:init
execute unless score gm4_spawner_minecarts load matches 1 run schedule clear gm4_spawner_minecarts:main
