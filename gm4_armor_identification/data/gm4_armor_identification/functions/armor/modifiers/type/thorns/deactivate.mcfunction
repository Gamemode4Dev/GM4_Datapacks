...
execute if score $level gm4_ai_data matches 1 run data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"gray","text":"Thorns XIV"},{"translate":"item.gm4.mob_buff.armor.lore.thorns_lvl1"}]}'
execute if score $level gm4_ai_data matches 2 run data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"gray","text":"Thorns XVI"},{"translate":"item.gm4.mob_buff.armor.lore.thorns_lvl2"}]}'
execute if score $level gm4_ai_data matches 3 run data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"gray","text":"Thorns XVIII"},{"translate":"item.gm4.mob_buff.armor.lore.thorns_lvl3"}]}'
execute if score $level gm4_ai_data matches 4 run data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"gray","text":"Thorns XX"},{"translate":"item.gm4.mob_buff.armor.lore.thorns_lvl4"}]}'
