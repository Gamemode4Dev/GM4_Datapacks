...
data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Spawn Trader"},{"translate":"item.gm4_armor_identification.armor.lore.trade"}]}'
data modify storage gm4_lore:temp Input set value ['{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Spawn Trader"},{"translate":"item.gm4_armor_identification.armor.lore.trade"}]}']
