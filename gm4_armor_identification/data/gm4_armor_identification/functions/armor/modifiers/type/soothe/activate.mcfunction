...
execute if score $level gm4_ai_data matches 1 run data modify storage gm4_lore:temp Target set value '{"translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Heal Pulse"},{"translate":"item.gm4_armor_identification.armor.lore.fear"}]}]}'
execute if score $level gm4_ai_data matches 2 run data modify storage gm4_lore:temp Target set value '{"translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Heal Pulse"},{"translate":"item.gm4_armor_identification.armor.lore.fear"}]},{"italic":false,"color":"blue","translate":"potion.potency.1"}]}'
execute if score $level gm4_ai_data matches 3 run data modify storage gm4_lore:temp Target set value '{"translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Heal Pulse"},{"translate":"item.gm4_armor_identification.armor.lore.fear"}]},{"italic":false,"color":"blue","translate":"potion.potency.2"}]}'
execute if score $level gm4_ai_data matches 1 run data modify storage gm4_lore:temp Input set value ['{"translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Heal Pulse"},{"translate":"item.gm4_armor_identification.armor.lore.fear"}]}]}']
execute if score $level gm4_ai_data matches 2 run data modify storage gm4_lore:temp Input set value ['{"translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Heal Pulse"},{"translate":"item.gm4_armor_identification.armor.lore.fear"}]},{"italic":false,"color":"dark_gray","translate":"potion.potency.1"}]}']
execute if score $level gm4_ai_data matches 3 run data modify storage gm4_lore:temp Input set value ['{"translate":"potion.withAmplifier","with":[{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Heal Pulse"},{"translate":"item.gm4_armor_identification.armor.lore.fear"}]},{"italic":false,"color":"dark_gray","translate":"potion.potency.2"}]}']
