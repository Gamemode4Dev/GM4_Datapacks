...
# set armor
# TODO - needs to add enchantment chances based on biome
loot replace entity @s armor.feet loot gm4_armor_identification:mobs/equip_armor/zombie
# set weapon
# NOT IMPLEMENTED YET

# set modifiers
function gm4_armor_identification:mobs/modifiers
