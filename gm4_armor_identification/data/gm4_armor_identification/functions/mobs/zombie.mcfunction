...
execute if score $difficulty gm4_ai_data matches 11.. if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon zombie ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
...
execute if predicate gm4_armor_identification:mobs/modifiers/flowering run data modify entity @s[tag=!gm4_ai_spore_mob] ArmorDropChances[3] set value 2F
...
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon zombie ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon zombie ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon zombie ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}

# set armor
loot replace entity @s armor.feet loot gm4_armor_identification:mobs/equip_armor/generic
execute if predicate gm4_armor_identification:mobs/modifiers/flowering run item replace entity @s armor.head with flowering_azalea_leaves{gm4_ai_spore:zombie}
# set weapon
