...
execute if predicate gm4_armor_identification:mobs/modifiers/burned if entity @s[tag=!gm4_ai_extra_mob] run function gm4_armor_identification:mobs/biomes/burned_husk
execute if predicate gm4_armor_identification:mobs/modifiers/burned run attribute @s generic.max_health modifier add 34931bf4-2d02-4700-bb16-097bc669d313 "gm4_ai_modifier_burned" -0.4 multiply
execute if predicate gm4_armor_identification:mobs/modifiers/burned run attribute @s generic.attack_damage modifier add 96ee68f2-4150-4350-af04-e4230fcd2cec "gm4_ai_modifier_burned" -0.25 multiply
