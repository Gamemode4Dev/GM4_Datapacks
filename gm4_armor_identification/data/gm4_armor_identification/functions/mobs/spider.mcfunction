...
execute if predicate gm4_armor_identification:mobs/modifiers/lush_caves if predicate gm4_armor_identification:technical/chance_50 run function gm4_armor_identification:mobs/biomes/lush_caves_spider
