...
execute if score $difficulty gm4_ai_data matches 11.. if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon drowned ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
...
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon drowned ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon drowned ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon drowned ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
