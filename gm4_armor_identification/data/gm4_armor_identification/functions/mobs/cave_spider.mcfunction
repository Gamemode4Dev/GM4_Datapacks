...
execute if predicate gm4_armor_identification:mobs/modifiers/toxic run tag @s add gm4_ai_poison_bite
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] store success score $mob_extras gm4_ai_data run summon cave_spider ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
execute if predicate gm4_armor_identification:mobs/modifiers/growth if entity @s[tag=!gm4_ai_extra_mob] if predicate gm4_armor_identification:technical/chance_50 store success score $mob_extras gm4_ai_data run summon cave_spider ~ ~ ~ {Tags:["gm4_ai_extra_mob"]}
