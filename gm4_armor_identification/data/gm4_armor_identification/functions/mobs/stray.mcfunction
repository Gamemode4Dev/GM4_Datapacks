...
execute if score $difficulty gm4_ai_data matches 8.. if predicate gm4_armor_identification:technical/chance_15 store success score $arrow gm4_ai_data run loot replace entity @s weapon.offhand loot gm4_armor_identification:mobs/equip_arrow/stray_harming
...
execute if predicate gm4_armor_identification:mobs/modifiers/snowy unless predicate gm4_armor_identification:mobs/modifiers/growth store success score $arrow gm4_ai_data run loot replace entity @s weapon.offhand loot gm4_armor_identification:mobs/equip_arrow/stray_snowy
execute if predicate gm4_armor_identification:mobs/modifiers/toxic store success score $arrow gm4_ai_data run loot replace entity @s weapon.offhand loot gm4_armor_identification:mobs/equip_arrow/stray_toxic
