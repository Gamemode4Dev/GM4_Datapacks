...
data modify storage gm4_combat_evolved:temp tag.gm4_combat_evolved.cooldown set value 75
...
data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Release Potion"},{"translate":"item.gm4_combat_evolved.armor.lore.witch"}]}'
data modify storage gm4_lore:temp Input set value ['{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Release Potion"},{"translate":"item.gm4_combat_evolved.armor.lore.witch"}]}']
