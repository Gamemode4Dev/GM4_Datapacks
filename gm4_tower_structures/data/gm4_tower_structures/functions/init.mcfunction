...
# guidebook
summon marker ~ 4238.762042469422 ~ {CustomName:'"gm4_tower_structures_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"orbis",id:"tower_structures",page_count:1,line_count:1,module_name:"Tower Structures"}}
