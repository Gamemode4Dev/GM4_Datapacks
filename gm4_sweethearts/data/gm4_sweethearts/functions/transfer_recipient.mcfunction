...
# run donor transfer
execute as @p[tag=gm4_sweethearts_donor,distance=..3] at @s run function gm4_sweethearts:transfer_donor 
...
# heal player
attribute @s minecraft:generic.max_health modifier add 17d25a01-e9ba-4c08-8a79-ee8f72fb033d gm4_sh_heal 1 add
