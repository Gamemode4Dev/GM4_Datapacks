...
scoreboard players operation remove_health gm4_sh_data -= @s gm4_health
...
execute if score donor_lost_health gm4_sh_data = @s gm4_sh_data run effect give @s minecraft:instant_damage 1 0 true
execute if score donor_lost_health gm4_sh_data = @s gm4_sh_data run advancement grant @s only gm4:sweethearts
