...
execute as @p[gamemode=!creative,gamemode=!spectator,tag=!gm4_sh_donor,distance=..3] unless score @s gm4_sh_health >= @s gm4_sh_data at @s run function gm4_sweethearts:transfer_recipient
