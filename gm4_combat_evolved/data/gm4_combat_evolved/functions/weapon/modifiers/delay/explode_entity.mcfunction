...
execute if entity @s[tag=gm4_cd_delay_lvl_1] run scoreboard players remove $health gm4_ce_data 4
execute if entity @s[tag=gm4_cd_delay_lvl_2] run scoreboard players remove $health gm4_ce_data 6
execute if entity @s[tag=gm4_cd_delay_lvl_3] run scoreboard players remove $health gm4_ce_data 8
