...
execute if score $modifier gm4_ce_data matches 12 unless score @s gm4_ce_t_hurt matches 1.. run function gm4_combat_evolved:armor/modifiers/type/other/sneak
...
execute if score $modifier gm4_ce_data matches 32 if score @s gm4_ce_kill matches 1.. run function gm4_combat_evolved:armor/modifiers/type/other/vamp
execute if score $modifier gm4_ce_data matches 33 if score @s gm4_ce_kill matches 1.. at @s as @e[type=!player,type=!armor_stand,team=!gm4_ce_team_check,distance=..8,tag=!smithed.strict] at @s run function gm4_combat_evolved:armor/modifiers/type/other/fear
# when below 50% hp
...
execute if score $modifier gm4_ce_data matches 62 if predicate gm4_combat_evolved:technical/night_time at @s run function gm4_combat_evolved:armor/modifiers/type/other/gloom
execute if score $modifier gm4_ce_data matches 63 if predicate gm4_combat_evolved:technical/night_time run function gm4_combat_evolved:armor/modifiers/type/other/shadow
# when equipped
execute if score $modifier gm4_ce_data matches 71 run function gm4_combat_evolved:armor/modifiers/type/canine/check
execute if score $modifier gm4_ce_data matches 72 at @s run function gm4_combat_evolved:armor/modifiers/type/other/link
