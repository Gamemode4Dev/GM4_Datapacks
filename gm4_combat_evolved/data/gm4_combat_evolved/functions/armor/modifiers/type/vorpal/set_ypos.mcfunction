...
execute unless score $set_y gm4_ce_data matches 17.. at @s unless score $warp_safe gm4_ce_data matches 1 run function gm4_combat_evolved:armor/modifiers/type/vorpal/set_ypos
