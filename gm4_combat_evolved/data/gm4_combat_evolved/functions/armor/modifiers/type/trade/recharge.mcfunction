...
data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Trade"},{"translate":"item.gm4.combat_evolved.lore.trade"}]}'
data modify storage gm4_lore:temp Input set value ['{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Trade"},{"translate":"item.gm4.combat_evolved.lore.trade"}]}']
