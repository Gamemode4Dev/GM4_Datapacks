...
data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Clientele"},{"translate":"item.gm4_combat_evolved.armor.lore.trade"}]}'
data modify storage gm4_lore:temp Input set value ['{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Clientele"},{"translate":"item.gm4_combat_evolved.armor.lore.trade"}]}']
