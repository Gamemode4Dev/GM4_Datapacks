...
data modify storage gm4_lore:temp Target set value '{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"dark_gray","text":"Discharge"},{"translate":"item.gm4.combat_evolved.lore.witch"}]}'
data modify storage gm4_lore:temp Input set value ['{"translate":"%1$s%3427655$s","with":[{"italic":false,"color":"blue","text":"Discharge"},{"translate":"item.gm4.combat_evolved.lore.witch"}]}']
