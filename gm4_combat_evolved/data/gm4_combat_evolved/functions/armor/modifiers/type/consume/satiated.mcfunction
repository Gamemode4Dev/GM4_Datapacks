...
execute store result score $namelen gm4_ce_data run data get storage gm4_combat_evolved:temp tag.display.Name
execute if score $namelen gm4_ce_data matches 75.. run function gm4_combat_evolved:armor/modifiers/type/consume/rename

# remove module tag to stop clock running for this armor
data remove storage gm4_combat_evolved:temp tag.gm4_combat_evolved
