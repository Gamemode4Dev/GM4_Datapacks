...
execute if score $player_online gm4_ce_data matches 1.. if score @s gm4_ce_t_wolf matches 0 at @s run function gm4_combat_evolved:armor/modifiers/type/canine/wolf_kill
