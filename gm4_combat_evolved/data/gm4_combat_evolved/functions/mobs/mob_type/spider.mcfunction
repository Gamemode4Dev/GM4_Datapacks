...
execute if predicate gm4_combat_evolved:mobs/modifiers/lush_caves if predicate gm4_combat_evolved:technical/chance_50 run function gm4_combat_evolved:mobs/effects/lush_caves_spider
execute if predicate gm4_combat_evolved:mobs/modifiers/toxic run function gm4_combat_evolved:mobs/effects/toxic_spider
