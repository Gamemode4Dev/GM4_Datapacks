...
execute if score $difficulty gm4_ce_data matches 8.. if predicate gm4_combat_evolved:technical/chance_15 store success score $arrow gm4_ce_data run loot replace entity @s weapon.offhand loot gm4_combat_evolved:mobs/equip_arrow/stray_harming
...
execute if predicate gm4_combat_evolved:mobs/modifiers/snowy unless predicate gm4_combat_evolved:mobs/modifiers/growth store success score $arrow gm4_ce_data run loot replace entity @s weapon.offhand loot gm4_combat_evolved:mobs/equip_arrow/stray_snowy
execute if predicate gm4_combat_evolved:mobs/modifiers/toxic store success score $arrow gm4_ce_data run loot replace entity @s weapon.offhand loot gm4_combat_evolved:mobs/equip_arrow/stray_toxic
