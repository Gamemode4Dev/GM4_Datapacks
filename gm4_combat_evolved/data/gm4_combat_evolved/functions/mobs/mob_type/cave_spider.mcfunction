...
execute if predicate gm4_combat_evolved:mobs/modifiers/lush_caves run function gm4_combat_evolved:mobs/effects/lush_caves_spider
execute if predicate gm4_combat_evolved:mobs/modifiers/toxic run tag @s add gm4_ce_poison_bite
execute if predicate gm4_combat_evolved:mobs/modifiers/growth if entity @s[tag=!gm4_ce_extra_mob] store success score $mob_extras gm4_ce_data run summon cave_spider ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
execute if predicate gm4_combat_evolved:mobs/modifiers/growth if entity @s[tag=!gm4_ce_extra_mob] if predicate gm4_combat_evolved:technical/chance_50 store success score $mob_extras gm4_ce_data run summon cave_spider ~ ~ ~ {Tags:["gm4_ce_extra_mob"]}
