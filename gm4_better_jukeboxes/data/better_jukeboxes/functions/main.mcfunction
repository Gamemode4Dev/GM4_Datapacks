...
execute as @e[type=armor_stand,tag=gm4_better_jukebox] at @s positioned ~ ~0.45 ~ run function better_jukeboxes:process

schedule function better_jukeboxes:scheduled_check 8t
