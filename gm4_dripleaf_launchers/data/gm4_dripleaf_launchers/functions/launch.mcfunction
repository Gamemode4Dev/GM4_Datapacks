...
summon minecraft:area_effect_cloud ~ ~ ~ {Particle:"minecraft:block minecraft:air",ReapplicationDelay:0,Age:-1,Radius:0.5f,RadiusPerTick:0f,RadiusOnUse:-0.5f,Duration:4,WaitTime:0,Effects:[{Id:25,Amplifier:40b,Duration:4,ShowParticles:0b,ShowIcon:0b,Ambient:1b}]}
