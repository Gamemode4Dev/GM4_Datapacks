...
# traps
execute as @e[type=marker,tag=gm4_mu_snowy_trap] at @s if entity @a[gamemode=!spectator,distance=..9] run function gm4_monsters_unbound:mob/process/reveal_snowy_trap
