...
scoreboard players set $keep_tick.boss gm4_mu_keep_tick 0
...
execute if score $keep_tick.boss gm4_mu_keep_tick matches 0 run kill @e[tag=gm4_mu_boss.watcher.temp_display]
execute if score $keep_tick.boss gm4_mu_keep_tick matches 1 run schedule function gm4_monsters_unbound:clocks/boss/watchers 1t
