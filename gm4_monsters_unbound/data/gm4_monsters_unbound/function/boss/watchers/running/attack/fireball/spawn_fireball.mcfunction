...
data merge entity @s {ExplosionPower:2b,Tags:["gm4_mu_boss.fireball"],power:[0.0,-0.05,0.0],Item:{id:"minecraft:budding_amethyst",count:1}}
...
# set motion
execute store result entity @s power[0] double -0.00025 run scoreboard players get $motion_x gm4_mu_boss
execute store result entity @s power[1] double -0.00025 run scoreboard players get $motion_y gm4_mu_boss
execute store result entity @s power[2] double -0.00025 run scoreboard players get $motion_z gm4_mu_boss
