...
execute at @r[gamemode=!spectator,gamemode=!creative,distance=..64] run tp @s ~ ~ ~
...
function gm4_monsters_unbound:boss/watchers/running/attack/warp/pick_location_near/randomize
