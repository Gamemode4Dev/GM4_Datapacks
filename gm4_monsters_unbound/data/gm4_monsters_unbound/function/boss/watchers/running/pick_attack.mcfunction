...
execute unless score @s[scores={gm4_mu_boss.attack_id=0,gm4_mu_boss.phase=2..}] gm4_mu_boss.last_attack matches 7 if entity @p[gamemode=!spectator,gamemode=!creative,distance=..5.25] positioned ~-5.5 ~-1.5 ~-5.5 if entity @p[gamemode=!spectator,gamemode=!creative,dx=10,dy=2,dz=10] if predicate gm4_monsters_unbound:chance/boss/watchers/aura_attack run scoreboard players set @s gm4_mu_boss.attack_id 7
...
execute unless score @s[scores={gm4_mu_boss.attack_id=0}] gm4_mu_boss.last_attack matches 2 if entity @p[gamemode=!spectator,gamemode=!creative,distance=8..20] if predicate gm4_monsters_unbound:chance/boss/watchers/fireball_attack run scoreboard players set @s gm4_mu_boss.attack_id 2
...
execute unless score @s gm4_mu_boss.attack_id matches 1.. if entity @a[gamemode=!spectator,gamemode=!creative,distance=..64] run scoreboard players set @s gm4_mu_boss.attack_id 3
