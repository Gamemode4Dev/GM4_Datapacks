...
execute if entity @s[tag=gm4_mu_elite.vorpal] if predicate {type:"minecraft:random_chance",chance:0.65} run function gm4_monsters_unbound:mob/process/elite/vorpal/warp/run
