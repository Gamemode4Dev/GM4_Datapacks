...
execute if score $elite_pick gm4_mu_data matches 1..35 run return run function gm4_monsters_unbound:mob/init/elite/glacial

# MENDING 15%
# 2.5x health, -25% speed
# heals undead in LoS, restoring 24 health and granting them resistance II for 1 second
execute if score $elite_pick gm4_mu_data matches 36..50 run return run function gm4_monsters_unbound:mob/init/elite/mending
...
execute if score $elite_pick gm4_mu_data matches 51..70 run return run function gm4_monsters_unbound:mob/init/elite/blazing
...
execute if score $elite_pick gm4_mu_data matches 71..75 run return run function gm4_monsters_unbound:mob/init/elite/zephyr
...
execute if score $elite_pick gm4_mu_data matches 76..80 run return run function gm4_monsters_unbound:mob/init/elite/gargantuan
...
execute if score $elite_pick gm4_mu_data matches 81..85 run return run function gm4_monsters_unbound:mob/init/elite/vorpal

# SPLITTING 5%
# 3.5x health
# on death splits into 5 miniature versions of the entity, with -50% in scale and most stats
execute if score $elite_pick gm4_mu_data matches 86..90 run return run function gm4_monsters_unbound:mob/init/elite/splitting
