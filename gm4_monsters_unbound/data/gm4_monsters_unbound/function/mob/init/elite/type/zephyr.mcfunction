...
attribute @s max_health modifier add gm4_monsters_unbound:elite_buff.speed 2.5 add_multiplied_total
attribute @s movement_speed modifier add gm4_monsters_unbound:elite_buff.speed 0.15 add_multiplied_total
attribute @s attack_knockback modifier add gm4_monsters_unbound:elite_buff.speed 0.5 add_value
attribute @s fall_damage_multiplier modifier add gm4_monsters_unbound:elite_buff.speed -1 add_multiplied_total
