...
# mountainous
execute if predicate {type:"minecraft:all_of",terms:[{type:"minecraft:random_chance",chance:0.30},"gm4_monsters_unbound:biome/mountainous"]} run function gm4_monsters_unbound:mob/init/mob_type/creeper/mountainous
# burned
