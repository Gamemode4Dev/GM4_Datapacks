...
execute if score $nearby_elites gm4_mu_data matches ..3 if predicate {type:"minecraft:random_chance",chance:0.05} run tag @s[tag=!gm4_sr_extra_mob] add gm4_mu_elite
...
# flowering
execute if predicate {type:"minecraft:all_of",terms:[{type:"minecraft:random_chance",chance:0.85},"gm4_monsters_unbound:biome/flowering"]} run function gm4_monsters_unbound:mob/init/mob_type/skeleton/flowering
# toxic
tag @s add gm4_mu_self
execute if entity @s[type=bogged,predicate=gm4_monsters_unbound:biome/toxic] if predicate {type:"minecraft:random_chance",chance:0.15} summon spider run function gm4_monsters_unbound:mob/init/mob_type/skeleton/toxic
tag @s remove gm4_mu_self
# burning
execute if predicate {type:"minecraft:all_of",terms:[{type:"minecraft:random_chance",chance:0.15},"gm4_monsters_unbound:biome/burned"]} run enchant @s flame 1
# growth
...
# dripstone caves
execute if predicate {type:"minecraft:all_of",terms:[{type:"location_check",predicate:{biomes:"dripstone_caves"}},{type:"random_chance",chance:0.6}]} run item replace entity @s weapon.mainhand with stone_pickaxe
# underground
execute if predicate gm4_monsters_unbound:technical/underground if predicate {type:"minecraft:random_chance",chance:0.4} run function gm4_monsters_unbound:mob/init/mob_type/skeleton/underground
