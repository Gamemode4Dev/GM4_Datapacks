...
# | Biome Modifiers
# flowering 
execute if predicate gm4_monsters_unbound:biome/flowering if predicate {type:"minecraft:random_chance",chance:0.50} run function gm4_monsters_unbound:mob/init/mob_type/enderman/flowering
# toxic 
execute if predicate gm4_monsters_unbound:biome/toxic if predicate {type:"minecraft:random_chance",chance:0.50} run function gm4_monsters_unbound:mob/init/mob_type/enderman/toxic
# burned
...
# underground
execute if entity @s[tag=!gm4_sr_extra_mob,predicate=gm4_monsters_unbound:technical/underground] if predicate {type:"minecraft:random_chance",chance:0.15} run function gm4_monsters_unbound:mob/init/mob_type/enderman/underground
# dripstone caves
...
# nether wastes
execute if biome ~ ~ ~ nether_wastes if predicate {type:"minecraft:random_chance",chance:0.95} run function gm4_monsters_unbound:mob/init/mob_type/enderman/nether_wastes
# soul sand valley
execute if biome ~ ~ ~ soul_sand_valley if predicate {type:"minecraft:random_chance",chance:0.95} run function gm4_monsters_unbound:mob/init/mob_type/enderman/soul_sand_valley
