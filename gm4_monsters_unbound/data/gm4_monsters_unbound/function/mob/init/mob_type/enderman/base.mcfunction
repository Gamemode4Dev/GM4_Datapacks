...
# nether wastes
execute if predicate gm4_monsters_unbound:biome/nether/nether_wastes if predicate gm4_monsters_unbound:chance/enderman/replace_with_blaze run function gm4_monsters_unbound:mob/init/mob_type/enderman/nether_wastes
# soul sand valley
execute if predicate gm4_monsters_unbound:biome/nether/soul_sand_valley if predicate gm4_monsters_unbound:chance/enderman/replace_with_wither_skeleton run function gm4_monsters_unbound:mob/init/mob_type/enderman/soul_sand_valley
