...
# growth
execute if entity @s[tag=!gm4_mu_extra_mob,predicate=gm4_monsters_unbound:biome/growth] store success score $mob_extras gm4_sr_data run summon spider ~ ~ ~ {Tags:["gm4_mu_extra_mob"]}
execute if entity @s[tag=!gm4_mu_extra_mob,predicate=gm4_monsters_unbound:biome/growth,predicate=gm4_monsters_unbound:chance/spider/extra_spawn] store success score $mob_extras gm4_sr_data run summon spider ~ ~ ~ {Tags:["gm4_mu_extra_mob"]}
# dark
