...
attribute @s attack_knockback modifier add gm4_monsters_unbound:stat_change.mountainous 1 add_value
attribute @s attack_damage modifier add gm4_monsters_unbound:stat_change.mountainous 1 add_value
