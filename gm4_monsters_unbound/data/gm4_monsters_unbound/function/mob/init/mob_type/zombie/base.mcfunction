...
execute if predicate {type:"all_of",terms:["gm4_monsters_unbound:technical/underground",{type:"inverted",term:{type:"location_check",predicate:{"biomes":"dripstone_caves"}}},{type:"random_chance",chance:0.5}]} run function gm4_monsters_unbound:mob/init/mob_type/zombie/underground/pick
