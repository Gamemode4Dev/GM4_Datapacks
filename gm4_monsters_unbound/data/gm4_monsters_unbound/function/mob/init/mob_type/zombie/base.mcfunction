...
execute if entity @s[tag=gm4_sr_was_baby] store result score $nearby_elites gm4_mu_data if entity @e[type=#gm4_monsters_unbound:elite_types,tag=gm4_mu_elite,distance=..32]
execute if entity @s[tag=gm4_sr_was_baby] if score $nearby_elites gm4_mu_data matches ..2 run return run function gm4_monsters_unbound:mob/init/elite/pick
