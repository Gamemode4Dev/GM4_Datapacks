...
attribute @s max_health modifier add gm4_monsters_unbound:stat_change.burned_husk -0.65 add_multiplied_total
attribute @s attack_damage modifier add gm4_monsters_unbound:stat_change.burned_husk -0.25 add_multiplied_total
