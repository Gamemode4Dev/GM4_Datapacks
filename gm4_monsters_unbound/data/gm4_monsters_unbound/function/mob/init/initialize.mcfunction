...
execute if entity @s[type=zombie] if predicate {type:"all_of",terms:[{type:"entity_properties",entity:"this",predicate:{flags:{is_baby:1b}}},{type:"inverted",term:{type:"entity_properties",entity:"this",predicate:{vehicle:{}}}}]} store success score $was_baby gm4_mu_data run data modify entity @s IsBaby set value 0b
