...
execute as @e[type=horse,distance=..8] if data entity @s ArmorItems[2].components."minecraft:custom_data"{gm4_furniture:"paintbrush"} run function gm4_furniture:technical/paintbrush/return_from_horse
