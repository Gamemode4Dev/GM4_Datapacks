...
execute as @e[type=horse,nbt={ArmorItems:[{components:{"minecraft:custom_data":{gm4_furniture:"paintbrush"}}}]}] at @s run function gm4_furniture:technical/paintbrush/remove_from_horse
