...
execute as @e[type=item_display,tag=gm4_furniture.display,distance=..8] if score @s gm4_furniture_id = $check_id gm4_furniture_id store result storage gm4_furniture:temp color.rgb int 1 run data get entity @s item.components."minecraft:dyed_color".rgb
