...
execute if score $holding_lighter gm4_furniture_data matches 1 store success score $ignited_candle gm4_furniture_data \
  run data modify entity @s item.components merge value {"minecraft:item_model":"gm4_furniture:wood_set/plain/light_1_lit","minecraft:custom_data":{gm4_furniture:{block_id:"light[level=15]"}}}
...
data modify entity @s item.components merge value {"minecraft:item_model":"gm4_furniture:wood_set/plain/light_1","minecraft:custom_data":{gm4_furniture:{block_id:"light[level=0]"}}}
