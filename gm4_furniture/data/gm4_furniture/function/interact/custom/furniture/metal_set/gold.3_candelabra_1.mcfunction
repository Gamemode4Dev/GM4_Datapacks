...
execute if score $holding_lighter gm4_furniture_data matches 1 store success score $ignited_candle gm4_furniture_data \
  run data modify entity @s item.components."minecraft:item_model" set value "gm4_furniture:metal_set/gold/3_candelabra_1_lit"
...
data modify entity @s item.components."minecraft:item_model" set value "gm4_furniture:metal_set/gold/3_candelabra_1"
