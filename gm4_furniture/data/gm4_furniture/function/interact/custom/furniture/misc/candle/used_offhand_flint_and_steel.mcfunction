# calculates damage for offhand flint and steel
...
# damage
execute store result score $unbreaking_level gm4_furniture_data run data get entity @s equipment.offhand.components."minecraft:enchantments"."minecraft:unbreaking"
...
execute if score $rand gm4_furniture_data < $damage_chance gm4_furniture_data run item modify entity @s weapon.offhand {"function":"minecraft:set_damage","damage":-0.0205,"add":true}
