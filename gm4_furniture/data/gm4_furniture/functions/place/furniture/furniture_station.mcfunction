...
data modify entity @e[type=item_display,tag=gm4_new_furniture,tag=gm4_furniture.tool_main,limit=1,distance=..2] item.tag.CustomModelData set from storage gm4_furniture:data furniture_station[0].cmd
data modify entity @e[type=item_display,tag=gm4_new_furniture,tag=gm4_furniture.tool_next,limit=1,distance=..2] item.tag.CustomModelData set from storage gm4_furniture:data furniture_station[1].cmd
data modify entity @e[type=item_display,tag=gm4_new_furniture,tag=gm4_furniture.tool_prev,limit=1,distance=..2] item.tag.CustomModelData set from storage gm4_furniture:data furniture_station[-1].cmd
execute unless score $waterlog gm4_furniture_data matches 1 run setblock ~ ~ ~ barrier
execute if score $waterlog gm4_furniture_data matches 1 run setblock ~ ~ ~ barrier[waterlogged=true]
...
scoreboard players set @e[type=wandering_trader,tag=gm4_new_furniture,limit=1] gm4_furniture_index 0
execute as @e[type=wandering_trader,tag=gm4_new_furniture,limit=1] at @s run function gm4_furniture:technical/furniture_station/build_trades/prep
