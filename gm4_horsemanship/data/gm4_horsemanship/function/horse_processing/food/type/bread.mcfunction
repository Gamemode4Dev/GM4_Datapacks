...
scoreboard players add $health gm4_horse_data 800
scoreboard players set $add_age gm4_horse_data 1600
scoreboard players add $temper gm4_horse_data 12
...
scoreboard players operation $add_stamina gm4_horse_data *= #4 gm4_horse_data
