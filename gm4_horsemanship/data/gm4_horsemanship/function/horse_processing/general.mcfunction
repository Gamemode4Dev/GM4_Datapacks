...
execute if score $mounted gm4_horse_data matches 1 on controller if predicate gm4_horsemanship:riding run scoreboard players set $riding gm4_horse_data 1
...
# wearing glider
execute if items entity @s armor.body *[custom_data~{gm4_horsemanship:{glider:{}}}] run function gm4_horsemanship:horse_processing/glider/process
