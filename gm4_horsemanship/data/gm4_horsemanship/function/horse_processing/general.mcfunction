...
# particle clocks
scoreboard players add @s gm4_horse_effect_clock 1
scoreboard players set @s[scores={gm4_horse_effect_clock=3..}] gm4_horse_effect_clock 0
...
# riding = -1
# swimming = -1
execute if score @s gm4_horse_need.graze matches 0 run scoreboard players remove @s[scores={gm4_horse_need.stamina=10..}] gm4_horse_need.stamina 10
...
execute if score @s[scores={gm4_horse_effect_clock=0}] gm4_horse_need.stamina matches 0 run playsound entity.horse.breathe neutral @a ~ ~ ~ 1 0.95
execute if score @s[scores={gm4_horse_effect_clock=1}] gm4_horse_need.stamina matches ..15 run playsound entity.horse.breathe neutral @a ~ ~ ~ 1 0.95
execute if score @s[scores={gm4_horse_effect_clock=2}] gm4_horse_need.stamina matches ..30 run playsound entity.horse.breathe neutral @a ~ ~ ~ 1 0.95
...
execute if score @s[scores={gm4_horse_effect_clock=2}] gm4_horse_need.graze matches 0 run playsound entity.horse.angry neutral @a ~ ~ ~ 0.5 0.875
...
# effects
execute unless score @s gm4_horse_need.brushing matches 100.. run particle block{block_state:"dirt"} ~ ~1 ~ 0.4 0.3 0.4 0 4
execute unless score @s[scores={gm4_horse_effect_clock=1}] gm4_horse_need.brushing matches 100.. run playsound block.rooted_dirt.step neutral @a ~ ~ ~ 0.5 0.925
...
# particles
execute if score $riding gm4_horse_data matches 0 if score @s[scores={gm4_horse_effect_clock=1}] gm4_horse_comfort matches ..49 anchored eyes run particle entity_effect{color:2130662741} ^ ^ ^ 0.3 0.1 0.3 0 4
execute if score $riding gm4_horse_data matches 0 if score @s[scores={gm4_horse_effect_clock=1}] gm4_horse_comfort matches 50..69 anchored eyes run particle entity_effect{color:1979689472} ^ ^ ^ 0.3 0.1 0.3 0 4
execute if score $riding gm4_horse_data matches 0 if score @s[scores={gm4_horse_effect_clock=1}] gm4_horse_comfort matches 70..89 anchored eyes run particle entity_effect{color:1884684117} ^ ^ ^ 0.3 0.1 0.3 0 4
execute if score $riding gm4_horse_data matches 0 if score @s[scores={gm4_horse_effect_clock=1}] gm4_horse_comfort matches 90.. anchored eyes run particle entity_effect{color:1811982848} ^ ^ ^ 0.3 0.1 0.3 0 4
...
scoreboard players operation $potential_loss gm4_horse_data > #25 gm4_horse_data

# particles
execute if score $riding gm4_horse_data matches 1 if score $potential_loss gm4_horse_data matches 25 anchored eyes run particle entity_effect{color:2130662741} ^ ^0.25 ^1 0.2 0.2 0.2 0 4
execute if score $riding gm4_horse_data matches 1 if score $potential_loss gm4_horse_data matches 26..50 anchored eyes run particle entity_effect{color:1979689472} ^ ^0.25 ^1 0.2 0.2 0.2 0 4
execute if score $riding gm4_horse_data matches 1 if score $potential_loss gm4_horse_data matches 51..89 anchored eyes run particle entity_effect{color:1884684117} ^ ^0.25 ^1 0.2 0.2 0.2 0 4
execute if score $riding gm4_horse_data matches 1 if score $potential_loss gm4_horse_data matches 90.. anchored eyes run particle entity_effect{color:1811982848} ^ ^0.25 ^1 0.2 0.2 0.2 0 4
...
scoreboard players operation @s gm4_horse_potential.realized > #0 gm4_horse_data
scoreboard players set @s[scores={gm4_horse_potential.realized=0}] gm4_horse_potential.total 0
