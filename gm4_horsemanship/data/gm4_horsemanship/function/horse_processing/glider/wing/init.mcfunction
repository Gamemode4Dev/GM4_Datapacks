...
execute store result entity @s[tag=gm4_horse.glider_wing.right] transformation.translation[0] float 0.0000625 run data get storage gm4_horsemanship:temp scale 1000
...
execute store result entity @s[tag=gm4_horse.glider_wing.left] transformation.translation[0] float -0.0003125 run data get storage gm4_horsemanship:temp scale 1000
...
execute store result entity @s transformation.translation[1] float -0.0002 run data get storage gm4_horsemanship:temp scale 1000
