...
summon item_display ~ ~ ~ {teleport_duration:1,Tags:["gm4_horse.glider_wing","gm4_horse.new_glider_wing","gm4_horse.glider_wing.right"],transformation:{scale:[2,2,2],left_rotation:[0,1.5,0,1],right_rotation:[-1,0,0,1],translation:[-0.375,0,0.9375]},Rotation:[90,0],item:{id:"feather",count:1,components:{custom_model_data:"item/horse_winged"}}}
summon item_display ~ ~ ~ {teleport_duration:1,Tags:["gm4_horse.glider_wing","gm4_horse.new_glider_wing","gm4_horse.glider_wing.left"],transformation:{scale:[2,2,2],left_rotation:[0,0.5,0,1],right_rotation:[1,0,0,1],translation:[0.125,0,1]},Rotation:[-90,0],item:{id:"feather",count:1,components:{custom_model_data:"item/horse_winged"}}}
