...
execute store result storage gm4_horsemanship:temp attribute.speed_start float 0.00001 run scoreboard players get $speed.start gm4_horse_data
...
execute store result storage gm4_horsemanship:temp attribute.jump_start float 0.00001 run scoreboard players get $jump.start gm4_horse_data
