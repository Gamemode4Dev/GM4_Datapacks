...
scoreboard players reset @a[scores={gm4_sg_swim=1..}] gm4_sg_swim
...
execute as @a[tag=gm4_in_water] at @s unless block ~ ~1 ~ water run function scuba_gear:remove_effect
