...
# register skulls
execute unless data storage gm4_player_heads:register heads[{id:"gm4_scuba_gear:scuba_helmet/v0"}] run data modify storage gm4_player_heads:register heads append value {id:"gm4_scuba_gear:scuba_helmet/v0",name:"[Drop to Fix Item] gm4_scuba_gear:scuba_helmet/v0",value:'',item:{CustomModelData:9,gm4_scuba_gear:{item:"helmet"},display:{Name:'{"translate":"%1$s%3427655$s","with":["SCUBA Helmet",{"translate":"item.gm4.scuba_helmet"}],"italic":false}'},AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Amount:2,Operation:0,UUID:[I;0,190244,0,554768],Slot:"head"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-.5,Operation:0,UUID:[I;0,193195,0,454101],Slot:"head"}]}}
