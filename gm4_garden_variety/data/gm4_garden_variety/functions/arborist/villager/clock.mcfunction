...
execute if score $current_time gm4_gv_arborist matches 2000..6000 run function gm4_garden_variety:arborist/villager/working
...
execute if entity @s[tag=gm4_gv_level_1] if score $xp_value gm4_gv_arborist matches 10.. run function gm4_garden_variety:arborist/villager/levels/level_2
...
execute if entity @s[tag=gm4_gv_level_2] if score $xp_value gm4_gv_arborist matches 70.. run function gm4_garden_variety:arborist/villager/levels/level_3
...
execute if entity @s[tag=gm4_gv_level_3] if score $xp_value gm4_gv_arborist matches 150.. run function gm4_garden_variety:arborist/villager/levels/level_4
...
execute if entity @s[tag=gm4_gv_level_4] if score $xp_value gm4_gv_arborist matches 250.. run function gm4_garden_variety:arborist/villager/levels/level_5
...
execute if score $look_at_job_site gm4_gv_arborist matches 1 if entity @s[tag=!gm4_gv_looking_at_job_site] run function gm4_garden_variety:arborist/villager/job/look_at_job_site
