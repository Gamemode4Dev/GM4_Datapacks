...
# complete
execute if score @s gm4_gv_analyze >= $analyzing_time_required gm4_gv_analyze run function gm4_garden_variety:arborist/analyzer/recipes/remove_name_tag/complete
