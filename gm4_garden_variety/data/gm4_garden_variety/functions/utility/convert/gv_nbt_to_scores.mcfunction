...
# clearance checker
execute if data storage gm4_garden_variety:convert/to_scores input.generation{clearance_checker:0b} run scoreboard players set $clearance_checker gm4_gv_nbt_data 0
