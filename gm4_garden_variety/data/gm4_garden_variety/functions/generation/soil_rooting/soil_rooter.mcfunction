...
execute at @s run function #gm4_garden_variety:generation/soil_rooting/place_block
...
execute if score $soil_rooting_loop gm4_gv_gen_data matches 1.. run function gm4_garden_variety:generation/soil_rooting/soil_rooter
