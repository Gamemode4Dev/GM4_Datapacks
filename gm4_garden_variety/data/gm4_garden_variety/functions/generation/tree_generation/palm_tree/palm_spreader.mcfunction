...
function #gm4_garden_variety:generation/tree_generation/variables/palm
...
execute as @e[type=marker,tag=gm4_tree_palm,limit=1,sort=nearest] at @s run function gm4_garden_variety:generation/tree_generation/palm_tree/palm
...
execute if score $palm_spreader_loop gm4_gv_gen_data matches 1.. run function gm4_garden_variety:generation/tree_generation/palm_tree/palm_spreader
