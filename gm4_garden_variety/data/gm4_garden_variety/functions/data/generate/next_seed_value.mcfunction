...
scoreboard players add $seed_used_eo4 gm4_gv_gen_data 1
...
execute if score $seed_used_eo4 gm4_gv_gen_data matches 1 run scoreboard players operation $current_seed gm4_gv_gen_data += $seed_used gm4_gv_gen_data
execute if score $seed_used_eo4 gm4_gv_gen_data matches 2 run scoreboard players operation $current_seed gm4_gv_gen_data += $seed gm4_gv_gen_data
execute if score $seed_used_eo4 gm4_gv_gen_data matches 3 run scoreboard players operation $current_seed gm4_gv_gen_data += $last_seed gm4_gv_gen_data
