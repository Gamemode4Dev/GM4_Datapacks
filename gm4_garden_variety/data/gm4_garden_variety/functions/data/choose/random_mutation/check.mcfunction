...
scoreboard players add $mutation_amount gm4_gv_nbt_data 2
...
execute if score $mutation_roll gm4_gv_nbt_data matches 2.. run function gm4_garden_variety:data/choose/random_mutation/success