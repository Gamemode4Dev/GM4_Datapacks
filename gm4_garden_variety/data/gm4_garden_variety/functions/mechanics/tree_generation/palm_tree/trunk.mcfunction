...
# summon leaf marker
execute if score $leaf_start_layer gm4_gv_gen_data = $current_trunk_layer gm4_gv_gen_data at @s run data modify storage gm4_garden_variety:debug/generation path append value "l"
