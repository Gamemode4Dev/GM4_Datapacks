...
scoreboard players operation $palm_spreader_loop gm4_gv_tree_gen = $adjusted_palm_amount gm4_gv_tree_gen
...
scoreboard players operation $leaf_segment_loop gm4_gv_tree_gen = $leaf_segments_split gm4_gv_tree_gen
...
scoreboard players operation $leaf_segment_loop gm4_gv_tree_gen = $leaf_segments_split gm4_gv_tree_gen
execute at @s run function #gm4_garden_variety:mechanics/tree_generation/leaf_segment
scoreboard players add $current_leaf_layer gm4_gv_tree_gen 1

# [Loop]
scoreboard players remove $leaf_layer_loop gm4_gv_tree_gen 1
execute if score $leaf_layer_loop gm4_gv_tree_gen matches 0 run kill @s
execute if score $leaf_layer_loop gm4_gv_tree_gen matches 1.. run function gm4_garden_variety:mechanics/tree_generation/palm_tree/leaf
