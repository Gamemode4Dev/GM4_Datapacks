...
scoreboard players operation @s gm4_fruit_stage = #apple_fruit_stage_0_start gm4_gv_fruit

# set age
scoreboard players operation @s gm4_fruit_age = #apple_fruit_stage_2_start gm4_gv_fruit
