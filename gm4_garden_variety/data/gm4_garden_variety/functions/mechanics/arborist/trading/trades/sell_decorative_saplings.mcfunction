...
# register trades
function #gm4_garden_variety:mechanics/arborist/register_trades/decorative_tree_sapling

# select random trade
data modify storage gm4_garden_variety:data/arborist random_trade set from entity @e[type=trader_llama,tag=gm4_gv_decorative_trade_option,limit=1,sort=random] {}
...
execute if score $trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:mechanics/arborist/trading/trades/sell_decorative_saplings