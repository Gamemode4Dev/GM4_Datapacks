...
execute as @s run loot replace entity @s weapon.mainhand loot gm4_garden_variety:mechanics/arborist/trades/barter_saplings/sell
...
execute as @s run loot replace entity @s weapon.mainhand loot gm4_garden_variety:mechanics/arborist/trades/barter_saplings/buy
...
execute as @s run loot replace entity @s weapon.mainhand loot gm4_garden_variety:mechanics/arborist/trades/barter_saplings/buyb
...
execute if score $trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:mechanics/arborist/trading/trades/barter_saplings