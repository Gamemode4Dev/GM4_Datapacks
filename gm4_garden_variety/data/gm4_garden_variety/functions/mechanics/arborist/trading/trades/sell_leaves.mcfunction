...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:mechanics/arborist/trades/sell_leaves/sell
...
# set trade item
loot replace entity @s weapon loot gm4_garden_variety:mechanics/arborist/trades/sell_leaves/buy
...
execute if score $trade_amount gm4_gv_trades matches 1.. run function gm4_garden_variety:mechanics/arborist/trading/trades/sell_blocks