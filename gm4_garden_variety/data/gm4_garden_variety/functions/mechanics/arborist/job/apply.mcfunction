...
# set random name
loot replace entity @s weapon loot gm4_garden_variety:mechanics/arborist/names
...
# give level 1 trades
execute at @s run function gm4_garden_variety:mechanics/arborist/levels/level_1
