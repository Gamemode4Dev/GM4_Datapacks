...
# spawn apple
execute if data entity @s[tag=gm4_ripe_apple_fruit] HandItems[0].id positioned ~0.5 ~1.5 ~0.5 run function gm4_garden_variety:mechanics/fruit_leaves/apple/spawn_fruit
