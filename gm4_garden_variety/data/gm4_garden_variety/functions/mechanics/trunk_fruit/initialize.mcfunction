...
execute if score $trunk_fruit_success gm4_gv_gen_data matches 1 as @e[type=marker,tag=gm4_trunk_fruit_marker,limit=1,sort=nearest] at @s run function gm4_garden_variety:mechanics/trunk_fruit/layer
