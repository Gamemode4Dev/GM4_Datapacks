...
execute if score $soil_conversion_max gm4_gv_gen_data matches 1.. at @s positioned ^ ^ ^1 run function gm4_garden_variety:mechanics/soil_conversion/check_block
...
execute if score $soil_converter_loop gm4_gv_gen_data matches 1.. run function gm4_garden_variety:mechanics/soil_conversion/converter
