...
scoreboard players set $analyzing_time_addition gm4_gv_analyzer 1
scoreboard players operation $analyzing_time_addition gm4_gv_analyzer *= $slot_1_amount gm4_gv_analyzer 
scoreboard players remove $analyzing_time_addition gm4_gv_analyzer 1
...
execute if score $analyzing_time_required gm4_gv_analyzer matches 61.. run scoreboard players set $analyzing_time_required gm4_gv_analyzer 60
...
# complete
execute if score @s gm4_gv_analyzer >= $analyzing_time_required gm4_gv_analyzer run function gm4_garden_variety:mechanics/analyzer/recipes/convert_sapling/complete
