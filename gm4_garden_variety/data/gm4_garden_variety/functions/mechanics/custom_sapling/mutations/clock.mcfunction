...
# set random chance
scoreboard players set $mutation_chance_pool gm4_gv_mutations 500
...
# gain mutation
execute if score $mutation_chance_roll gm4_gv_mutations matches ..1 run function gm4_garden_variety:mechanics/custom_sapling/mutations/gain_mutation
