...
# move forward
scoreboard players add $ray gm4_gv_gen_data 1
tp @s ^ ^ ^0.01
execute if score $ray gm4_gv_gen_data matches 0..500 at @s unless score $found gm4_gv_gen_data matches 1 run function gm4_garden_variety:mechanics/custom_sapling/ray
