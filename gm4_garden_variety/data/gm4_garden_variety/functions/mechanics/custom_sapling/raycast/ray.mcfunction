...
tp @s ^ ^ ^0.01
execute if score $ray gm4_gv_tree_gen matches 0..500 at @s unless score $found gm4_gv_tree_gen matches 1 run function gm4_garden_variety:mechanics/custom_sapling/raycast/ray
