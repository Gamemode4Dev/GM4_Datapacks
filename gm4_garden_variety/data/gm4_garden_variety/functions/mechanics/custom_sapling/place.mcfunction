...
# check 5 blocks
execute as @e[type=marker,tag=gm4_tree_ray,limit=1] at @s run function gm4_garden_variety:mechanics/custom_sapling/raycast/ray
...
execute unless score $found gm4_gv_tree_gen matches 1 as @e[type=marker,tag=gm4_tree_ray,limit=1] at @s run function gm4_garden_variety:mechanics/custom_sapling/raycast/ray_backup
