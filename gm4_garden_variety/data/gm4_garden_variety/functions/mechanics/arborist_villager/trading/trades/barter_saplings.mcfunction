# gives the villager the barter_saplings trade
...
# set trade item
data modify entity @s HandItems[1] set from storage gm4_garden_variety:arborist last_sell.sell
...
# set trade item
data modify entity @s ArmorItems[0] set from storage gm4_garden_variety:arborist next_trade.sell
...
# set trade item
data modify entity @s ArmorItems[1] set from storage gm4_garden_variety:arborist next_trade.buy
execute as @s run loot replace entity @s weapon.mainhand loot gm4_garden_variety:arborist/trades/barter_saplings/buyb
data modify storage gm4_garden_variety:arborist next_trade.buyB set from entity @s HandItems[0]
data modify storage gm4_garden_variety:test test set from storage gm4_garden_variety:arborist next_trade.buyb
