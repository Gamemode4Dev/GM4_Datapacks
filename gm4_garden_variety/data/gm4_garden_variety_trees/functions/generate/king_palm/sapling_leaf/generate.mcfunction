...
# store nbt
data modify entity @e[type=marker,distance=..1,limit=1,tag=gm4_gv_new_sapling_leaf] data.gm4_garden_variety set from storage gm4_garden_variety:data/garden_variety_nbt tree_offspring
