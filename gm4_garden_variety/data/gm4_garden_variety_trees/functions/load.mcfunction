...
execute unless score gm4 load matches 1 run data modify storage gm4:log queue append value {type:"missing",module:"Garden Variety Trees",require:"Gamemode 4"}
execute unless score gm4_garden_variety load matches 1 run data modify storage gm4:log queue append value {type:"missing",module:"Garden Variety Trees",require:"Garden Variety"}
