...
execute if score king_palm gm4_tree_type matches 1 run function gm4_natural_trees:generate/king_palm/integration/garden_variety/generation/leaf_segment
