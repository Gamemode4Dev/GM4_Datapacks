...
# king palm tree
execute if score beach gm4_orbis_biome matches 1 if predicate gm4_garden_variety:biome/beach if block ~ 31 ~ minecraft:stone positioned ~6 248 ~12 run function gm4_natural_trees:generate/king_palm/integration/orbis/scan_column
