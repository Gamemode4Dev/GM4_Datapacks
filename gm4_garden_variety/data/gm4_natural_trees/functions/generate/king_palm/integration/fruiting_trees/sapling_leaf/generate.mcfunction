...
# store nbt
data modify entity @e[type=marker,distance=..1,limit=1,tag=gm4_fruiting_leaf_new] data.gm4_garden_variety set from storage gm4_garden_variety:data/garden_variety nbt
