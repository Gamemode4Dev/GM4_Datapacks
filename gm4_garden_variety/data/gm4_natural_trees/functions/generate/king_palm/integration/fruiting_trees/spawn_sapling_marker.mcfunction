...
# store nbt
execute positioned ~0.5 ~ ~0.5 run data modify entity @e[type=marker,distance=..1,limit=1,tag=gm4_king_palm_sapling,sort=nearest] data.gm4_garden_variety set from storage gm4_garden_variety:data/garden_variety_nbt place_sapling
