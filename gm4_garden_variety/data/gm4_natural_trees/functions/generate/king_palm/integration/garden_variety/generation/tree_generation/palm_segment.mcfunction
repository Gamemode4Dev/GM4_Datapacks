...
execute if score $palm_segment_loop gm4_gv_gen_data matches 1.. run function gm4_natural_trees:generate/king_palm/integration/garden_variety/generation/tree_generation/palm_segment
