...
execute as @e[type=item_frame,tag=!smithed.entity,tag=!gm4_hologram] if items entity @s contents *[custom_name] at @s positioned ^ ^ ^0.3 positioned ~ ~-.3 ~ unless entity @e[type=area_effect_cloud,tag=gm4_hologram,distance=..0.1] run function gm4_holographic_tags:create_hologram
...
execute as @e[type=glow_item_frame,tag=!smithed.entity,tag=!gm4_hologram] if items entity @s contents *[custom_name] at @s positioned ^ ^ ^0.3 positioned ~ ~-.3 ~ unless entity @e[type=area_effect_cloud,tag=gm4_hologram,distance=..0.1] run function gm4_holographic_tags:create_hologram
