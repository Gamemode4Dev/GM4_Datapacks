...
execute if score gm4_pig_tractors load matches 1 run function pig_tractors:init
execute unless score gm4_pig_tractors load matches 1 run schedule clear pig_tractors:tick
