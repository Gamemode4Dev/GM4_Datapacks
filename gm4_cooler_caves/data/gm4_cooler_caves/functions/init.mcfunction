...
# guidebook
summon marker ~ 736.421522857372 ~ {CustomName:'"gm4_cooler_caves_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"orbis",id:"cooler_caves",page_count:1,line_count:1,module_name:"Cooler Caves"}}
