...
execute if score @s gm4_slot_count matches 1 if score @s gm4_stack_size matches ..32 if data storage gm4_custom_crafters:temp/crafter {Items:[{Slot:0b,id:"minecraft:cut_sandstone_slab"}]} run data merge storage gm4_custom_crafters:temp/crafter {Items:[{Slot:8,id:"sand",Count:1b,tag:{gm4_custom_crafters:{multiplier:2}}}]}
execute if score @s gm4_slot_count matches 1 if score @s gm4_stack_size matches ..32 if data storage gm4_custom_crafters:temp/crafter {Items:[{Slot:0b,id:"minecraft:smooth_sandstone_slab"}]} run data merge storage gm4_custom_crafters:temp/crafter {Items:[{Slot:8,id:"sand",Count:1b,tag:{gm4_custom_crafters:{multiplier:2}}}]}
...
execute if score @s gm4_slot_count matches 1 if score @s gm4_stack_size matches ..32 if data storage gm4_custom_crafters:temp/crafter {Items:[{Slot:0b,id:"minecraft:cut_red_sandstone_slab"}]} run data merge storage gm4_custom_crafters:temp/crafter {Items:[{Slot:8,id:"red_sand",Count:1b,tag:{gm4_custom_crafters:{multiplier:2}}}]}
execute if score @s gm4_slot_count matches 1 if score @s gm4_stack_size matches ..32 if data storage gm4_custom_crafters:temp/crafter {Items:[{Slot:0b,id:"minecraft:smooth_red_sandstone_slab"}]} run data merge storage gm4_custom_crafters:temp/crafter {Items:[{Slot:8,id:"red_sand",Count:1b,tag:{gm4_custom_crafters:{multiplier:2}}}]}
