...
scoreboard objectives add gm4_aa_health.current dummy
scoreboard objectives add gm4_aa_health.max dummy
scoreboard objectives add gm4_aa_health.max_half dummy
