...
# totem
execute unless score $keep_tick.totem gm4_aa_keep_tick matches 1 if entity @e[type=armor_stand,tag=gm4_aa_totem] run schedule function gm4_augmented_armor:clocks/temp/totem 1t
