...
execute as @e[type=wolf,tag=gm4_aa_wolf] run function gm4_augmented_armor:armor/modifier/type/canine/wolf_process
# sword_ring
...
execute if score $natural_regen gm4_aa_data matches 0 as @a[gamemode=!spectator,tag=gm4_aa_sustain_active] unless score @s[scores={gm4_aa_hunger=18..}] gm4_aa_combat_regen_timer matches 1.. run function gm4_augmented_armor:armor/modifier/type/sustain/extra_regen
