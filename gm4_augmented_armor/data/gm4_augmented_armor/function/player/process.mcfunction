...
execute if entity @s[tag=!gm4_aa_wearing_archer,predicate=gm4_augmented_armor:modified_armor/archer] run function gm4_augmented_armor:armor/modifier/type/archer/activate
