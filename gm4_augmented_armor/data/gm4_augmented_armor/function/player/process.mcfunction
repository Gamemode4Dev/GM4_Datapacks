...
# remove dashing sprint score if player didn't sprint for too long
...
scoreboard players add @s[scores={gm4_aa_augment.dashing.timer=..-1}] gm4_aa_augment.dashing.timer 1
