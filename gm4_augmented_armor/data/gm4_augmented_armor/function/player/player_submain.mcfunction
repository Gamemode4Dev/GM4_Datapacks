...
# apply equine speed effect
execute as @a on vehicle if score @s gm4_aa_augment.equine.speed_level matches 1.. run function gm4_augmented_armor:armor/augment/type/equine/apply_effect
