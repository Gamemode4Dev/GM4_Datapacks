...
execute if score $level_1_mult gm4_aa_data matches 2.. run scoreboard players operation $level_1 gm4_aa_data *= $level_1_mult gm4_aa_data
...
execute if score $level_2_mult gm4_aa_data matches 2.. run scoreboard players operation $level_2 gm4_aa_data *= $level_2_mult gm4_aa_data
...
execute if score $level_3_mult gm4_aa_data matches 2.. run scoreboard players operation $level_3 gm4_aa_data *= $level_3_mult gm4_aa_data
...
execute if score $level_4_mult gm4_aa_data matches 2.. run scoreboard players operation $level_4 gm4_aa_data *= $level_4_mult gm4_aa_data
