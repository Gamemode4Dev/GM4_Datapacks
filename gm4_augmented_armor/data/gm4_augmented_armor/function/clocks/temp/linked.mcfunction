...
# @s = unspecified
# at unspecified
# schedule from amor/augment/type/linked/check
# schedule from here
...
execute if score $keep_tick.link gm4_aa_keep_tick matches 1 run schedule function gm4_augmented_armor:clocks/temp/linked 1t
