...
execute as @a[predicate=gm4_augmented_armor:modified_armor/radiant,gamemode=!spectator] at @s run function gm4_augmented_armor:armor/augment/type/radiant/prep
...
execute if score $keep_tick.radiant gm4_aa_keep_tick matches 1 run schedule function gm4_augmented_armor:clocks/temp/radiant 1t
