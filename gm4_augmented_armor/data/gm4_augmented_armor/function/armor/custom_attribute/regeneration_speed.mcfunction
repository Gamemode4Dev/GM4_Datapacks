...
scoreboard players operation $add_regen_speed gm4_aa_data *= @s gm4_sr_stat.regeneration_rate_base
scoreboard players operation $add_regen_speed gm4_aa_data /= #100 gm4_aa_data
