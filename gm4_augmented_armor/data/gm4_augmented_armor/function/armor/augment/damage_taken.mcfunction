...
execute if score $augment gm4_aa_data matches 12 if score @s gm4_sr_armor matches 1.. run function gm4_augmented_armor:armor/augment/type/plated/reduce_damage
execute if score $augment gm4_aa_data matches 13 if score @s gm4_sr_armor matches 1.. run function gm4_augmented_armor:armor/augment/type/sturdy/reduce_damage
