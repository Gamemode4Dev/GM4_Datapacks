...
execute if score $augment gm4_aa_data matches 11 unless score @s gm4_ce_combat_regen_timer matches 1.. unless score @s gm4_aa_t_shield matches 1.. run function gm4_augmented_armor:armor/augment/type/shielded/add_level
