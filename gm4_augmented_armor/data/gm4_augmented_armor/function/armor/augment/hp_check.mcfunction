...
execute if score $augment gm4_aa_data matches 45 if score @s gm4_sr_health.percentage matches ..50 run function gm4_augmented_armor:armor/augment/type/sustain/activate
