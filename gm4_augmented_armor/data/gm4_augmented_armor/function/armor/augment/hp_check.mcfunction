...
execute if score $augment gm4_aa_data matches 45 if score @s gm4_sr_health.current <= @s gm4_sr_health.max_half run function gm4_augmented_armor:armor/augment/type/sustain/activate
execute if score $augment gm4_aa_data matches 51 run function gm4_augmented_armor:armor/augment/type/immune/get_immunities
# either
