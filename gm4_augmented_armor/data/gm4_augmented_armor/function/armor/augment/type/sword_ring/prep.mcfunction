...
function gm4_augmented_armor:armor/augment/type/sword_ring/get_relevant_data
...
execute if predicate gm4_augmented_armor:technical/crouching run function gm4_augmented_armor:armor/augment/type/sword_ring/set_stats_crouching
execute if score $stats_set gm4_aa_data matches 0 run function gm4_augmented_armor:armor/augment/type/sword_ring/set_stats
