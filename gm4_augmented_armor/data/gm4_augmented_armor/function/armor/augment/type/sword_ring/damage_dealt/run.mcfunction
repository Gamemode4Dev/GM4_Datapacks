...
# at player rotated ~x ~
# run from armor/augment/type/sword_ring/move_sword
...
execute if score $player_creative gm4_aa_data matches 0 run function gm4_augmented_armor:armor/augment/type/sword_ring/damage_dealt/durability
