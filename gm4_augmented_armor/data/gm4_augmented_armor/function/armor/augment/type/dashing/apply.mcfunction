...
# @s = player wearing dashing armour above 50% health and sprinting
# at unspecified
# run from armor/augment/clocked

# advance sprinting timer (can advance by 1 for every dashing armor piece) if player is sprinting
