...
data modify storage gm4_lore:temp Target set value '{"color":"gray","fallback":"When Low on Health:","italic":false,"translate":"item.gm4.augmented_armor.lore.low_hp"}'
$data modify storage gm4_lore:temp Input set value ['{"color":"dark_gray","fallback":"Kills: %s/%s","italic":false,"translate":"item.gm4.augmented_armor.lore.soothe_recharge","with":["$(recharge)","$(max_charge)"]}']
scoreboard players set $start gm4_lore 2
