...
execute unless score @s gm4_aa_t_soothe matches 1.. at @s if score $active gm4_aa_data matches 0 if score @s gm4_sr_health.percentage matches ..50 run function gm4_augmented_armor:armor/augment/type/soothe/activate
