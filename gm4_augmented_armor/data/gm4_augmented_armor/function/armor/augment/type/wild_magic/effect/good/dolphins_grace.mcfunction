...
data modify storage gm4_augmented_armor:temp wild_magic.id set value "dolphins_grace"

# Duration
execute store result storage gm4_augmented_armor:temp wild_magic.duration int 1 run random value 45..180
