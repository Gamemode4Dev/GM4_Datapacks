...
execute store result score $attack_reach gm4_aa_data run attribute @s minecraft:entity_interaction_range get 15

# time to explode based on attack speed
execute store result score $attack_speed gm4_aa_data run attribute @s minecraft:attack_speed get 100
