...
execute if data storage gm4_augmented_armor:temp components."minecraft:custom_data".gm4_augmented_armor{augment:convert} run function gm4_augmented_armor:armor/augment/type/convert/calc_conversion
