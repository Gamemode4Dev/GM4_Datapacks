...
execute store result storage gm4_augmented_armor:temp psychic.scale float 0.1 run attribute @s scale get 10
...
execute store result storage gm4_augmented_armor:temp psychic.offset float 0.075 run attribute @s entity_interaction_range get 10
