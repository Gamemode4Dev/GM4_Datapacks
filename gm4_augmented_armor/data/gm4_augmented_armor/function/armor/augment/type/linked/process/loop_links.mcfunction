...
execute if score $link_players gm4_aa_data matches 1 as @p[tag=gm4_aa_link.process] run function gm4_augmented_armor:armor/augment/type/linked/process/one_player_link
execute if score $link_players gm4_aa_data matches 2.. run function gm4_augmented_armor:armor/augment/type/linked/process/process_link

# check for more links
data remove storage gm4_augmented_armor:temp run_links[0]
execute if data storage gm4_augmented_armor:temp run_links[0] run function gm4_augmented_armor:armor/augment/type/linked/process/loop_links
