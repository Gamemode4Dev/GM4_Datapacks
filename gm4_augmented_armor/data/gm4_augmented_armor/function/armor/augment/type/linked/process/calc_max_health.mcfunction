...
execute as @a[tag=gm4_aa_link.process] run scoreboard players operation $link_max_health gm4_aa_data += @s gm4_aa_augment.link.max_health
...
execute as @a[tag=gm4_aa_link.process] run function gm4_augmented_armor:armor/augment/type/linked/process/calc_max_health_change
