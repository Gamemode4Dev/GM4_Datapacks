...
execute store result storage gm4_augmented_armor:temp run_links[0].health int 1 run scoreboard players get @s gm4_sr_stat.current_health

scoreboard players set $set_max_health gm4_aa_data 0
execute if score $link.calc_max_health gm4_aa_data matches 1 run function gm4_augmented_armor:armor/augment/type/linked/process/set_max_health
