...
data modify storage gm4_augmented_armor:temp check_rename set from storage gm4_augmented_armor:temp components."minecraft:custom_data".gm4_augmented_armor.augment.stored_name
execute store success score $renamed gm4_aa_data run data modify storage gm4_augmented_armor:temp check_rename set from storage gm4_augmented_armor:temp components."minecraft:custom_name"
# if it has format it
...
execute if score $renamed gm4_aa_data matches 1 run function gm4_augmented_armor:armor/augment/type/linked/format_name with storage gm4_augmented_armor:temp format_name_args
...
function gm4_augmented_armor:armor/augment/type/linked/search_links
...
execute if score @s gm4_aa_augment.link.id matches 0 run function gm4_augmented_armor:armor/augment/type/linked/create_link
...
# start clock
execute unless score $keep_tick.link gm4_aa_keep_tick matches 1 run schedule function gm4_augmented_armor:clocks/temp/linked 1t
