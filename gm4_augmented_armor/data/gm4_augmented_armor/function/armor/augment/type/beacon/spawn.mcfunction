...
scoreboard players operation @e[type=block_display,tag=gm4_aa_beacon.process] gm4_aa_id = $player_id gm4_aa_id 

execute store result score $light_colour gm4_aa_data run random value 1..3
execute if score $light_colour gm4_aa_data matches 2 as @e[type=block_display,tag=gm4_aa_beacon.process] on passengers run data modify entity @s block_state.Name set value "minecraft:pearlescent_froglight"
execute if score $light_colour gm4_aa_data matches 3 as @e[type=block_display,tag=gm4_aa_beacon.process] on passengers run data modify entity @s block_state.Name set value "minecraft:ochre_froglight"
