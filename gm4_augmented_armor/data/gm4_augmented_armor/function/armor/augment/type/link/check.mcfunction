...
execute unless score @s gm4_aa_health.current matches 1.. run return 0
...
execute if score @s gm4_aa_link_id matches 1.. if score $slot gm4_aa_data matches 0 store success score $change gm4_aa_data run data modify storage gm4_augmented_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_augmented_armor:head.dynamic"}].amount set value 0
execute if score @s gm4_aa_link_id matches 1.. if score $slot gm4_aa_data matches 1 store success score $change gm4_aa_data run data modify storage gm4_augmented_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_augmented_armor:chest.dynamic"}].amount set value 0
execute if score @s gm4_aa_link_id matches 1.. if score $slot gm4_aa_data matches 2 store success score $change gm4_aa_data run data modify storage gm4_augmented_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_augmented_armor:legs.dynamic"}].amount set value 0
execute if score @s gm4_aa_link_id matches 1.. if score $slot gm4_aa_data matches 3 store success score $change gm4_aa_data run data modify storage gm4_augmented_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_augmented_armor:feet.dynamic"}].amount set value 0
execute if score @s gm4_aa_link_id matches 1.. run return 0

# loop through links to find the one this player belongs to
scoreboard players set @s gm4_aa_link_id 0
...
execute if score $wrong_link gm4_aa_data matches 0 store result score @s gm4_aa_link_id run data get storage gm4_augmented_armor:temp search_links.list[0].id
data remove storage gm4_augmented_armor:temp search_links

# if an id was found no need to put a new entry in storage
execute if score @s gm4_aa_link_id matches 0 run function gm4_augmented_armor:armor/augment/type/link/create_link
...
execute if score $slot gm4_aa_data matches 3 store result score @s gm4_aa_link_max_health run data get storage gm4_augmented_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_augmented_armor:feet.dynamic"}].amount -1
scoreboard players operation @s gm4_aa_link_max_health += @s gm4_aa_health.max
...
scoreboard players operation @s gm4_aa_link_slot = $slot gm4_aa_data
