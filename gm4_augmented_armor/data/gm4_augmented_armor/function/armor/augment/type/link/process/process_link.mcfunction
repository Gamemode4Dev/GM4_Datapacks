...
execute if score $link.calc_max_health gm4_aa_data matches 1 run function gm4_augmented_armor:armor/augment/type/link/process/calc_max_health
...
execute as @a[tag=gm4_aa_link.process,tag=gm4_aa_was_linked] run function gm4_augmented_armor:armor/augment/type/link/process/calc_health_change
...
execute if score $link_health gm4_aa_data matches 1.. as @a[tag=gm4_aa_link.process] run function gm4_augmented_armor:armor/augment/type/link/process/set_health
execute unless score $link_health gm4_aa_data matches 1.. run function gm4_augmented_armor:armor/augment/type/link/process/death
