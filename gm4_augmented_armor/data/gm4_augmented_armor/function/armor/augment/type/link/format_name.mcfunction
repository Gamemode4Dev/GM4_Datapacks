...
$data modify storage gm4_augmented_armor:temp components."minecraft:custom_name" set value '{"translate":"item.gm4.augmented_armor.name.link_no_translate","fallback":$(name),"italic":false,"color":"light_purple"}'
...
data modify storage gm4_lore:temp Target set value '{"translate":"item.gm4.augmented_armor.lore.link_2","fallback":"Rename to Link","italic":false,"color":"blue"}'
function #gm4_lore:remove
data modify storage gm4_lore:temp Target set value '{"translate":"item.gm4.augmented_armor.lore.link_3","fallback":"Lifelink","italic":false,"color":"dark_gray"}'
data modify storage gm4_lore:temp Input set value ['{"translate":"item.gm4.augmented_armor.lore.link_3","fallback":"Lifelink","italic":false,"color":"blue"}']
