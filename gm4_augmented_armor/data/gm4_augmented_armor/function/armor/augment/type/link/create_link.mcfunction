...
execute store result storage gm4_augmented_armor:temp new_link.id int 1 run scoreboard players add $latest_id gm4_aa_link_id 1
execute store result storage gm4_augmented_armor:temp new_link.health int 1 run scoreboard players get @s gm4_aa_health.current
...
scoreboard players operation @s gm4_aa_link_id = $latest_id gm4_aa_link_id
