...
scoreboard players operation @s gm4_sr_healstore -= $damage_health gm4_aa_data

# pause regen next tick if damaged
tag @s[scores={gm4_sr_healstore=..-1}] add gm4_aa_pause_nat_regen

# change player health
execute if score @s gm4_sr_healstore matches 1.. run function gm4_augmented_armor:player/heal/heal_calc
execute if score @s gm4_sr_healstore matches ..-1 run function gm4_augmented_armor:player/damage/activate
