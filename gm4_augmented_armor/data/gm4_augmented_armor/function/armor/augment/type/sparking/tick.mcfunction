...
execute store result storage gm4_augmented_armor:temp lightning.scale float 0.0075 run attribute @s generic.scale get 100
execute store result storage gm4_augmented_armor:temp lightning.height float 0.0133 run attribute @s generic.scale get 100
