...
scoreboard players operation $missing_health gm4_aa_data = @s gm4_sr_stat.max_health
scoreboard players operation $missing_health gm4_aa_data -= @s gm4_sr_stat.current_health
