...
execute unless entity @e[type=block_display,tag=gm4_aa_beacon.process,distance=..12] run function gm4_augmented_armor:armor/modifier/type/beacon/spawn
...
execute as @e[type=block_display,tag=gm4_aa_beacon.process,distance=..12] run function gm4_augmented_armor:armor/modifier/type/beacon/process
