...
execute if score $renamed gm4_aa_data matches 1 run function gm4_augmented_armor:armor/modifier/type/link/format_name with storage gm4_augmented_armor:temp format_name_args
...
execute if score @s gm4_aa_link_id matches 1.. store success score $change gm4_aa_data run data modify storage gm4_augmented_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_augmented_armor:dynamic"}].amount set value 0
...
function gm4_augmented_armor:armor/modifier/type/link/search_links
...
execute if score @s gm4_aa_link_id matches 0 run function gm4_augmented_armor:armor/modifier/type/link/create_link
...
function gm4_survival_refightalized:player/calculate_hp
execute store result score @s gm4_aa_link_max_health run data get storage gm4_augmented_armor:temp components."minecraft:attribute_modifiers".modifiers[{id:"gm4_augmented_armor:dynamic"}].amount -1
