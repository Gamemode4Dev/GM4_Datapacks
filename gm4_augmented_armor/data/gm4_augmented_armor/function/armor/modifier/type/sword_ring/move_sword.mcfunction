...
execute unless score @s gm4_aa_data = $sword_material gm4_aa_data run function gm4_augmented_armor:armor/modifier/type/sword_ring/change_material
...
execute if score $damage_dealt gm4_aa_data matches 1 at @s run function gm4_augmented_armor:armor/modifier/type/sword_ring/damage_dealt/run
