...
execute if data storage gm4_augmented_armor:temp Items[{Slot:0b}].components."minecraft:custom_data".gm4_augmented_armor{modifier:toxic} store result score $level gm4_aa_data run data get storage gm4_augmented_armor:temp Items[{Slot:0b}].components."minecraft:custom_data".gm4_augmented_armor.level
...
scoreboard players set $level gm4_aa_data 0
execute if data storage gm4_augmented_armor:temp Items[{Slot:1b}].components."minecraft:custom_data".gm4_augmented_armor{modifier:toxic} store result score $level gm4_aa_data run data get storage gm4_augmented_armor:temp Items[{Slot:1b}].components."minecraft:custom_data".gm4_augmented_armor.level
execute if score $level gm4_aa_data matches 1 run scoreboard players add $level.poison gm4_aa_data 1
execute if score $level gm4_aa_data matches 2 run scoreboard players add $level.weakness gm4_aa_data 1
execute if score $level gm4_aa_data matches 3 run scoreboard players add $level.instant_health gm4_aa_data 1

scoreboard players set $level gm4_aa_data 0
execute if data storage gm4_augmented_armor:temp Items[{Slot:2b}].components."minecraft:custom_data".gm4_augmented_armor{modifier:toxic} store result score $level gm4_aa_data run data get storage gm4_augmented_armor:temp Items[{Slot:2b}].components."minecraft:custom_data".gm4_augmented_armor.level
execute if score $level gm4_aa_data matches 1 run scoreboard players add $level.poison gm4_aa_data 1
execute if score $level gm4_aa_data matches 2 run scoreboard players add $level.weakness gm4_aa_data 1
execute if score $level gm4_aa_data matches 3 run scoreboard players add $level.instant_health gm4_aa_data 1

scoreboard players set $level gm4_aa_data 0
execute if data storage gm4_augmented_armor:temp Items[{Slot:3b}].components."minecraft:custom_data".gm4_augmented_armor{modifier:toxic} store result score $level gm4_aa_data run data get storage gm4_augmented_armor:temp Items[{Slot:3b}].components."minecraft:custom_data".gm4_augmented_armor.level
execute if score $level gm4_aa_data matches 1 run scoreboard players add $level.poison gm4_aa_data 1
execute if score $level gm4_aa_data matches 2 run scoreboard players add $level.weakness gm4_aa_data 1
execute if score $level gm4_aa_data matches 3 run scoreboard players add $level.instant_health gm4_aa_data 1
