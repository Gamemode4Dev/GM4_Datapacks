...
execute as @e[type=marker,tag=gm4_aa_vorpal] run function gm4_augmented_armor:armor/modifier/type/vorpal/eval_failsafe with storage gm4_augmented_armor:temp vorpal
data remove storage gm4_augmented_armor:temp vorpal

# teleport
function gm4_augmented_armor:armor/modifier/type/vorpal/tp_player
