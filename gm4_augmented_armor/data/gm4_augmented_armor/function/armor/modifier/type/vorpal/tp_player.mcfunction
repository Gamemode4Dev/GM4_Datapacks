...
# effects
execute if score $warp_safe gm4_aa_data matches 1.. at @e[type=marker,tag=gm4_aa_vorpal] align xyz run tp @s ~0.5 ~ ~0.5
kill @e[type=marker,tag=gm4_aa_vorpal]
...
# advancement
advancement grant @s only gm4:augmented_armor_vorpal
