...
execute if data storage gm4_augmented_armor:temp components."minecraft:custom_data".gm4_augmented_armor{modifier:convert} run function gm4_augmented_armor:armor/modifier/type/convert/calc_conversion
...
advancement revoke @s only gm4_augmented_armor:wear_convert
