...
execute if data storage gm4_augmented_armor:temp attribute_modifiers[0] run function gm4_augmented_armor:armor/modifier/type/convert/loop_attribute_modifiers
