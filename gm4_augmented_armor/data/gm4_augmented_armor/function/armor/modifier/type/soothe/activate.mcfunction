...
execute positioned ~ ~.6 ~ summon marker at @s run function gm4_augmented_armor:armor/modifier/type/soothe/particles
...
function gm4_augmented_armor:armor/modifier/type/soothe/recharge_text with storage gm4_augmented_armor:temp components."minecraft:custom_data".gm4_augmented_armor
