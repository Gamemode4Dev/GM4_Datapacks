...
execute if score continue gm4_player_heads matches 1 if data storage gm4_player_heads:register temp[0] run function gm4_player_heads-1.1:repair_with_name
