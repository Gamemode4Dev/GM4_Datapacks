...
execute if data storage gm4_player_heads:register name run function gm4_player_heads-1.1:repair_with_name
execute if data storage gm4_player_heads:register texture run function gm4_player_heads-1.1:repair_with_texture
