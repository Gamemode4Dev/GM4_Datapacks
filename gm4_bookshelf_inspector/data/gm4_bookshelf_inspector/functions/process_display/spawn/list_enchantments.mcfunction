...
data modify storage gm4_bookshelf_inspector:temp enchantments set from storage gm4_bookshelf_inspector:temp book_data.components."minecraft:stored_enchantments"
