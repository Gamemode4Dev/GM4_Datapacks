...
#recursion
execute positioned ~-1 ~ ~ if block ~ ~ ~ #crossbow_cables:airtype if score @s gm4_string_count matches 1.. if score string_placed gm4_string_count matches ..39 run function crossbow_cables:unspool_string_west