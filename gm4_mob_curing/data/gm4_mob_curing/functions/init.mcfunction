...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 2791.573318812042 ~ {CustomName:'"gm4_mob_curing_guide"',Tags:["gm4_guide"],data:{type:"module",id:"mob_curing",page_count:3,line_count:1,module_name:"Mob Curing"}}
