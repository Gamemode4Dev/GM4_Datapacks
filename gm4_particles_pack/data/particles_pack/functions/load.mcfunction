execute if score gm4 load matches 1 if score gm4_better_armour_stands load matches 1 run scoreboard players set gm4_particles_pack load 1
...
execute if score gm4_particles_pack load matches 1 run function particles_pack:init
