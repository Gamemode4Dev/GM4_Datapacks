...
execute if score @s gm4_particle matches 9 run particle minecraft:falling_dust minecraft:snow ~ ~.5 ~ 8 0 8 1 10
...
execute if score @s gm4_particle matches 17 run particle minecraft:portal ~ ~1 ~ 0 0 0 1 5
execute if score @s gm4_particle matches 18 run particle minecraft:enchant ~ ~1 ~ 0 0 0 1 5
