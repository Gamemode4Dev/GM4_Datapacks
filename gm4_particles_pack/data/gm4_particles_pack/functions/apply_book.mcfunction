...
execute if entity @s[nbt={Item:{tag:{pages:["snow"]}}}] run scoreboard players set @e[type=armor_stand,distance=..1,limit=1,sort=nearest,tag=!gm4_no_edit] gm4_particle 9
