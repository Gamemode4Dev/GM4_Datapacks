...
# guidebook
summon marker ~ 3307.180186041202 ~ {CustomName:'"gm4_particles_pack_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"better_armour_stands",id:"particles_pack",page_count:1,line_count:1,module_name:"Particles Pack"}}
