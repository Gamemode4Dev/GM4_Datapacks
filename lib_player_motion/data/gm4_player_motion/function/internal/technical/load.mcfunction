#> gm4_player_motion-1.4:internal/technical/load
# LOAD FUNCTION
...
# TICK FUNCTION
schedule function gm4_player_motion-1.4:internal/technical/tick 1t append
...
summon marker 0.0 0.0 0.0 {UUID:[I; -1707835796, 484787018, -1223203065, -719371623], Tags:["smithed.strict", "smithed.entity"]}
#                                ^ (GM4) changed UUID to prevent potential conflict

# TRIG LOOKUP TABLE:
function gm4_player_motion-1.4:internal/technical/trig
