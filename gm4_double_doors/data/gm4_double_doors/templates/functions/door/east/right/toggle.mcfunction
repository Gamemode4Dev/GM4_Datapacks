...
execute unless score $triggered_by_auto_toggle gm4_double_doors_data matches 1.. summon marker run function gm4_double_doors:{{ material_name }}/door/east/right/initialize_auto_toggle_marker
