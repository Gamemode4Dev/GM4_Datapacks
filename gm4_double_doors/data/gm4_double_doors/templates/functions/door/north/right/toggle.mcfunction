...
execute align xyz unless entity @e[type=marker,tag=gm4_double_doors_auto_toggle_marker,dx=0,limit=1] positioned ~.5 ~.5 ~.5 summon marker run function gm4_double_doors:{{ material_name }}/door/north/right/initialize_auto_toggle_marker
