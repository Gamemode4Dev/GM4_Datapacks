...
execute unless entity @s[tag=gm4_block_auto_toggle] unless score $triggered_by_auto_toggle gm4_double_doors_data matches 1.. summon marker run function gm4_double_doors:{{ material_name }}/door/north/right/initialize_auto_toggle_marker
