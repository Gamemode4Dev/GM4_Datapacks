...
execute if score $target_door_state gm4_double_doors_data matches 0 run place template gm4_double_doors:door/oak/north/right/closed ~ ~ ~

# player just opened a door
execute if score $target_door_state gm4_double_doors_data matches 1 run place template gm4_double_doors:door/oak/north/right/open ~ ~ ~
...
execute positioned ~ ~2 ~ if block ~ ~ ~ #minecraft:trapdoors[open=true,half=bottom] unless block ~ ~ ~ #minecraft:trapdoors[facing=east] unless block ~ ~ ~ #minecraft:trapdoors[facing=south] run function gm4_double_doors:trapdoor/north_west/check_neighbours
