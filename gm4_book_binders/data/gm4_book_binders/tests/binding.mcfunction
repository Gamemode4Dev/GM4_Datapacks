...
dummy @s use entity @e[tag=gm4_book_binder,sort=nearest,limit=1]

await entity @e[tag=gm4_book_binder,nbt=!{HandItems:[{id:"minecraft:paper"}]}]

give @s leather
dummy @s use entity @e[tag=gm4_book_binder,sort=nearest,limit=1]

await entity @e[tag=gm4_book_binder,nbt=!{HandItems:[{id:"minecraft:leather"}]}]
