...
execute if score illusioner_random_value gm4_menace >= illusioner_required_value gm4_menace if entity @a[limit=1] run function gm4_illusioner_nights:set_pos
