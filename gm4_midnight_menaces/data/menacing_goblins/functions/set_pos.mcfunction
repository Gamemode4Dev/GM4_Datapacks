...
execute as @e[type=area_effect_cloud,tag=gm4_goblin_spawn_point] at @s run summon zombie ~ ~ ~ {CustomNameVisible:0b,DeathLootTable:"menacing_goblins:goblin",LeftHanded:1b,CanPickUpLoot:0b,Health:12f,IsBaby:1b,CanBreakDoors:0b,Tags:["gm4_goblin"],CustomName:'"Goblin"',HandItems:[{id:"minecraft:golden_sword",Count:1b},{}],HandDropChances:[0.3F,0.85F],ArmorItems:[{},{},{},{id:"minecraft:carved_pumpkin",Count:1b}],ArmorDropChances:[0.85F,0.85F,0.85F,-327.67F],ActiveEffects:[{Id:11b,Amplifier:4b,Duration:5,ShowParticles:1b}],Attributes:[{Name:generic.maxHealth,Base:12},{Name:generic.followRange,Base:32}]}