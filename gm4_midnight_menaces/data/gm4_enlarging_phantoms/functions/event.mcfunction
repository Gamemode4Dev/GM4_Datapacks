...
summon minecraft:area_effect_cloud ~ ~ ~ {CustomName:'"gm4_phantom_spawn_point"',Tags:["gm4_phantom_spawn_point"],Duration:18000,Radius:0.01,Particle:"block air"}
...
execute if score phantom_random_value gm4_menace >= phantom_required_value gm4_menace if entity @a[limit=1] run function gm4_enlarging_phantoms:set_pos
