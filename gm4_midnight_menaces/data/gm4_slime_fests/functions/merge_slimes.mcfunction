...
execute as @e[type=slime,nbt={Size:1},scores={gm4_menace=..8},limit=1,sort=random] at @s run data merge entity @e[type=slime,distance=0.1..2,sort=nearest,limit=1,nbt={Size:3},tag=!gm4_just_grew] {Size:7,Tags:[gm4_just_grew],DeathLootTable:"gm4_slime_fests:giant_slime",Attributes:[{Base:64.0d,Name:"generic.maxHealth"}],Health:64.0f}
...
execute at @e[type=slime,tag=gm4_just_grew] as @e[type=slime,tag=!gm4_just_grew,distance=0,limit=1] at @s run function gm4_slime_fests:complete_merge
