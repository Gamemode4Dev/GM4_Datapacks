...
# slime takeover
execute as @e[type=#gm4_slime_fests:slime_convertable,x=0,nbt={PersistenceRequired:0b}] at @s run function gm4_slime_fests:slime_transform

# merging slimes
scoreboard players reset @e[type=minecraft:slime] gm4_menace_data
execute at @e[type=minecraft:slime,x=0] run scoreboard players add @e[type=minecraft:slime,distance=0.1..5] gm4_menace_data 1
