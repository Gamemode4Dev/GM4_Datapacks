...
# guidebook
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 4006.118556280305 ~ {CustomName:'"gm4_slime_fests_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"mysterious_midnights",id:"slime_fests",page_count:1,line_count:1,module_name:"Slime Fests"}}
...
execute if score gm4_guidebook load.status matches 1 run summon marker ~ 2718.678477504404 ~ {CustomName:'"gm4_menacing_goblins_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"mysterious_midnights",id:"menacing_goblins",page_count:1,line_count:1,module_name:"Menacing Goblins"}}
