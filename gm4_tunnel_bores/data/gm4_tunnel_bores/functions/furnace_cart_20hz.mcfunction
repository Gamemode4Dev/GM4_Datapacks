...
# fix MC-51053
execute at @s unless block ~ ~ ~ #rails[shape=north_south] unless block ~ ~ ~ #rails[shape=east_west] if entity @s[nbt=!{Fuel:0s}] if entity @s[nbt=!{Fuel:3600s}] run function gm4_tunnel_bores:mc_51053
