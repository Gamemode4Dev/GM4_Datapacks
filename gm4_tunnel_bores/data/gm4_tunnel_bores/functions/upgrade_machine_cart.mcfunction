...
execute as @e[type=area_effect_cloud,tag=gm4_bore_storage,tag=!smithed.entity,distance=..0.2] run data merge entity @s {Tags:["gm4_bore_storage","smithed.entity","smithed.strict"]}
