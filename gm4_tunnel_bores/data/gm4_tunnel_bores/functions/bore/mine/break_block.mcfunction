...
execute positioned ^1 ^ ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^ ^ ^1 unless block ~ ~ ~ #minecraft:rails unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^-1 ^ ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^1 ^1 ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^ ^1 ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^-1 ^1 ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^1 ^2 ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^ ^2 ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
execute positioned ^-1 ^2 ^1 unless block ~ ~ ~ #gm4:unbreakable run fill ~ ~ ~ ~ ~ ~ air destroy
