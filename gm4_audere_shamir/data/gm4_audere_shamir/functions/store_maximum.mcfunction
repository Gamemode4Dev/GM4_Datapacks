...
execute store success score $success gm4_ml_data if entity @s[nbt={Item:{id:"minecraft:wooden_shovel"}}] run data modify entity @s Item.tag.gm4_audere_shamir.max_durability set value 59
...
execute unless score $success gm4_ml_data matches 1.. store success score $success gm4_ml_data if entity @s[nbt={Item:{id:"minecraft:netherite_shovel"}}] run data modify entity @s Item.tag.gm4_audere_shamir.max_durability set value 2031
