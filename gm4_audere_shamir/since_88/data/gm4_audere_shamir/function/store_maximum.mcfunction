...
execute unless score $success gm4_ml_data matches 1.. store success score $success gm4_ml_data if items entity @s contents minecraft:copper_shovel run data modify entity @s Item.components."minecraft:custom_data".gm4_audere_shamir.max_durability set value 190
execute unless score $success gm4_ml_data matches 1.. store success score $success gm4_ml_data if items entity @s contents minecraft:copper_pickaxe run data modify entity @s Item.components."minecraft:custom_data".gm4_audere_shamir.max_durability set value 190
execute unless score $success gm4_ml_data matches 1.. store success score $success gm4_ml_data if items entity @s contents minecraft:copper_hoe run data modify entity @s Item.components."minecraft:custom_data".gm4_audere_shamir.max_durability set value 190
execute unless score $success gm4_ml_data matches 1.. store success score $success gm4_ml_data if items entity @s contents minecraft:copper_axe run data modify entity @s Item.components."minecraft:custom_data".gm4_audere_shamir.max_durability set value 190
