...
tellraw @a[gamemode=creative] ["",{"text":"[GM4]: Installing Auto Breeding..."}]
execute unless entity @p run say GM4: Installing Auto Breeding...

#declare and initialise scoreboards and settings
scoreboard players set updateHappened gm4_upCheck 1
scoreboard players set auto_breeding gm4_modules 1
scoreboard players set auto_breeding gm4_clockTick 0

#announce success
tellraw @a[gamemode=creative] ["",{"text":"[GM4]: Auto Breeding Installed!"}]
execute unless entity @p run say GM4: Auto Breeding Installed!
