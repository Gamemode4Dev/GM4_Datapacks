...
data modify storage gm4_mountaineering:temp Item set from storage gm4_custom_crafters:temp/crafter Items[0]
...
data remove storage gm4_mountaineering:temp Item