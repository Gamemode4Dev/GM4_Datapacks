...
execute at @s if entity @s[tag=!gm4_mountaineering_using_crampons,predicate=gm4_mountaineering:wearing_crampons] run tag @s add gm4_mountaineering_using_crampons

# Clear crampon tag when crampons are removed
execute at @s if entity @s[predicate=!gm4_mountaineering:wearing_crampons,tag=gm4_mountaineering_using_crampons] run tag @s remove gm4_mountaineering_using_crampons
