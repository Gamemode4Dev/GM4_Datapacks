...
execute as @a[gamemode=!spectator,tag=gm4_mountaineering_skiing,predicate=gm4_mountaineering:wearing_skis] at @s run function gm4_mountaineering:ski_effects/skis_on_snow
execute as @a[gamemode=!spectator,tag=!gm4_mountaineering_skiing,predicate=gm4_mountaineering:wearing_skis] at @s run function gm4_mountaineering:ski_effects/skis_off_snow
