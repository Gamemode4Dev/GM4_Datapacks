...
# @s = player with skiing tag and downhill skiing tag but no longer meeting relevant requirements
# at @s
# run from ski_effects/downhill_ski_speed/check_downhill_ski_speed
