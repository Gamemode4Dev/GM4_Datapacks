...
execute unless block ~ ~ ~ minecraft:snow unless predicate gm4_mountaineering:on_snowy_block_or_air if predicate gm4_mountaineering:wearing_skis run tag @s add gm4_mountaineering_skiing_off_snow
