...
attribute @s minecraft:generic.movement_speed modifier add 8aed075d-afeb-4943-af9d-6b7e1d31e0de "gm4_mountaineering_steep_downhill_speed_boost" 0.175 add_multiplied_base
