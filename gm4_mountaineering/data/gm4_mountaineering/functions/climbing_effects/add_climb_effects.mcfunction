...
# teleport shulker down 1000 blocks to bring them into position
execute positioned ~ ~1000 ~ as @e[type=shulker, tag=gm4_mountaineering_climb_assist, predicate=gm4_mountaineering:high_entity] at @s run teleport @s ~ ~-1000 ~
