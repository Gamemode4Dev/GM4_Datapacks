...
# at @s
# run from pole_effects/poles_equipped
...
execute if entity @s[scores={gm4_mountaineering_jump_counter=1..}] run scoreboard players reset @s gm4_mountaineering_jump_counter
