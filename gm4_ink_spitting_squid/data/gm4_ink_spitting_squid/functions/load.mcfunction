...
execute if score gm4_ink_spitting_squid load matches 1 run function ink_spitting_squid:init
execute unless score gm4_ink_spitting_squid load matches 1 run schedule clear ink_spitting_squid:main
