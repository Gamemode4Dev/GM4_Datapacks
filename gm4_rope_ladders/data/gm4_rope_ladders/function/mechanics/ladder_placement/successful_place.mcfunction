...
execute if score $mainhand gm4_rol_data matches 1 run item modify entity @s[gamemode=!creative] weapon.mainhand {type: "minecraft:set_count", count: -1, add: true}
execute if score $mainhand gm4_rol_data matches 1 run swing @s mainhand
execute if score $mainhand gm4_rol_data matches 0 run item modify entity @s[gamemode=!creative] weapon.offhand {type: "minecraft:set_count", count: -1, add: true}
