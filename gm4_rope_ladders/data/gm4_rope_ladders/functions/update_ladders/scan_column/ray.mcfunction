...
execute if score $ray gm4_rol_data matches 0..63 unless score $ray_stop gm4_rol_data matches 1 if block ~ ~-1 ~ ladder positioned ~ ~-1 ~ run function gm4_rope_ladders:update_ladders/scan_column/ray
