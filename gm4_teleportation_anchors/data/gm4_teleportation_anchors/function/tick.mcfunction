...
execute as @e[type=enderman,tag=gm4_ta_jammed,scores={gm4_ta_jam_time=1..}] unless data entity @s carriedBlockState run data merge entity @s {carriedBlockState:{id:"tall_seagrass",properties:{half:"upper"}}}
