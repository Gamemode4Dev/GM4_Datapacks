...
data modify storage gm4_relocators:temp merge_data set value {custom_block:"gm4_teleportation_anchor",lore:'{"translate":"%1$s%3427655$s","with":["Teleportation Anchor",{"translate":"block.gm4.teleportation_anchor"}],"color":"gray","italic":true}'}
