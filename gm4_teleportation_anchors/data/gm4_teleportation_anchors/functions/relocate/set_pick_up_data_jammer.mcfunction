...
data modify storage gm4_relocators:temp merge_data set value {custom_block:"gm4_teleportation_jammer",lore:'{"translate":"%1$s%3427655$s","with":["Teleportation Jammer",{"translate":"block.gm4.teleportation_jammer"}],"color":"gray","italic":true}'}
