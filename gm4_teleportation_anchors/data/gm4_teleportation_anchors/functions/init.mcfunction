...
execute unless score gm4_teleportation_anchors gm4_modules matches 1 run data modify storage gm4:log queue append value {type:"install",module:"Display Frames"}
