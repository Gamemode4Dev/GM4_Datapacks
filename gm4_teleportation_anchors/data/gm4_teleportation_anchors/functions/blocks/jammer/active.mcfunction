...
scoreboard players set @e[type=#gm4_teleportation_anchors:affected,tag=gm4_ta_new_jammed,distance=..65] gm4_ta_jam_time 3
tag @e[type=#gm4_teleportation_anchors:affected,tag=gm4_ta_new_jammed,distance=..65] add gm4_ta_jammed
tag @e[type=#gm4_teleportation_anchors:affected,distance=..65] remove gm4_ta_new_jammed
