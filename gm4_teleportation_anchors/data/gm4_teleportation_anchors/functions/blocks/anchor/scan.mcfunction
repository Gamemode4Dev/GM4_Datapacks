...
execute if block ~ ~ ~ lodestone align xyz if entity @e[type=armor_stand,tag=gm4_teleportation_anchor,dx=0,dy=0,dz=0] at @s run function gm4_teleportation_anchors:blocks/anchor/link
...
execute unless entity @s[tag=gm4_ta_kill] unless score scan_count gm4_ta_data matches 64.. at @s[tag=!gm4_ta_found_anchor] run function gm4_teleportation_anchors:blocks/anchor/scan
