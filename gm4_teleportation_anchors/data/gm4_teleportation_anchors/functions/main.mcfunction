...
scoreboard players remove @e[type=#gm4_teleportation_anchors:affected,tag=gm4_ta_jammed,scores={gm4_ta_jam_time=1..}] gm4_ta_jam_time 1
scoreboard players reset @e[type=#gm4_teleportation_anchors:affected,scores={gm4_ta_jam_time=..0}] gm4_ta_pos_x
tag @e[type=#gm4_teleportation_anchors:affected,scores={gm4_ta_jam_time=..0}] remove gm4_ta_jammed
