...
execute if entity @s[tag=gm4_ta_teleported] at @e[type=marker,tag=gm4_ta_pos_tracker,limit=1] run tag @s[type=enderman,distance=5.8..7.2,nbt={active_effects:[{id:'minecraft:speed',amplifier:0b}]}] remove gm4_ta_teleported
execute if entity @s[tag=gm4_ta_teleported] at @e[type=marker,tag=gm4_ta_pos_tracker,limit=1] run tag @s[type=enderman,distance=5.8..10.1,nbt={active_effects:[{id:'minecraft:speed',amplifier:1b}]}] remove gm4_ta_teleported
