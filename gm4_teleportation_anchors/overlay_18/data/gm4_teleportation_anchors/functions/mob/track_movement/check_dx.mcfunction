...
execute if score difference gm4_ta_pos_x matches 360..510 run tag @s[type=enderman,nbt={active_effects:[{id:'minecraft:speed',amplifier:0b}]}] remove gm4_ta_teleported
execute if score difference gm4_ta_pos_x matches 360..690 run tag @s[type=enderman,nbt={active_effects:[{id:'minecraft:speed',amplifier:1b}]}] remove gm4_ta_teleported
