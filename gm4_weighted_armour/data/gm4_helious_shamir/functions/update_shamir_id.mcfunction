...
execute if entity @s[nbt={Item:{tag:{gm4_metallurgy:{active_shamir:"helios"}}}}] run data modify entity @s Item.tag.display.Lore[-1] set value '{"italic":false,"color":"gray","translate":"%1$s%3427655$s","with":["Helious",{"translate":"item.gm4.shamir.helious"}]}'
