execute if score gm4 load matches 1 run scoreboard players set gm4_weighted_armour load 1
...
execute if score gm4_weighted_armour load matches 1 run function weighted_armour:init
