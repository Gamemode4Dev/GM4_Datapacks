...
execute if score gm4_note_block_interface load matches 1 run function gm4_note_block_interface:init
execute unless score gm4_note_block_interface load matches 1 run schedule clear gm4_note_block_interface:tick
