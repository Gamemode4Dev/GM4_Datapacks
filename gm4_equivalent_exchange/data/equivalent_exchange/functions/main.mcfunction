...
execute if entity @e[type=creeper,tag=gm4_remove_power] as @e[type=creeper,tag=gm4_removePower] run function equivalent_exchange:post_effects/remove_lightning
