...
execute if score lightning gm4_ee_curse matches 1.. run tag @e[type=creeper,distance=..10,tag=!gm4_removePower,nbt=!{powered:1b}] add gm4_removePower
...
execute if score vex gm4_ee_curse matches 1.. run summon vex ~ ~1 ~ {DeathLootTable:"empty",LifeTicks:400,Tags:["gm4_ee_transmutation"],CustomName:"{\"text\":\"Living Transmutation\",\"color\":\"red\"}"}
