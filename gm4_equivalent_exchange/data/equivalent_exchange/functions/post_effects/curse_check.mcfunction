...
execute if score random_int gm4_ee_curse matches 0..19 run scoreboard players set lightning gm4_ee_curse 1

execute if score random_int gm4_ee_curse matches 20..49 run scoreboard players set cloud gm4_ee_curse 1

execute if score random_int gm4_ee_curse matches 50.. run scoreboard players add vex gm4_ee_curse 1