...
execute if score @s gm4_slot_count matches 3 if score @s gm4_stack_size matches ..5 if block ~ ~ ~ dropper{Items:[{Slot:0b,id:"minecraft:player_head",tag:{gm4_transmutation_charged:1b}},{Slot:1b,id:"minecraft:diamond"},{Slot:3b,id:"minecraft:diamond"}]} run data merge block ~ ~ ~ {Items:[{Slot:8b,id:"minecraft:gold_ingot",Count:1b,tag:{gm4_alchemical_crafters:{multiplier:12}}}]}
