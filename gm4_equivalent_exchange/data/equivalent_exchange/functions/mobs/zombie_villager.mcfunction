...
execute store result score @s gm4_ee_hit run data get entity @s Profession

scoreboard players add @s gm4_ee_hit 1
execute if score @s gm4_ee_hit matches 6.. run scoreboard players set @s gm4_ee_hit 0

execute store result entity @s Profession byte 1 run scoreboard players get @s gm4_ee_hit
