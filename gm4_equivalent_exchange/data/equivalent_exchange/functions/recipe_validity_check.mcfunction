...
#check supercharge
execute if score @s gm4_slot_count matches 3 if score @s gm4_stack_size matches 1 if block ~ ~ ~ dropper{Items:[{Slot:1b,id:"minecraft:nether_star"},{Slot:4b,tag:{gm4_transmutation_stone:1b,gm4_transmutation_charge:100s}},{Slot:7b,id:"minecraft:nether_star"}]} if block ~1 ~-1 ~ lapis_block if block ~-1 ~-1 ~ lapis_block if block ~ ~-1 ~1 lapis_block if block ~ ~-1 ~-1 lapis_block if block ~1 ~-1 ~1 lapis_block if block ~1 ~-1 ~-1 lapis_block if block ~-1 ~-1 ~1 lapis_block if block ~-1 ~-1 ~-1 lapis_block if block ~ ~-1 ~ lapis_block if block ~1 ~ ~ quartz_slab if block ~-1 ~ ~ quartz_slab if block ~ ~ ~1 quartz_slab if block ~ ~ ~-1 quartz_slab if block ~2 ~-1 ~ quartz_stairs[facing=west] if block ~-2 ~-1 ~ quartz_stairs[facing=east] if block ~ ~-1 ~2 quartz_stairs[facing=north] if block ~ ~-1 ~-2 quartz_stairs[facing=south] run function equivalent_exchange:recharge/supercharge
