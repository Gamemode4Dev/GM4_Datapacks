...
execute if score charge_val gm4_ee_charge matches 7.. if score @s gm4_ee_charge matches ..99 run scoreboard players add @s gm4_ee_charge 1execute if score charge_val gm4_ee_charge matches ..6 if score @s gm4_ee_charge matches ..99 run scoreboard players add @s gm4_ee_charge 2

execute if score @s gm4_ee_charge matches 101.. run scoreboard players set @s gm4_ee_charge 100

execute at @e[tag=gm4_ee_flower_checker,sort=nearest,limit=1] run particle dragon_breath ~ ~1 ~ 0 0 0 .01 7
