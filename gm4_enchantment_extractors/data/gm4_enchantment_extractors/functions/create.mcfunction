...
summon armor_stand ~ ~-1.2 ~ {CustomName:'"GM4 Enchantment Extractor"',Invisible:1b,Invulnerable:1b,Marker:1b,NoGravity:1,Tags:["gm4_enchantment_extractor","gm4_no_edit","gm4_machine"],ArmorItems:[{},{},{},{id:"minecraft:enchanting_table",Count:1,tag:{CustomModelData:3420001}}],DisabledSlots:2039583}
