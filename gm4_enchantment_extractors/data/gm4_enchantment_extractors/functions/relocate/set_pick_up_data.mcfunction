...
data modify storage gm4_relocators:temp merge_data set value {custom_block:"gm4_enchantment_extractor",lore:'{"translate":"%1$s%3427655$s","with":["Enchantment Extractor",{"translate":"block.gm4.enchantment_extractor"}],"color":"gray","italic":true}'}
