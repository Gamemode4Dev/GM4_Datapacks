...
execute if block ~ ~ ~ dropper{Items:[]} positioned ~ ~1 ~ as @e[type=item,distance=..0.7,nbt={Item:{Count:1b,tag:{Enchantments:[{}]}}}] positioned ~ ~-1 ~ run function gm4_enchantment_extractors:extract
