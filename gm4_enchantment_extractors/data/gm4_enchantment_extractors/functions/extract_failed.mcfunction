...
execute if score result gm4_ench_random matches 80..89 run summon vex ~ ~-1 ~ {CustomName:'{"translate":"%1$s%3427655$s","with":["Congealed Enchantment",{"translate":"entity.gm4.congealed_enchantment"}]}',CustomNameVisible:0,LifeTicks:100,Attributes:[{Name:generic.attackDamage,Base:2}],Health:4.0,Motion:[0.0,0.35,0.0]}
