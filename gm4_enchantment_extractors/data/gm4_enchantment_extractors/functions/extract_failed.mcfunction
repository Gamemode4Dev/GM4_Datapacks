...
execute store success score $failed_congealed_ench gm4_ench_data if score $failed_smoke gm4_ench_data matches 0 if predicate gm4_enchantment_extractors:failed_congealed_chance run summon vex ~ ~ ~ {CustomName:'{"translate":"entity.gm4.congealed_enchantment","fallback":"Congealed Enchantment§"}',CustomNameVisible:0,Team:"gm4_hide_name",LifeTicks:100,Attributes:[{Name:"generic.attack_damage",Base:2}],Health:4.0f,Motion:[0.0,0.35,0.0]}
...
execute store success score $failed_living_ench gm4_ench_data if score $failed_congealed_ench gm4_ench_data matches 0 run summon vex ~ ~ ~ {CustomName:'{"translate":"entity.gm4.living_enchantment","fallback":"Living Enchantment§"}',CustomNameVisible:0,Team:"gm4_hide_name",HandItems:[{id:"minecraft:golden_sword",Count:1},{}],HandDropChances:[0.0f,0.0f],Motion:[0.0,0.25,0.0]}
