...
execute if score result gm4_ench_random matches 80..89 run summon vex ~ ~-1 ~ {CustomName:'{"translate":"%1$s%3427655$s","with":["§fCongealed Enchantment",{"translate":"entity.gm4.congealed_enchantment"}]}',CustomNameVisible:0,LifeTicks:100,Attributes:[{Name:"generic.attack_damage",Base:2}],Health:4.0f,Motion:[0.0,0.35,0.0]}
