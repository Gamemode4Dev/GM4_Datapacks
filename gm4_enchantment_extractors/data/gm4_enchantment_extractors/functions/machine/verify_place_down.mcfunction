...
execute if score $placed_block gm4_machine_data matches 0 if data storage gm4_machines:temp {id:"enchantment_extractor"} run function gm4_enchantment_extractors:machine/create
