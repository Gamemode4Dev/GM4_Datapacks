scoreboard players add extract_chance gm4_random 27
execute if score extract_chance gm4_random matches 100.. run scoreboard players remove extract_chance gm4_random 100
