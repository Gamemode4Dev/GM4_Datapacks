...
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Installing Enchantment Extractors...",{"translate":"text.gm4.modules.update.installing","with":["Enchantment Extractors"]}]}]
...
#announce success
tellraw @a[gamemode=creative] [{"translate":"%1$s","with":["[GM4]: ",{"translate":"text.gm4.prefix"}]},{"translate":"%1$s","with":["Enchantment Extractors Installed!",{"translate":"text.gm4.modules.update.installed","with":["Enchantment Extractors"]}]}]
