...
execute if score fail_type gm4_ench_random matches ..79 run particle explosion ~ ~1.7 ~ 0.2 0.2 0.2 0.05 25 force @a[distance=..10]
execute if score fail_type gm4_ench_random matches ..79 run playsound item.shield.break block @a[distance=..8] ~ ~ ~ 0.6 0.3

execute if score fail_type gm4_ench_random matches 80..89 run playsound entity.evocation_illager.prepare_attack block @a[distance=..8] ~ ~ ~ .8 1.8
...
execute if score fail_type gm4_ench_random matches 90.. run playsound entity.evocation_illager.prepare_attack block @a[distance=..8] ~ ~ ~ 1.3 .6
