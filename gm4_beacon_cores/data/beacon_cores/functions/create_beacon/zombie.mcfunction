# @s - Zombie Core item on a beacon block
# run from check_core

# Particles and sound effects
particle cloud ~ ~ ~ 0 0 0 0.2 50
particle witch ~ ~ ~ 0 0 0 0.3 40
playsound minecraft:entity.zombie.death block @a ~ ~ ~ 1 0 0
...
tag @e[name=gm4_beacon_core,limit=1,distance=..0.4] add gm4_beacon_zombie
