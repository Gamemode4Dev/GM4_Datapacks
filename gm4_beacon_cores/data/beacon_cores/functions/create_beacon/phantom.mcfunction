# @s - Phantom Core item on a beacon block
# run from check_core
...
playsound minecraft:entity.phantom.death block @a ~ ~ ~ 1 0 0
...
tag @e[name=gm4_beacon_core,limit=1,distance=..0.4] add gm4_beacon_phantom

# Advancement for creating the beacon: Peace in the Sky 
advancement grant @a[distance=..7] only gm4:beacon_cores

scoreboard players add @e[name=gm4_beacon_core,limit=1,distance=..0.4] gm4_beacon_cores 1
