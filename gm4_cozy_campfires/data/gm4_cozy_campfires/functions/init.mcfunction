...
# guidebook
summon marker ~ 739.663219176003 ~ {CustomName:'"gm4_cozy_campfires_guide"',Tags:["gm4_guide"],data:{type:"module",id:"cozy_campfires",page_count:1,line_count:1,module_name:"Cozy Campfires"}}
