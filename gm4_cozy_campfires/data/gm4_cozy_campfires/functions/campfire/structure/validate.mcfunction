...
execute if block ~ ~ ~ #minecraft:campfires[lit=true] as @a[distance=..3,gamemode=!spectator,nbt={HurtTime:0s}] at @s run function gm4_cozy_campfires:player/near_cozy_campfire
