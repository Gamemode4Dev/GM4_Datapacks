...
execute if entity @s[nbt={Item:{tag:{pages:["invisible"]}}}] run data merge entity @e[limit=1,distance=..1,type=armor_stand,tag=!gm4_no_edit] {Invisible:1b}
execute if entity @s[nbt={Item:{tag:{pages:["visible"]}}}] run data merge entity @e[limit=1,distance=..1,type=armor_stand,tag=!gm4_no_edit] {Invisible:0b}
