...
execute if entity @s[nbt={Item:{tag:{pages:["invisible"]}}}] align xz positioned ~ ~ ~ run data merge entity @e[dx=0,type=armor_stand,tag=!gm4_no_edit] {Invisible:1b}
execute if entity @s[nbt={Item:{tag:{pages:["visible"]}}}] align xz positioned ~ ~ ~ run data merge entity @e[dx=0,type=armor_stand,tag=!gm4_no_edit] {Invisible:0}
