...
summon minecraft:wandering_trader ~ ~-10000 ~ {CustomName:'"gm4_bas_detect_rightclick"',Tags:["smithed.entity","smithed.strict","gm4_trader","gm4_bas_arms_detect"],Team:"gm4_bas",Silent:1b,NoAI:1b,Invulnerable:1b,Offers:{},ActiveEffects:[{Id:14b,Amplifier:0b,Duration:10000000,ShowParticles:0b}]}
