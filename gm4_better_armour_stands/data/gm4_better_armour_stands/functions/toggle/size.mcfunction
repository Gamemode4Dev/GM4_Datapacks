...
execute if score @s gm4_bas_data matches 1 run playsound minecraft:entity.puffer_fish.blow_up block @a[distance=..5] ~ ~ ~ .5 1.5

# small
execute unless score @s gm4_bas_data matches 1 run data modify entity @s Small set value 1
execute unless score @s gm4_bas_data matches 1 run playsound minecraft:entity.puffer_fish.blow_out block @a[distance=..5] ~ ~ ~ .5 1.5
