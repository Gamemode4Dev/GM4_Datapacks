...
execute as @e[type=armor_stand,tag=gm4_bas_no_arm] at @s unless entity @p[distance=..5,predicate=gm4_better_armour_stands:holding/mainhand/book_arms] run function gm4_better_armour_stands:toggle/arms_detect_remove
