...
execute unless score gm4_better_armour_stands load matches 1 run schedule clear gm4_better_armour_stands:main
execute unless score gm4_better_armour_stands load matches 1 run schedule clear gm4_better_armour_stands:tick
