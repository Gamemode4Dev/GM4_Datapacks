...
execute if predicate gm4_better_armour_stands:holding_book_arms as @e[type=armor_stand,distance=..1,nbt={ShowArms:0b}] at @s run function gm4_better_armour_stands:toggle/arms
