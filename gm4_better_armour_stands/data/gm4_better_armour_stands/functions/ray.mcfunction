...
execute unless entity @e[type=minecraft:armor_stand,predicate=gm4_better_armour_stands:holding_book_and_quill,dx=0,limit=1] if entity @p[distance=..5] positioned ^ ^ ^.1 run function gm4_better_armour_stands:ray
