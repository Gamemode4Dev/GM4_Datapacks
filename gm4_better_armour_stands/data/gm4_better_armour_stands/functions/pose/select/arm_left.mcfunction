...
execute if score @s gm4_bas_data matches 0 positioned ~ ~1.4 ~ run summon marker ^.3 ^ ^ {Tags:["gm4_bas_joint","gm4_bas_left_arm"]}
execute if score @s gm4_bas_data matches 1 positioned ~ ~.7 ~ run summon marker ^.15 ^ ^ {Tags:["gm4_bas_joint","gm4_bas_left_arm"]}
