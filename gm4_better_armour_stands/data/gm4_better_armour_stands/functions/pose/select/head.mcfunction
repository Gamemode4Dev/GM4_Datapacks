...
execute if score @s gm4_bas_data matches 0 run summon marker ~ ~1.4 ~ {Tags:["gm4_bas_joint","gm4_bas_head","gm4_bas_marker","gm4_bas_new"]}
execute if score @s gm4_bas_data matches 1 run summon marker ~ ~.7 ~ {Tags:["gm4_bas_joint","gm4_bas_head","gm4_bas_marker","gm4_bas_new"]}
