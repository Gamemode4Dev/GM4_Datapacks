...
execute unless entity @s[tag=gm4_bas_stop_ray] unless score @s gm4_bas_dist matches 55.. positioned ^ ^ ^.5 run function gm4_better_armour_stands:pose/select/move/ray
