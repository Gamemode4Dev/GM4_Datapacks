...
execute positioned ~ ~.525 ~ run summon minecraft:chicken ^.125 ^ ^ {CustomName:'"gm4_bas_detect_left_leg"',Tags:["gm4_bas_detect_part","gm4_bas_left_leg"],NoAI:1b,Silent:1b,Age:-100000}
execute positioned ~ ~.525 ~ run summon minecraft:chicken ^-.125 ^ ^ {CustomName:'"gm4_bas_detect_right_leg"',Tags:["gm4_bas_detect_part","gm4_bas_right_leg"],NoAI:1b,Silent:1b,Age:-100000}
