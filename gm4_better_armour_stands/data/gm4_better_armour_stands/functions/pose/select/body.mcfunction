...
# spawn markers
execute at @p[tag=gm4_bas_active] positioned ~ ~1.6 ~ run summon marker ^ ^ ^2 {Tags:["gm4_bas_player_offset","gm4_bas_marker","gm4_bas_new"]}
execute if score @s gm4_bas_data matches 0 run summon marker ~ ~1.5 ~ {Tags:["gm4_bas_joint","gm4_bas_body","gm4_bas_marker","gm4_bas_new"]}
execute if score @s gm4_bas_data matches 1 run summon marker ~ ~.7 ~ {Tags:["gm4_bas_joint","gm4_bas_body","gm4_bas_marker","gm4_bas_new"]}
