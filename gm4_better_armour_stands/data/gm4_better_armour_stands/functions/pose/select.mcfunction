...
execute unless score @s gm4_bas_mode matches 1.. if entity @p[tag=gm4_bas_active,predicate=gm4_better_armour_stands:select/base,predicate=!gm4_better_armour_stands:sneaking] positioned ~ ~-1.6 ~ run function gm4_better_armour_stands:pose/select/move
