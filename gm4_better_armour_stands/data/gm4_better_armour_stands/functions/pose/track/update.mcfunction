...
execute as @p[tag=gm4_bas_track] unless predicate gm4_better_armour_stands:holding/mainhand/book_and_quill at @s run function gm4_better_armour_stands:pose/set
