...
item replace entity @s weapon.mainhand from entity @p[tag=gm4_bas_active] weapon.offhand gm4_better_armour_stands:count
item modify entity @p[tag=gm4_bas_active] weapon.offhand gm4_better_armour_stands:remove_item
