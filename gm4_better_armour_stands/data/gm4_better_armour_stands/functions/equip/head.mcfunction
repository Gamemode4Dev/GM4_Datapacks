...
execute if data storage gm4_better_armour_stands:temp Item.Count run function gm4_better_armour_stands:equip/remove_head

# move item from player to armour stand
item replace entity @s armor.head from entity @p[tag=gm4_bas_user] weapon.offhand gm4_better_armour_stands:count
