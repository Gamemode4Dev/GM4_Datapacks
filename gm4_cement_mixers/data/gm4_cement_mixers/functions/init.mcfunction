...
# guidebook
summon marker ~ 659.530987417665 ~ {CustomName:'"gm4_cement_mixers_guide"',Tags:["gm4_guide"],data:{type:"_expansion",base:"liquid_tanks",id:"cement_mixers",page_count:1,line_count:1,module_name:"Cement Mixers"}}
