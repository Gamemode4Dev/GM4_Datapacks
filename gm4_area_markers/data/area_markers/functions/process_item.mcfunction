...
execute as @s[nbt={Item:{tag:{SkullOwner:{Id:"9b36c3fe-187f-4686-b472-4c7d7670804a"}}}}] run data merge entity @s {Item:{tag:{RepairCost:0,gm4_area_marker:1b,gm4_am_tier:1b,display:{Name:"{\"translate\":\"%1$s%3427655$s\",\"with\":[\"Area Marker Tier 1\",{\"translate\":\"item.gm4.area_markers.tier_1\"}],\"italic\":\"false\"}"}}}}
