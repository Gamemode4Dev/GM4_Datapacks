...
execute if score $placed_block gm4_machine_data matches 0 if data storage gm4_machines:temp {id:"gm4_master_crafter"} run function gm4_master_crafting:machine/create
