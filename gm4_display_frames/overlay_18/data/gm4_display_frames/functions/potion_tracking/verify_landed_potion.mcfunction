...
execute if data storage gm4_potion_tracking:temp entity_data.Item.tag{custom_potion_effects:[{id:'minecraft:invisibility'}]} run function gm4_display_frames:potion_tracking/splash_item_frames
