...
advancement revoke @s only gm4_trapped_signs:place_secret_trapped_sign
...
execute as @e[tag=gm4_trapped_signs_ray] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run function gm4_trapped_signs:machine/create_secret_trapped_sign
