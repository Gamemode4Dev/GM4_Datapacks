...
# @s = trapped_sign armor stand
# located at @s
# run from gm4_trapped_signs:main
...
execute if entity @s[tag=gm4_secret_trapped_sign] run tag @e[type=marker,tag=gm4_new_machine,limit=1,distance=..0.1] add gm4_secret_trapped_sign
...
scoreboard players set @e[type=marker,tag=gm4_new_machine,limit=1,distance=..0.1] gm4_entity_version 1
