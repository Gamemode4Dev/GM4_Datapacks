...
summon marker ~0.5 ~0.5 ~0.5 {Tags:["gm4_trapped_sign","gm4_machine_marker","smithed.block","smithed.entity","smithed.strict","gm4_new_machine"],CustomName:'"gm4_secret_trapped_sign"'}
