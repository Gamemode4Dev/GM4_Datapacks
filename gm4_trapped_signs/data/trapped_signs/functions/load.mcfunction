...
execute if score gm4_trapped_signs load matches 1 run function trapped_signs:init
execute unless score gm4_trapped_signs load matches 1 run schedule clear trapped_signs:main
execute unless score gm4_trapped_signs load matches 1 run schedule clear trapped_signs:tick
