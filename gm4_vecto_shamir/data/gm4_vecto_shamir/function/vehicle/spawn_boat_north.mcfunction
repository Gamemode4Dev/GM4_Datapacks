...
execute if biome ~ ~ ~ #gm4_vecto_shamir:poplar run summon minecraft:poplar_boat ~ ~ ~ {Invulnerable:1b,Tags:["gm4_vecto_vehicle","gm4_vecto_new_vehicle"],Rotation:[180f,0f]}
