...
execute unless score gm4_xp_storage load matches 1 run schedule clear gm4_xp_storage:main
execute unless score gm4_xp_storage load matches 1 run schedule clear gm4_xp_storage:tick
