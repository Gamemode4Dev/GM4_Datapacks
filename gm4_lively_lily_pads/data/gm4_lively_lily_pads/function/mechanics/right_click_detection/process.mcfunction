...
execute if score $killed_rcd gm4_llp.data matches 0 store success score $killed_rcd gm4_llp.data if entity @e[type=interaction,tag=gm4_llp_rcd,distance=0.1..10] run kill @s
