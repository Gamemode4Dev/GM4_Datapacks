...
execute if score $ray gm4_llp.data matches 0.. positioned ^ ^ ^.1 run function gm4_lively_lily_pads:mechanics/interactions/add_candle/ray with storage gm4_llp:temp
