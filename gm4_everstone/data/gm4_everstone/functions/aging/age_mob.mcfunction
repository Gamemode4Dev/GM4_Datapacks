...
execute as @e[type=#gm4_everstone:aging_mob,tag=!gm4_everstone_locked,tag=!gm4_everstone_ignore,limit=45,sort=random,distance=..128] at @s run function gm4_everstone:aging/check_mob
